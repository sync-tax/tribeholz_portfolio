...
`)+`
`+p);const _=M+m+o,y=M+p+a,P=df(r,r.VERTEX_SHADER,_),R=df(r,r.FRAGMENT_SHADER,y);r.attachShader(E,P),r.attachShader(E,R),t.index0AttributeName!==void 0?r.bindAttribLocation(E,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(E,0,"position"),r.linkProgram(E);function w(b){if(n.debug.checkShaderErrors){const U=r.getProgramInfoLog(E).trim(),X=r.getShaderInfoLog(P).trim(),Q=r.getShaderInfoLog(R).trim();let oe=!0,q=!0;if(r.getProgramParameter(E,r.LINK_STATUS)===!1)if(oe=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,E,P,R);else{const J=hf(r,P,"vertex"),H=hf(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(E,r.VALIDATE_STATUS)+`
...
}`;function Cy(n,e,t){let i=new gc;const r=new Je,s=new Je,o=new at,a=new by({depthPacking:i0}),l=new Ty,c={},u=t.maxTextureSize,f={[_i]:Wt,[Wt]:_i,[Gn]:Gn},d=new vi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Je},radius:{value:4}},vertexShader:wy,fragmentShader:Ry}),h=d.clone();h.defines.HORIZONTAL_PASS=1;const S=new yi;S.setAttribute("position",new Tn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const E=new An(S,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=fh;let p=this.type;this.render=function(R,w,I){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;const k=n.getRenderTarget(),x=n.getActiveCubeFace(),b=n.getActiveMipmapLevel(),U=n.state;U.setBlending(pi),U.buffers.color.setClear(1,1,1,1),U.buffers.depth.setTest(!0),U.setScissorTest(!1);const X=p!==zn&&this.type===zn,Q=p===zn&&this.type!==zn;for(let oe=0,q=R.length;oe<q;oe++){const J=R[oe],H=J.shadow;if(H===void 0){console.warn("THREE.WebGLShadowMap:",J,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;r.copy(H.mapSize);const me=H.getFrameExtents();if(r.multiply(me),s.copy(H.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/me.x),r.x=s.x*me.x,H.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/me.y),r.y=s.y*me.y,H.mapSize.y=s.y)),H.map===null||X===!0||Q===!0){const Me=this.type!==zn?{minFilter:on,magFilter:on}:{};H.map!==null&&H.map.dispose(),H.map=new ji(r.x,r.y,Me),H.map.texture.name=J.name+".shadowMap",H.camera.updateProjectionMatrix()}n.setRenderTarget(H.map),n.clear();const _e=H.getViewportCount();for(let Me=0;Me<_e;Me++){const Ie=H.getViewport(Me);o.set(s.x*Ie.x,s.y*Ie.y,s.x*Ie.z,s.y*Ie.w),U.viewport(o),H.updateMatrices(J,Me),i=H.getFrustum(),y(w,I,H.camera,J,this.type)}H.isPointLightShadow!==!0&&this.type===zn&&M(H,I),H.needsUpdate=!1}p=this.type,m.needsUpdate=!1,n.setRenderTarget(k,x,b)};function M(R,w){const I=e.update(E);d.defines.VSM_SAMPLES!==R.blurSamples&&(d.defines.VSM_SAMPLES=R.blurSamples,h.defines.VSM_SAMPLES=R.blurSamples,d.needsUpdate=!0,h.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new ji(r.x,r.y)),d.uniforms.shadow_pass.value=R.map.texture,d.uniforms.resolution.value=R.mapSize,d.uniforms.radius.value=R.radius,n.setRenderTarget(R.mapPass),n.clear(),n.renderBufferDirect(w,null,I,d,E,null),h.uniforms.shadow_pass.value=R.mapPass.texture,h.uniforms.resolution.value=R.mapSize,h.uniforms.radius.value=R.radius,n.setRenderTarget(R.map),n.clear(),n.renderBufferDirect(w,null,I,h,E,null)}function _(R,w,I,k){let x=null;const b=I.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(b!==void 0)x=b;else if(x=I.isPointLight===!0?l:a,n.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const U=x.uuid,X=w.uuid;let Q=c[U];Q===void 0&&(Q={},c[U]=Q);let oe=Q[X];oe===void 0&&(oe=x.clone(),Q[X]=oe,w.addEventListener("dispose",P)),x=oe}if(x.visible=w.visible,x.wireframe=w.wireframe,k===zn?x.side=w.shadowSide!==null?w.shadowSide:w.side:x.side=w.shadowSide!==null?w.shadowSide:f[w.side],x.alphaMap=w.alphaMap,x.alphaTest=w.alphaTest,x.map=w.map,x.clipShadows=w.clipShadows,x.clippingPlanes=w.clippingPlanes,x.clipIntersection=w.clipIntersection,x.displacementMap=w.displacementMap,x.displacementScale=w.displacementScale,x.displacementBias=w.displacementBias,x.wireframeLinewidth=w.wireframeLinewidth,x.linewidth=w.linewidth,I.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const U=n.properties.get(x);U.light=I}return x}function y(R,w,I,k,x){if(R.visible===!1)return;if(R.layers.test(w.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&x===zn)&&(!R.frustumCulled||i.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(I.matrixWorldInverse,R.matrixWorld);const X=e.update(R),Q=R.material;if(Array.isArray(Q)){const oe=X.groups;for(let q=0,J=oe.length;q<J;q++){const H=oe[q],me=Q[H.materialIndex];if(me&&me.visible){const _e=_(R,me,k,x);R.onBeforeShadow(n,R,w,I,X,_e,H),n.renderBufferDirect(I,null,X,_e,R,H),R.onAfterShadow(n,R,w,I,X,_e,H)}}}else if(Q.visible){const oe=_(R,Q,k,x);R.onBeforeShadow(n,R,w,I,X,oe,null),n.renderBufferDirect(I,null,X,oe,R,null),R.onAfterShadow(n,R,w,I,X,oe,null)}}const U=R.children;for(let X=0,Q=U.length;X<Q;X++)y(U[X],w,I,k,x)}function P(R){R.target.removeEventListener("dispose",P);for(const I in c){const k=c[I],x=R.target.uuid;x in k&&(k[x].dispose(),delete k[x])}}}const Py={[nl]:il,[rl]:al,[sl]:ll,[Cr]:ol,[il]:nl,[al]:rl,[ll]:sl,[ol]:Cr};function Ly(n){function e(){let N=!1;const be=new at;let te=null;const le=new at(0,0,0,0);return{setMask:function(Ee){te!==Ee&&!N&&(n.colorMask(Ee,Ee,Ee,Ee),te=Ee)},setLocked:function(Ee){N=Ee},setClear:function(Ee,Te,Ke,St,Vt){Vt===!0&&(Ee*=St,Te*=St,Ke*=St),be.set(Ee,Te,Ke,St),le.equals(be)===!1&&(n.clearColor(Ee,Te,Ke,St),le.copy(be))},reset:function(){N=!1,te=null,le.set(-1,0,0,0)}}}function t(){let N=!1,be=!1,te=null,le=null,Ee=null;return{setReversed:function(Te){be=Te},setTest:function(Te){Te?xe(n.DEPTH_TEST):F(n.DEPTH_TEST)},setMask:function(Te){te!==Te&&!N&&(n.depthMask(Te),te=Te)},setFunc:function(Te){if(be&&(Te=Py[Te]),le!==Te){switch(Te){case nl:n.depthFunc(n.NEVER);break;case il:n.depthFunc(n.ALWAYS);break;case rl:n.depthFunc(n.LESS);break;case Cr:n.depthFunc(n.LEQUAL);break;case sl:n.depthFunc(n.EQUAL);break;case ol:n.depthFunc(n.GEQUAL);break;case al:n.depthFunc(n.GREATER);break;case ll:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}le=Te}},setLocked:function(Te){N=Te},setClear:function(Te){Ee!==Te&&(n.clearDepth(Te),Ee=Te)},reset:function(){N=!1,te=null,le=null,Ee=null}}}function i(){let N=!1,be=null,te=null,le=null,Ee=null,Te=null,Ke=null,St=null,Vt=null;return{setTest:function(Qe){N||(Qe?xe(n.STENCIL_TEST):F(n.STENCIL_TEST))},setMask:function(Qe){be!==Qe&&!N&&(n.stencilMask(Qe),be=Qe)},setFunc:function(Qe,Gt,Ln){(te!==Qe||le!==Gt||Ee!==Ln)&&(n.stencilFunc(Qe,Gt,Ln),te=Qe,le=Gt,Ee=Ln)},setOp:function(Qe,Gt,Ln){(Te!==Qe||Ke!==Gt||St!==Ln)&&(n.stencilOp(Qe,Gt,Ln),Te=Qe,Ke=Gt,St=Ln)},setLocked:function(Qe){N=Qe},setClear:function(Qe){Vt!==Qe&&(n.clearStencil(Qe),Vt=Qe)},reset:function(){N=!1,be=null,te=null,le=null,Ee=null,Te=null,Ke=null,St=null,Vt=null}}}const r=new e,s=new t,o=new i,a=new WeakMap,l=new WeakMap;let c={},u={},f=new WeakMap,d=[],h=null,S=!1,E=null,m=null,p=null,M=null,_=null,y=null,P=null,R=new et(0,0,0),w=0,I=!1,k=null,x=null,b=null,U=null,X=null;const Q=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let oe=!1,q=0;const J=n.getParameter(n.VERSION);J.indexOf("WebGL")!==-1?(q=parseFloat(/^WebGL (\d)/.exec(J)[1]),oe=q>=1):J.indexOf("OpenGL ES")!==-1&&(q=parseFloat(/^OpenGL ES (\d)/.exec(J)[1]),oe=q>=2);let H=null,me={};const _e=n.getParameter(n.SCISSOR_BOX),Me=n.getParameter(n.VIEWPORT),Ie=new at().fromArray(_e),Xe=new at().fromArray(Me);function ee(N,be,te,le){const Ee=new Uint8Array(4),Te=n.createTexture();n.bindTexture(N,Te),n.texParameteri(N,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(N,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ke=0;Ke<te;Ke++)N===n.TEXTURE_3D||N===n.TEXTURE_2D_ARRAY?n.texImage3D(be,0,n.RGBA,1,1,le,0,n.RGBA,n.UNSIGNED_BYTE,Ee):n.texImage2D(be+Ke,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,Ee);return Te}const fe={};fe[n.TEXTURE_2D]=ee(n.TEXTURE_2D,n.TEXTURE_2D,1),fe[n.TEXTURE_CUBE_MAP]=ee(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),fe[n.TEXTURE_2D_ARRAY]=ee(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),fe[n.TEXTURE_3D]=ee(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),o.setClear(0),xe(n.DEPTH_TEST),s.setFunc(Cr),O(!1),Z(Tu),xe(n.CULL_FACE),g(pi);function xe(N){c[N]!==!0&&(n.enable(N),c[N]=!0)}function F(N){c[N]!==!1&&(n.disable(N),c[N]=!1)}function se(N,be){return u[N]!==be?(n.bindFramebuffer(N,be),u[N]=be,N===n.DRAW_FRAMEBUFFER&&(u[n.FRAMEBUFFER]=be),N===n.FRAMEBUFFER&&(u[n.DRAW_FRAMEBUFFER]=be),!0):!1}function ne(N,be){let te=d,le=!1;if(N){te=f.get(be),te===void 0&&(te=[],f.set(be,te));const Ee=N.textures;if(te.length!==Ee.length||te[0]!==n.COLOR_ATTACHMENT0){for(let Te=0,Ke=Ee.length;Te<Ke;Te++)te[Te]=n.COLOR_ATTACHMENT0+Te;te.length=Ee.length,le=!0}}else te[0]!==n.BACK&&(te[0]=n.BACK,le=!0);le&&n.drawBuffers(te)}function de(N){return h!==N?(n.useProgram(N),h=N,!0):!1}const we={[Oi]:n.FUNC_ADD,[C_]:n.FUNC_SUBTRACT,[P_]:n.FUNC_REVERSE_SUBTRACT};we[L_]=n.MIN,we[D_]=n.MAX;const Pe={[I_]:n.ZERO,[U_]:n.ONE,[N_]:n.SRC_COLOR,[el]:n.SRC_ALPHA,[H_]:n.SRC_ALPHA_SATURATE,[k_]:n.DST_COLOR,[O_]:n.DST_ALPHA,[F_]:n.ONE_MINUS_SRC_COLOR,[tl]:n.ONE_MINUS_SRC_ALPHA,[z_]:n.ONE_MINUS_DST_COLOR,[B_]:n.ONE_MINUS_DST_ALPHA,[V_]:n.CONSTANT_COLOR,[G_]:n.ONE_MINUS_CONSTANT_COLOR,[W_]:n.CONSTANT_ALPHA,[X_]:n.ONE_MINUS_CONSTANT_ALPHA};function g(N,be,te,le,Ee,Te,Ke,St,Vt,Qe){if(N===pi){S===!0&&(F(n.BLEND),S=!1);return}if(S===!1&&(xe(n.BLEND),S=!0),N!==R_){if(N!==E||Qe!==I){if((m!==Oi||_!==Oi)&&(n.blendEquation(n.FUNC_ADD),m=Oi,_=Oi),Qe)switch(N){case Mr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case wu:n.blendFunc(n.ONE,n.ONE);break;case Ru:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Cu:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}else switch(N){case Mr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case wu:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Ru:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Cu:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}p=null,M=null,y=null,P=null,R.set(0,0,0),w=0,E=N,I=Qe}return}Ee=Ee||be,Te=Te||te,Ke=Ke||le,(be!==m||Ee!==_)&&(n.blendEquationSeparate(we[be],we[Ee]),m=be,_=Ee),(te!==p||le!==M||Te!==y||Ke!==P)&&(n.blendFuncSeparate(Pe[te],Pe[le],Pe[Te],Pe[Ke]),p=te,M=le,y=Te,P=Ke),(St.equals(R)===!1||Vt!==w)&&(n.blendColor(St.r,St.g,St.b,Vt),R.copy(St),w=Vt),E=N,I=!1}function L(N,be){N.side===Gn?F(n.CULL_FACE):xe(n.CULL_FACE);let te=N.side===Wt;be&&(te=!te),O(te),N.blending===Mr&&N.transparent===!1?g(pi):g(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),s.setFunc(N.depthFunc),s.setTest(N.depthTest),s.setMask(N.depthWrite),r.setMask(N.colorWrite);const le=N.stencilWrite;o.setTest(le),le&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),ie(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?xe(n.SAMPLE_ALPHA_TO_COVERAGE):F(n.SAMPLE_ALPHA_TO_COVERAGE)}function O(N){k!==N&&(N?n.frontFace(n.CW):n.frontFace(n.CCW),k=N)}function Z(N){N!==b_?(xe(n.CULL_FACE),N!==x&&(N===Tu?n.cullFace(n.BACK):N===T_?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):F(n.CULL_FACE),x=N}function W(N){N!==b&&(oe&&n.lineWidth(N),b=N)}function ie(N,be,te){N?(xe(n.POLYGON_OFFSET_FILL),(U!==be||X!==te)&&(n.polygonOffset(be,te),U=be,X=te)):F(n.POLYGON_OFFSET_FILL)}function re(N){N?xe(n.SCISSOR_TEST):F(n.SCISSOR_TEST)}function A(N){N===void 0&&(N=n.TEXTURE0+Q-1),H!==N&&(n.activeTexture(N),H=N)}function v(N,be,te){te===void 0&&(H===null?te=n.TEXTURE0+Q-1:te=H);let le=me[te];le===void 0&&(le={type:void 0,texture:void 0},me[te]=le),(le.type!==N||le.texture!==be)&&(H!==te&&(n.activeTexture(te),H=te),n.bindTexture(N,be||fe[N]),le.type=N,le.texture=be)}function D(){const N=me[H];N!==void 0&&N.type!==void 0&&(n.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function j(){try{n.compressedTexImage2D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function G(){try{n.compressedTexImage3D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function V(){try{n.texSubImage2D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ce(){try{n.texSubImage3D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ae(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function pe(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Re(){try{n.texStorage2D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ue(){try{n.texStorage3D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ve(){try{n.texImage2D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Ue(){try{n.texImage3D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Le(N){Ie.equals(N)===!1&&(n.scissor(N.x,N.y,N.z,N.w),Ie.copy(N))}function ye(N){Xe.equals(N)===!1&&(n.viewport(N.x,N.y,N.z,N.w),Xe.copy(N))}function je(N,be){let te=l.get(be);te===void 0&&(te=new WeakMap,l.set(be,te));let le=te.get(N);le===void 0&&(le=n.getUniformBlockIndex(be,N.name),te.set(N,le))}function Ne(N,be){const le=l.get(be).get(N);a.get(be)!==le&&(n.uniformBlockBinding(be,le,N.__bindingPointIndex),a.set(be,le))}function $e(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),c={},H=null,me={},u={},f=new WeakMap,d=[],h=null,S=!1,E=null,m=null,p=null,M=null,_=null,y=null,P=null,R=new et(0,0,0),w=0,I=!1,k=null,x=null,b=null,U=null,X=null,Ie.set(0,0,n.canvas.width,n.canvas.height),Xe.set(0,0,n.canvas.width,n.canvas.height),r.reset(),s.reset(),o.reset()}return{buffers:{color:r,depth:s,stencil:o},enable:xe,disable:F,bindFramebuffer:se,drawBuffers:ne,useProgram:de,setBlending:g,setMaterial:L,setFlipSided:O,setCullFace:Z,setLineWidth:W,setPolygonOffset:ie,setScissorTest:re,activeTexture:A,bindTexture:v,unbindTexture:D,compressedTexImage2D:j,compressedTexImage3D:G,texImage2D:ve,texImage3D:Ue,updateUBOMapping:je,uniformBlockBinding:Ne,texStorage2D:Re,texStorage3D:ue,texSubImage2D:V,texSubImage3D:ce,compressedTexSubImage2D:ae,compressedTexSubImage3D:pe,scissor:Le,viewport:ye,reset:$e}}function Mf(n,e,t,i){const r=Dy(i);switch(t){case _h:return n*e;case xh:return n*e;case Sh:return n*e*2;case Mh:return n*e/r.components*r.byteLength;case uc:return n*e/r.components*r.byteLength;case yh:return n*e*2/r.components*r.byteLength;case fc:return n*e*2/r.components*r.byteLength;case vh:return n*e*3/r.components*r.byteLength;case mn:return n*e*4/r.components*r.byteLength;case dc:return n*e*4/r.components*r.byteLength;case io:case ro:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*8;case so:case oo:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case pl:case gl:return Math.max(n,16)*Math.max(e,8)/4;case hl:case ml:return Math.max(n,8)*Math.max(e,8)/2;case _l:case vl:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*8;case xl:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case Sl:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case Ml:return Math.floor((n+4)/5)*Math.floor((e+3)/4)*16;case yl:return Math.floor((n+4)/5)*Math.floor((e+4)/5)*16;case El:return Math.floor((n+5)/6)*Math.floor((e+4)/5)*16;case Al:return Math.floor((n+5)/6)*Math.floor((e+5)/6)*16;case bl:return Math.floor((n+7)/8)*Math.floor((e+4)/5)*16;case Tl:return Math.floor((n+7)/8)*Math.floor((e+5)/6)*16;case wl:return Math.floor((n+7)/8)*Math.floor((e+7)/8)*16;case Rl:return Math.floor((n+9)/10)*Math.floor((e+4)/5)*16;case Cl:return Math.floor((n+9)/10)*Math.floor((e+5)/6)*16;case Pl:return Math.floor((n+9)/10)*Math.floor((e+7)/8)*16;case Ll:return Math.floor((n+9)/10)*Math.floor((e+9)/10)*16;case Dl:return Math.floor((n+11)/12)*Math.floor((e+9)/10)*16;case Il:return Math.floor((n+11)/12)*Math.floor((e+11)/12)*16;case ao:case Ul:case Nl:return Math.ceil(n/4)*Math.ceil(e/4)*16;case Eh:case Fl:return Math.ceil(n/4)*Math.ceil(e/4)*8;case Ol:case Bl:return Math.ceil(n/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function Dy(n){switch(n){case qn:case ph:return{byteLength:1,components:1};case hs:case mh:case xs:return{byteLength:2,components:1};case lc:case cc:return{byteLength:2,components:4};case Xi:case ac:case Wn:return{byteLength:4,components:1};case gh:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${n}.`)}function Iy(n,e,t,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Je,u=new WeakMap;let f;const d=new WeakMap;let h=!1;try{h=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(A,v){return h?new OffscreenCanvas(A,v):Mo("canvas")}function E(A,v,D){let j=1;const G=re(A);if((G.width>D||G.height>D)&&(j=D/Math.max(G.width,G.height)),j<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const V=Math.floor(j*G.width),ce=Math.floor(j*G.height);f===void 0&&(f=S(V,ce));const ae=v?S(V,ce):f;return ae.width=V,ae.height=ce,ae.getContext("2d").drawImage(A,0,0,V,ce),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+G.width+"x"+G.height+") to ("+V+"x"+ce+")."),ae}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+G.width+"x"+G.height+")."),A;return A}function m(A){return A.generateMipmaps&&A.minFilter!==on&&A.minFilter!==hn}function p(A){n.generateMipmap(A)}function M(A,v,D,j,G=!1){if(A!==null){if(n[A]!==void 0)return n[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let V=v;if(v===n.RED&&(D===n.FLOAT&&(V=n.R32F),D===n.HALF_FLOAT&&(V=n.R16F),D===n.UNSIGNED_BYTE&&(V=n.R8)),v===n.RED_INTEGER&&(D===n.UNSIGNED_BYTE&&(V=n.R8UI),D===n.UNSIGNED_SHORT&&(V=n.R16UI),D===n.UNSIGNED_INT&&(V=n.R32UI),D===n.BYTE&&(V=n.R8I),D===n.SHORT&&(V=n.R16I),D===n.INT&&(V=n.R32I)),v===n.RG&&(D===n.FLOAT&&(V=n.RG32F),D===n.HALF_FLOAT&&(V=n.RG16F),D===n.UNSIGNED_BYTE&&(V=n.RG8)),v===n.RG_INTEGER&&(D===n.UNSIGNED_BYTE&&(V=n.RG8UI),D===n.UNSIGNED_SHORT&&(V=n.RG16UI),D===n.UNSIGNED_INT&&(V=n.RG32UI),D===n.BYTE&&(V=n.RG8I),D===n.SHORT&&(V=n.RG16I),D===n.INT&&(V=n.RG32I)),v===n.RGB_INTEGER&&(D===n.UNSIGNED_BYTE&&(V=n.RGB8UI),D===n.UNSIGNED_SHORT&&(V=n.RGB16UI),D===n.UNSIGNED_INT&&(V=n.RGB32UI),D===n.BYTE&&(V=n.RGB8I),D===n.SHORT&&(V=n.RGB16I),D===n.INT&&(V=n.RGB32I)),v===n.RGBA_INTEGER&&(D===n.UNSIGNED_BYTE&&(V=n.RGBA8UI),D===n.UNSIGNED_SHORT&&(V=n.RGBA16UI),D===n.UNSIGNED_INT&&(V=n.RGBA32UI),D===n.BYTE&&(V=n.RGBA8I),D===n.SHORT&&(V=n.RGBA16I),D===n.INT&&(V=n.RGBA32I)),v===n.RGB&&D===n.UNSIGNED_INT_5_9_9_9_REV&&(V=n.RGB9_E5),v===n.RGBA){const ce=G?_o:rt.getTransfer(j);D===n.FLOAT&&(V=n.RGBA32F),D===n.HALF_FLOAT&&(V=n.RGBA16F),D===n.UNSIGNED_BYTE&&(V=ce===dt?n.SRGB8_ALPHA8:n.RGBA8),D===n.UNSIGNED_SHORT_4_4_4_4&&(V=n.RGBA4),D===n.UNSIGNED_SHORT_5_5_5_1&&(V=n.RGB5_A1)}return(V===n.R16F||V===n.R32F||V===n.RG16F||V===n.RG32F||V===n.RGBA16F||V===n.RGBA32F)&&e.get("EXT_color_buffer_float"),V}function _(A,v){let D;return A?v===null||v===Xi||v===Dr?D=n.DEPTH24_STENCIL8:v===Wn?D=n.DEPTH32F_STENCIL8:v===hs&&(D=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Xi||v===Dr?D=n.DEPTH_COMPONENT24:v===Wn?D=n.DEPTH_COMPONENT32F:v===hs&&(D=n.DEPTH_COMPONENT16),D}function y(A,v){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==on&&A.minFilter!==hn?Math.log2(Math.max(v.width,v.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?v.mipmaps.length:1}function P(A){const v=A.target;v.removeEventListener("dispose",P),w(v),v.isVideoTexture&&u.delete(v)}function R(A){const v=A.target;v.removeEventListener("dispose",R),k(v)}function w(A){const v=i.get(A);if(v.__webglInit===void 0)return;const D=A.source,j=d.get(D);if(j){const G=j[v.__cacheKey];G.usedTimes--,G.usedTimes===0&&I(A),Object.keys(j).length===0&&d.delete(D)}i.remove(A)}function I(A){const v=i.get(A);n.deleteTexture(v.__webglTexture);const D=A.source,j=d.get(D);delete j[v.__cacheKey],o.memory.textures--}function k(A){const v=i.get(A);if(A.depthTexture&&A.depthTexture.dispose(),A.isWebGLCubeRenderTarget)for(let j=0;j<6;j++){if(Array.isArray(v.__webglFramebuffer[j]))for(let G=0;G<v.__webglFramebuffer[j].length;G++)n.deleteFramebuffer(v.__webglFramebuffer[j][G]);else n.deleteFramebuffer(v.__webglFramebuffer[j]);v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer[j])}else{if(Array.isArray(v.__webglFramebuffer))for(let j=0;j<v.__webglFramebuffer.length;j++)n.deleteFramebuffer(v.__webglFramebuffer[j]);else n.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&n.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let j=0;j<v.__webglColorRenderbuffer.length;j++)v.__webglColorRenderbuffer[j]&&n.deleteRenderbuffer(v.__webglColorRenderbuffer[j]);v.__webglDepthRenderbuffer&&n.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const D=A.textures;for(let j=0,G=D.length;j<G;j++){const V=i.get(D[j]);V.__webglTexture&&(n.deleteTexture(V.__webglTexture),o.memory.textures--),i.remove(D[j])}i.remove(A)}let x=0;function b(){x=0}function U(){const A=x;return A>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+r.maxTextures),x+=1,A}function X(A){const v=[];return v.push(A.wrapS),v.push(A.wrapT),v.push(A.wrapR||0),v.push(A.magFilter),v.push(A.minFilter),v.push(A.anisotropy),v.push(A.internalFormat),v.push(A.format),v.push(A.type),v.push(A.generateMipmaps),v.push(A.premultiplyAlpha),v.push(A.flipY),v.push(A.unpackAlignment),v.push(A.colorSpace),v.join()}function Q(A,v){const D=i.get(A);if(A.isVideoTexture&&W(A),A.isRenderTargetTexture===!1&&A.version>0&&D.__version!==A.version){const j=A.image;if(j===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(j.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Xe(D,A,v);return}}t.bindTexture(n.TEXTURE_2D,D.__webglTexture,n.TEXTURE0+v)}function oe(A,v){const D=i.get(A);if(A.version>0&&D.__version!==A.version){Xe(D,A,v);return}t.bindTexture(n.TEXTURE_2D_ARRAY,D.__webglTexture,n.TEXTURE0+v)}function q(A,v){const D=i.get(A);if(A.version>0&&D.__version!==A.version){Xe(D,A,v);return}t.bindTexture(n.TEXTURE_3D,D.__webglTexture,n.TEXTURE0+v)}function J(A,v){const D=i.get(A);if(A.version>0&&D.__version!==A.version){ee(D,A,v);return}t.bindTexture(n.TEXTURE_CUBE_MAP,D.__webglTexture,n.TEXTURE0+v)}const H={[fl]:n.REPEAT,[ki]:n.CLAMP_TO_EDGE,[dl]:n.MIRRORED_REPEAT},me={[on]:n.NEAREST,[t0]:n.NEAREST_MIPMAP_NEAREST,[Ps]:n.NEAREST_MIPMAP_LINEAR,[hn]:n.LINEAR,[aa]:n.LINEAR_MIPMAP_NEAREST,[zi]:n.LINEAR_MIPMAP_LINEAR},_e={[s0]:n.NEVER,[f0]:n.ALWAYS,[o0]:n.LESS,[bh]:n.LEQUAL,[a0]:n.EQUAL,[u0]:n.GEQUAL,[l0]:n.GREATER,[c0]:n.NOTEQUAL};function Me(A,v){if(v.type===Wn&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===hn||v.magFilter===aa||v.magFilter===Ps||v.magFilter===zi||v.minFilter===hn||v.minFilter===aa||v.minFilter===Ps||v.minFilter===zi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(A,n.TEXTURE_WRAP_S,H[v.wrapS]),n.texParameteri(A,n.TEXTURE_WRAP_T,H[v.wrapT]),(A===n.TEXTURE_3D||A===n.TEXTURE_2D_ARRAY)&&n.texParameteri(A,n.TEXTURE_WRAP_R,H[v.wrapR]),n.texParameteri(A,n.TEXTURE_MAG_FILTER,me[v.magFilter]),n.texParameteri(A,n.TEXTURE_MIN_FILTER,me[v.minFilter]),v.compareFunction&&(n.texParameteri(A,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(A,n.TEXTURE_COMPARE_FUNC,_e[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===on||v.minFilter!==Ps&&v.minFilter!==zi||v.type===Wn&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||i.get(v).__currentAnisotropy){const D=e.get("EXT_texture_filter_anisotropic");n.texParameterf(A,D.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),i.get(v).__currentAnisotropy=v.anisotropy}}}function Ie(A,v){let D=!1;A.__webglInit===void 0&&(A.__webglInit=!0,v.addEventListener("dispose",P));const j=v.source;let G=d.get(j);G===void 0&&(G={},d.set(j,G));const V=X(v);if(V!==A.__cacheKey){G[V]===void 0&&(G[V]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,D=!0),G[V].usedTimes++;const ce=G[A.__cacheKey];ce!==void 0&&(G[A.__cacheKey].usedTimes--,ce.usedTimes===0&&I(v)),A.__cacheKey=V,A.__webglTexture=G[V].texture}return D}function Xe(A,v,D){let j=n.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(j=n.TEXTURE_2D_ARRAY),v.isData3DTexture&&(j=n.TEXTURE_3D);const G=Ie(A,v),V=v.source;t.bindTexture(j,A.__webglTexture,n.TEXTURE0+D);const ce=i.get(V);if(V.version!==ce.__version||G===!0){t.activeTexture(n.TEXTURE0+D);const ae=rt.getPrimaries(rt.workingColorSpace),pe=v.colorSpace===di?null:rt.getPrimaries(v.colorSpace),Re=v.colorSpace===di||ae===pe?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Re);let ue=E(v.image,!1,r.maxTextureSize);ue=ie(v,ue);const ve=s.convert(v.format,v.colorSpace),Ue=s.convert(v.type);let Le=M(v.internalFormat,ve,Ue,v.colorSpace,v.isVideoTexture);Me(j,v);let ye;const je=v.mipmaps,Ne=v.isVideoTexture!==!0,$e=ce.__version===void 0||G===!0,N=V.dataReady,be=y(v,ue);if(v.isDepthTexture)Le=_(v.format===Ir,v.type),$e&&(Ne?t.texStorage2D(n.TEXTURE_2D,1,Le,ue.width,ue.height):t.texImage2D(n.TEXTURE_2D,0,Le,ue.width,ue.height,0,ve,Ue,null));else if(v.isDataTexture)if(je.length>0){Ne&&$e&&t.texStorage2D(n.TEXTURE_2D,be,Le,je[0].width,je[0].height);for(let te=0,le=je.length;te<le;te++)ye=je[te],Ne?N&&t.texSubImage2D(n.TEXTURE_2D,te,0,0,ye.width,ye.height,ve,Ue,ye.data):t.texImage2D(n.TEXTURE_2D,te,Le,ye.width,ye.height,0,ve,Ue,ye.data);v.generateMipmaps=!1}else Ne?($e&&t.texStorage2D(n.TEXTURE_2D,be,Le,ue.width,ue.height),N&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ue.width,ue.height,ve,Ue,ue.data)):t.texImage2D(n.TEXTURE_2D,0,Le,ue.width,ue.height,0,ve,Ue,ue.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Ne&&$e&&t.texStorage3D(n.TEXTURE_2D_ARRAY,be,Le,je[0].width,je[0].height,ue.depth);for(let te=0,le=je.length;te<le;te++)if(ye=je[te],v.format!==mn)if(ve!==null)if(Ne){if(N)if(v.layerUpdates.size>0){const Ee=Mf(ye.width,ye.height,v.format,v.type);for(const Te of v.layerUpdates){const Ke=ye.data.subarray(Te*Ee/ye.data.BYTES_PER_ELEMENT,(Te+1)*Ee/ye.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,te,0,0,Te,ye.width,ye.height,1,ve,Ke,0,0)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,te,0,0,0,ye.width,ye.height,ue.depth,ve,ye.data,0,0)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,te,Le,ye.width,ye.height,ue.depth,0,ye.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ne?N&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,te,0,0,0,ye.width,ye.height,ue.depth,ve,Ue,ye.data):t.texImage3D(n.TEXTURE_2D_ARRAY,te,Le,ye.width,ye.height,ue.depth,0,ve,Ue,ye.data)}else{Ne&&$e&&t.texStorage2D(n.TEXTURE_2D,be,Le,je[0].width,je[0].height);for(let te=0,le=je.length;te<le;te++)ye=je[te],v.format!==mn?ve!==null?Ne?N&&t.compressedTexSubImage2D(n.TEXTURE_2D,te,0,0,ye.width,ye.height,ve,ye.data):t.compressedTexImage2D(n.TEXTURE_2D,te,Le,ye.width,ye.height,0,ye.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ne?N&&t.texSubImage2D(n.TEXTURE_2D,te,0,0,ye.width,ye.height,ve,Ue,ye.data):t.texImage2D(n.TEXTURE_2D,te,Le,ye.width,ye.height,0,ve,Ue,ye.data)}else if(v.isDataArrayTexture)if(Ne){if($e&&t.texStorage3D(n.TEXTURE_2D_ARRAY,be,Le,ue.width,ue.height,ue.depth),N)if(v.layerUpdates.size>0){const te=Mf(ue.width,ue.height,v.format,v.type);for(const le of v.layerUpdates){const Ee=ue.data.subarray(le*te/ue.data.BYTES_PER_ELEMENT,(le+1)*te/ue.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,le,ue.width,ue.height,1,ve,Ue,Ee)}v.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ue.width,ue.height,ue.depth,ve,Ue,ue.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Le,ue.width,ue.height,ue.depth,0,ve,Ue,ue.data);else if(v.isData3DTexture)Ne?($e&&t.texStorage3D(n.TEXTURE_3D,be,Le,ue.width,ue.height,ue.depth),N&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ue.width,ue.height,ue.depth,ve,Ue,ue.data)):t.texImage3D(n.TEXTURE_3D,0,Le,ue.width,ue.height,ue.depth,0,ve,Ue,ue.data);else if(v.isFramebufferTexture){if($e)if(Ne)t.texStorage2D(n.TEXTURE_2D,be,Le,ue.width,ue.height);else{let te=ue.width,le=ue.height;for(let Ee=0;Ee<be;Ee++)t.texImage2D(n.TEXTURE_2D,Ee,Le,te,le,0,ve,Ue,null),te>>=1,le>>=1}}else if(je.length>0){if(Ne&&$e){const te=re(je[0]);t.texStorage2D(n.TEXTURE_2D,be,Le,te.width,te.height)}for(let te=0,le=je.length;te<le;te++)ye=je[te],Ne?N&&t.texSubImage2D(n.TEXTURE_2D,te,0,0,ve,Ue,ye):t.texImage2D(n.TEXTURE_2D,te,Le,ve,Ue,ye);v.generateMipmaps=!1}else if(Ne){if($e){const te=re(ue);t.texStorage2D(n.TEXTURE_2D,be,Le,te.width,te.height)}N&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ve,Ue,ue)}else t.texImage2D(n.TEXTURE_2D,0,Le,ve,Ue,ue);m(v)&&p(j),ce.__version=V.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function ee(A,v,D){if(v.image.length!==6)return;const j=Ie(A,v),G=v.source;t.bindTexture(n.TEXTURE_CUBE_MAP,A.__webglTexture,n.TEXTURE0+D);const V=i.get(G);if(G.version!==V.__version||j===!0){t.activeTexture(n.TEXTURE0+D);const ce=rt.getPrimaries(rt.workingColorSpace),ae=v.colorSpace===di?null:rt.getPrimaries(v.colorSpace),pe=v.colorSpace===di||ce===ae?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,pe);const Re=v.isCompressedTexture||v.image[0].isCompressedTexture,ue=v.image[0]&&v.image[0].isDataTexture,ve=[];for(let le=0;le<6;le++)!Re&&!ue?ve[le]=E(v.image[le],!0,r.maxCubemapSize):ve[le]=ue?v.image[le].image:v.image[le],ve[le]=ie(v,ve[le]);const Ue=ve[0],Le=s.convert(v.format,v.colorSpace),ye=s.convert(v.type),je=M(v.internalFormat,Le,ye,v.colorSpace),Ne=v.isVideoTexture!==!0,$e=V.__version===void 0||j===!0,N=G.dataReady;let be=y(v,Ue);Me(n.TEXTURE_CUBE_MAP,v);let te;if(Re){Ne&&$e&&t.texStorage2D(n.TEXTURE_CUBE_MAP,be,je,Ue.width,Ue.height);for(let le=0;le<6;le++){te=ve[le].mipmaps;for(let Ee=0;Ee<te.length;Ee++){const Te=te[Ee];v.format!==mn?Le!==null?Ne?N&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Ee,0,0,Te.width,Te.height,Le,Te.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Ee,je,Te.width,Te.height,0,Te.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ne?N&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Ee,0,0,Te.width,Te.height,Le,ye,Te.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Ee,je,Te.width,Te.height,0,Le,ye,Te.data)}}}else{if(te=v.mipmaps,Ne&&$e){te.length>0&&be++;const le=re(ve[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,be,je,le.width,le.height)}for(let le=0;le<6;le++)if(ue){Ne?N&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,0,0,ve[le].width,ve[le].height,Le,ye,ve[le].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,je,ve[le].width,ve[le].height,0,Le,ye,ve[le].data);for(let Ee=0;Ee<te.length;Ee++){const Ke=te[Ee].image[le].image;Ne?N&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Ee+1,0,0,Ke.width,Ke.height,Le,ye,Ke.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Ee+1,je,Ke.width,Ke.height,0,Le,ye,Ke.data)}}else{Ne?N&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,0,0,Le,ye,ve[le]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,je,Le,ye,ve[le]);for(let Ee=0;Ee<te.length;Ee++){const Te=te[Ee];Ne?N&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Ee+1,0,0,Le,ye,Te.image[le]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Ee+1,je,Le,ye,Te.image[le])}}}m(v)&&p(n.TEXTURE_CUBE_MAP),V.__version=G.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function fe(A,v,D,j,G,V){const ce=s.convert(D.format,D.colorSpace),ae=s.convert(D.type),pe=M(D.internalFormat,ce,ae,D.colorSpace);if(!i.get(v).__hasExternalTextures){const ue=Math.max(1,v.width>>V),ve=Math.max(1,v.height>>V);G===n.TEXTURE_3D||G===n.TEXTURE_2D_ARRAY?t.texImage3D(G,V,pe,ue,ve,v.depth,0,ce,ae,null):t.texImage2D(G,V,pe,ue,ve,0,ce,ae,null)}t.bindFramebuffer(n.FRAMEBUFFER,A),Z(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,j,G,i.get(D).__webglTexture,0,O(v)):(G===n.TEXTURE_2D||G>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&G<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,j,G,i.get(D).__webglTexture,V),t.bindFramebuffer(n.FRAMEBUFFER,null)}function xe(A,v,D){if(n.bindRenderbuffer(n.RENDERBUFFER,A),v.depthBuffer){const j=v.depthTexture,G=j&&j.isDepthTexture?j.type:null,V=_(v.stencilBuffer,G),ce=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ae=O(v);Z(v)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ae,V,v.width,v.height):D?n.renderbufferStorageMultisample(n.RENDERBUFFER,ae,V,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,V,v.width,v.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,ce,n.RENDERBUFFER,A)}else{const j=v.textures;for(let G=0;G<j.length;G++){const V=j[G],ce=s.convert(V.format,V.colorSpace),ae=s.convert(V.type),pe=M(V.internalFormat,ce,ae,V.colorSpace),Re=O(v);D&&Z(v)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Re,pe,v.width,v.height):Z(v)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Re,pe,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,pe,v.width,v.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function F(A,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,A),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(v.depthTexture).__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),Q(v.depthTexture,0);const j=i.get(v.depthTexture).__webglTexture,G=O(v);if(v.depthTexture.format===yr)Z(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,j,0,G):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,j,0);else if(v.depthTexture.format===Ir)Z(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,j,0,G):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,j,0);else throw new Error("Unknown depthTexture format")}function se(A){const v=i.get(A),D=A.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==A.depthTexture){const j=A.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),j){const G=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,j.removeEventListener("dispose",G)};j.addEventListener("dispose",G),v.__depthDisposeCallback=G}v.__boundDepthTexture=j}if(A.depthTexture&&!v.__autoAllocateDepthBuffer){if(D)throw new Error("target.depthTexture not supported in Cube render targets");F(v.__webglFramebuffer,A)}else if(D){v.__webglDepthbuffer=[];for(let j=0;j<6;j++)if(t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[j]),v.__webglDepthbuffer[j]===void 0)v.__webglDepthbuffer[j]=n.createRenderbuffer(),xe(v.__webglDepthbuffer[j],A,!1);else{const G=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,V=v.__webglDepthbuffer[j];n.bindRenderbuffer(n.RENDERBUFFER,V),n.framebufferRenderbuffer(n.FRAMEBUFFER,G,n.RENDERBUFFER,V)}}else if(t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=n.createRenderbuffer(),xe(v.__webglDepthbuffer,A,!1);else{const j=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,G=v.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,G),n.framebufferRenderbuffer(n.FRAMEBUFFER,j,n.RENDERBUFFER,G)}t.bindFramebuffer(n.FRAMEBUFFER,null)}function ne(A,v,D){const j=i.get(A);v!==void 0&&fe(j.__webglFramebuffer,A,A.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),D!==void 0&&se(A)}function de(A){const v=A.texture,D=i.get(A),j=i.get(v);A.addEventListener("dispose",R);const G=A.textures,V=A.isWebGLCubeRenderTarget===!0,ce=G.length>1;if(ce||(j.__webglTexture===void 0&&(j.__webglTexture=n.createTexture()),j.__version=v.version,o.memory.textures++),V){D.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(v.mipmaps&&v.mipmaps.length>0){D.__webglFramebuffer[ae]=[];for(let pe=0;pe<v.mipmaps.length;pe++)D.__webglFramebuffer[ae][pe]=n.createFramebuffer()}else D.__webglFramebuffer[ae]=n.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){D.__webglFramebuffer=[];for(let ae=0;ae<v.mipmaps.length;ae++)D.__webglFramebuffer[ae]=n.createFramebuffer()}else D.__webglFramebuffer=n.createFramebuffer();if(ce)for(let ae=0,pe=G.length;ae<pe;ae++){const Re=i.get(G[ae]);Re.__webglTexture===void 0&&(Re.__webglTexture=n.createTexture(),o.memory.textures++)}if(A.samples>0&&Z(A)===!1){D.__webglMultisampledFramebuffer=n.createFramebuffer(),D.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,D.__webglMultisampledFramebuffer);for(let ae=0;ae<G.length;ae++){const pe=G[ae];D.__webglColorRenderbuffer[ae]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,D.__webglColorRenderbuffer[ae]);const Re=s.convert(pe.format,pe.colorSpace),ue=s.convert(pe.type),ve=M(pe.internalFormat,Re,ue,pe.colorSpace,A.isXRRenderTarget===!0),Ue=O(A);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ue,ve,A.width,A.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ae,n.RENDERBUFFER,D.__webglColorRenderbuffer[ae])}n.bindRenderbuffer(n.RENDERBUFFER,null),A.depthBuffer&&(D.__webglDepthRenderbuffer=n.createRenderbuffer(),xe(D.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(V){t.bindTexture(n.TEXTURE_CUBE_MAP,j.__webglTexture),Me(n.TEXTURE_CUBE_MAP,v);for(let ae=0;ae<6;ae++)if(v.mipmaps&&v.mipmaps.length>0)for(let pe=0;pe<v.mipmaps.length;pe++)fe(D.__webglFramebuffer[ae][pe],A,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,pe);else fe(D.__webglFramebuffer[ae],A,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);m(v)&&p(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ce){for(let ae=0,pe=G.length;ae<pe;ae++){const Re=G[ae],ue=i.get(Re);t.bindTexture(n.TEXTURE_2D,ue.__webglTexture),Me(n.TEXTURE_2D,Re),fe(D.__webglFramebuffer,A,Re,n.COLOR_ATTACHMENT0+ae,n.TEXTURE_2D,0),m(Re)&&p(n.TEXTURE_2D)}t.unbindTexture()}else{let ae=n.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ae=A.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ae,j.__webglTexture),Me(ae,v),v.mipmaps&&v.mipmaps.length>0)for(let pe=0;pe<v.mipmaps.length;pe++)fe(D.__webglFramebuffer[pe],A,v,n.COLOR_ATTACHMENT0,ae,pe);else fe(D.__webglFramebuffer,A,v,n.COLOR_ATTACHMENT0,ae,0);m(v)&&p(ae),t.unbindTexture()}A.depthBuffer&&se(A)}function we(A){const v=A.textures;for(let D=0,j=v.length;D<j;D++){const G=v[D];if(m(G)){const V=A.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,ce=i.get(G).__webglTexture;t.bindTexture(V,ce),p(V),t.unbindTexture()}}}const Pe=[],g=[];function L(A){if(A.samples>0){if(Z(A)===!1){const v=A.textures,D=A.width,j=A.height;let G=n.COLOR_BUFFER_BIT;const V=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ce=i.get(A),ae=v.length>1;if(ae)for(let pe=0;pe<v.length;pe++)t.bindFramebuffer(n.FRAMEBUFFER,ce.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,ce.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,ce.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ce.__webglFramebuffer);for(let pe=0;pe<v.length;pe++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(G|=n.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(G|=n.STENCIL_BUFFER_BIT)),ae){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ce.__webglColorRenderbuffer[pe]);const Re=i.get(v[pe]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Re,0)}n.blitFramebuffer(0,0,D,j,0,0,D,j,G,n.NEAREST),l===!0&&(Pe.length=0,g.length=0,Pe.push(n.COLOR_ATTACHMENT0+pe),A.depthBuffer&&A.resolveDepthBuffer===!1&&(Pe.push(V),g.push(V),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,g)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,Pe))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ae)for(let pe=0;pe<v.length;pe++){t.bindFramebuffer(n.FRAMEBUFFER,ce.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.RENDERBUFFER,ce.__webglColorRenderbuffer[pe]);const Re=i.get(v[pe]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,ce.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.TEXTURE_2D,Re,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ce.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){const v=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[v])}}}function O(A){return Math.min(r.maxSamples,A.samples)}function Z(A){const v=i.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function W(A){const v=o.render.frame;u.get(A)!==v&&(u.set(A,v),A.update())}function ie(A,v){const D=A.colorSpace,j=A.format,G=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||D!==Mi&&D!==di&&(rt.getTransfer(D)===dt?(j!==mn||G!==qn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",D)),v}function re(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=U,this.resetTextureUnits=b,this.setTexture2D=Q,this.setTexture2DArray=oe,this.setTexture3D=q,this.setTextureCube=J,this.rebindTextures=ne,this.setupRenderTarget=de,this.updateRenderTargetMipmap=we,this.updateMultisampleRenderTarget=L,this.setupDepthRenderbuffer=se,this.setupFrameBufferTexture=fe,this.useMultisampledRTT=Z}function Uy(n,e){function t(i,r=di){let s;const o=rt.getTransfer(r);if(i===qn)return n.UNSIGNED_BYTE;if(i===lc)return n.UNSIGNED_SHORT_4_4_4_4;if(i===cc)return n.UNSIGNED_SHORT_5_5_5_1;if(i===gh)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===ph)return n.BYTE;if(i===mh)return n.SHORT;if(i===hs)return n.UNSIGNED_SHORT;if(i===ac)return n.INT;if(i===Xi)return n.UNSIGNED_INT;if(i===Wn)return n.FLOAT;if(i===xs)return n.HALF_FLOAT;if(i===_h)return n.ALPHA;if(i===vh)return n.RGB;if(i===mn)return n.RGBA;if(i===xh)return n.LUMINANCE;if(i===Sh)return n.LUMINANCE_ALPHA;if(i===yr)return n.DEPTH_COMPONENT;if(i===Ir)return n.DEPTH_STENCIL;if(i===Mh)return n.RED;if(i===uc)return n.RED_INTEGER;if(i===yh)return n.RG;if(i===fc)return n.RG_INTEGER;if(i===dc)return n.RGBA_INTEGER;if(i===io||i===ro||i===so||i===oo)if(o===dt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===io)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===ro)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===so)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===oo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===io)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===ro)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===so)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===oo)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===hl||i===pl||i===ml||i===gl)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===hl)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===pl)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===ml)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===gl)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===_l||i===vl||i===xl)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===_l||i===vl)return o===dt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===xl)return o===dt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Sl||i===Ml||i===yl||i===El||i===Al||i===bl||i===Tl||i===wl||i===Rl||i===Cl||i===Pl||i===Ll||i===Dl||i===Il)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Sl)return o===dt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Ml)return o===dt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===yl)return o===dt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===El)return o===dt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Al)return o===dt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===bl)return o===dt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Tl)return o===dt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===wl)return o===dt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Rl)return o===dt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Cl)return o===dt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Pl)return o===dt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Ll)return o===dt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Dl)return o===dt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Il)return o===dt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===ao||i===Ul||i===Nl)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===ao)return o===dt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Ul)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Nl)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Eh||i===Fl||i===Ol||i===Bl)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===ao)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Fl)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Ol)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Bl)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Dr?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}class Ny extends Qt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Zs extends jt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Fy={type:"move"};class Na{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Zs,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Zs,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new $,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new $),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Zs,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new $,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new $),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const E of e.hand.values()){const m=t.getJointPose(E,i),p=this._getHandJoint(c,E);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],d=u.position.distanceTo(f.position),h=.02,S=.005;c.inputState.pinching&&d>h+S?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&d<=h-S&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=t.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Fy)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new Zs;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}const Oy=`
void main() {
...
`)])],-1))]),C("section",WE,[he(ht,{title:"Overview"},{default:qe(()=>t[1]||(t[1]=[C("h4",null,"About",-1),C("p",null," While SonicPi enables scripting generative soundscapes, I personally prefer using the live loop feature. Controlling different parameters with a MIDI controller makes playing around even more fun. ",-1),C("h4",null,"Tech",-1),C("p",null,[We(" - SonicPi "),C("br"),We(" - Ruby ")],-1)])),_:1}),he(ht,{title:"Features"},{default:qe(()=>t[2]||(t[2]=[C("h4",null,"Metronome",-1),C("p",null," Syncing to it enables playing around with sleep values without getting out of sync. - MIDI Scale Function: Remap the default MIDI control range to your desired range. ",-1),C("h4",null,"Pattern Function",-1),C("p",null," Easily define rhythmic patterns of instruments with simple Strings. ",-1),C("h4",null,"MIDI Scale Function",-1),C("p",null,"Remap the default MIDI control range to your desired range.",-1),C("h4",null,"MIDI Mapper",-1),C("p",null," Place the controls you want to map within the Switch-Case and call scale_midi(val, min, max) on them. ",-1)])),_:1}),he(ht,{title:"Resources"},{default:qe(()=>t[3]||(t[3]=[C("p",null,[C("a",{target:"_blank",href:"https://github.com/sync-tax/sonicpi_livejam_boilerplate/blob/main/live_jam_boilerplate.rb"},"→ GitHub - Code")],-1)])),_:1})])]))}},jE=Tt(XE,[["__scopeId","data-v-b17c429b"]]),$E={class:"project"},qE={class:"projectOverview"},YE={class:"mainProjectContent"},KE={class:"projectDetails"},ZE={__name:"TD_VJ_Setup",setup(n){return $n(()=>{_s(()=>{xc.highlightAll()})}),(e,t)=>(Ye(),lt("div",$E,[he(Cn),C("section",qE,[he(Pn,{title:"VJ-Setup v1.0",text:"A Touchdesigner setup that uses a MIDI controller, to navigate and control a range of dynamic visuals during a concert we hosted at AEC Deep Space. "}),C("div",YE,[he(yt,{src:"/project_images/v_spotlight_img2.jpg",alt:"VJ_System"}),t[0]||(t[0]=C("p",{class:"contentNote"}," Here’s the basic setup – each visual is housed in its own Base component. I MIDI-mapped each value, but you can also just use the sliders in the 'Constant CHOP'. ",-1)),t[1]||(t[1]=C("pre",null,[C("code",{class:"language-python"},`
...
def onValueChange(channel, sampleIndex, val, prev):
    ...
    return
`)],-1)),t[2]||(t[2]=C("p",{class:"contentNote"}," To keep things running smoothly, I added a small Python script that triggers with MIDI changes. When a visual's opacity drops to 0 (making it invisible), it turns off cooking to save on performance. ",-1))])]),C("section",KE,[he(ht,{title:"Overview"},{default:qe(()=>t[3]||(t[3]=[C("h4",null,"About",-1),C("p",null," This tool is designed to dynamically transition between different Touchdesigner patches and manipulate each patch in real-time. It allows you to VJ for various shows that require mixing multiple visual renderings. ",-1),C("h4",null,"Tools",-1),C("p",null,[We(" - Touchdesigner "),C("br"),We(" - Python "),C("br"),We(" - MIDI Controller ")],-1)])),_:1}),he(ht,{title:"Features"},{default:qe(()=>t[4]||(t[4]=[C("h4",null,"Current | v1.0",-1),C("p",null,[We(" - Seamless transitions between different patches "),C("br"),We(" - Automatically pauses processing (cooking) for patches that aren’t currently visible ")],-1),C("h4",null,"Future Updates | v2.0",-1),C("p",null,[We(" - Compact Mixing TOX | 8 slots "),C("br"),We(" - MIDI Mapping TOX | 24 knobs | 8 sliders "),C("br"),We(" - User Interface ")],-1)])),_:1}),he(ht,{title:"Resources"},{default:qe(()=>t[5]||(t[5]=[C("p",null,[C("a",{target:"_blank",href:"https://drive.google.com/drive/u/1/folders/1q3PbSq1VdNGDDjJ9tW2eAR2bjTQ2lTS3"},"→ .TOE-File + Assets")],-1)])),_:1})])]))}},JE=Tt(ZE,[["__scopeId","data-v-662f481b"]]),QE={class:"project"},eA={class:"projectOverview"},tA={class:"mainProjectContent"},nA={class:"projectDetails"},iA={__name:"808club",setup(n){return(e,t)=>(Ye(),lt("div",QE,[he(Cn),C("section",eA,[he(Pn,{title:"808club.at",text:"A website I created for our Arts & Culture club."}),C("div",tA,[he(yt,{src:"/project_images/d_websites_img1.jpg",alt:"Website"}),t[0]||(t[0]=C("p",{class:"contentNote"},"www.808club.at",-1))])]),C("section",nA,[he(ht,{title:"Overview"},{default:qe(()=>t[1]||(t[1]=[C("h4",null,"About",-1),C("p",null,[We(" I made this website for our club to post upcoming events on and a bunch of other stuff."),C("br")],-1),C("h4",null,"Tools",-1),C("p",null,[We(" - Wordpress "),C("br"),We(" - Elementor "),C("br"),We(" - Other Plugins ")],-1)])),_:1}),he(ht,{title:"Resources"},{default:qe(()=>t[2]||(t[2]=[C("p",null,[C("a",{href:"https://808club.at",target:"_blank",rel:"noopener noreferrer"},"→ Website 808Club"),C("br"),C("a",{href:"https://www.instagram.com/808club_linz/",target:"_blank",rel:"noopener noreferrer"},"→ Instagram @808club_linz")],-1)])),_:1})])]))}},rA=Tt(iA,[["__scopeId","data-v-fd95a0f9"]]),sA={class:"project"},oA={class:"projectOverview"},aA={class:"mainProjectContent"},lA={class:"projectDetails"},cA={__name:"screenprints",setup(n){return(e,t)=>(Ye(),lt("div",sA,[he(Cn),C("section",oA,[he(Pn,{title:"Screenprints",text:"Printdesigns I made for our screenprinting collective. → DURCH"}),C("div",aA,[he(yt,{src:"/project_images/d_durch_img3.jpg",alt:"Printdesign"}),t[0]||(t[0]=C("p",{class:"contentNote"},"Printdesign - Big Brother - Procreate & TD",-1)),he(yt,{src:"/project_images/d_durch_img2.jpg",alt:"Printdesign"}),t[1]||(t[1]=C("p",{class:"contentNote"},"Printdesign - Random Doodle - Procreate",-1)),he(yt,{src:"/project_images/d_durch_img4.jpg",alt:"Printdesign"}),t[2]||(t[2]=C("p",{class:"contentNote"},"Printdesign - Bananana - TD",-1)),he(yt,{src:"/project_images/d_durch_img1.jpg",alt:"Printdesign"}),t[3]||(t[3]=C("p",{class:"contentNote"}," Printdesign - Beeware - Ink Marker & Illustrator ",-1)),he(yt,{src:"/project_images/d_durch_img5.jpg",alt:"Printdesign"}),t[4]||(t[4]=C("p",{class:"contentNote"},"Printdesign - VOID - Touchdesigner",-1)),he(yt,{src:"/project_images/d_durch_img6.jpg",alt:"Printdesign"}),t[5]||(t[5]=C("p",{class:"contentNote"}," Printdesign - Shroompa Mario - Inkpens & Procreate ",-1)),he(yt,{src:"/project_images/d_durch_img7.jpg",alt:"Printdesign"}),t[6]||(t[6]=C("p",{class:"contentNote"},"Printdesign - Wond - Procreate",-1))])]),C("section",lA,[he(ht,{title:"Overview"},{default:qe(()=>t[7]||(t[7]=[C("h4",null,"About",-1),C("p",null," A couple of friends and I started a small artist collective where we create print designs and screen print them in my home workshop. ",-1),C("h4",null,"Tools",-1),C("p",null,[We(" - Screenprinting stuff "),C("br"),We(" - Pens & Paper "),C("br"),We(" - Designsoftware ")],-1)])),_:1}),he(ht,{title:"Resources"},{default:qe(()=>t[8]||(t[8]=[C("p",null,[C("a",{href:"https://www.instagram.com/durch.durch.durch/",target:"_blank",rel:"noopener noreferrer"},"→ Instagram @durch.durch.durch")],-1)])),_:1})])]))}},uA=Tt(cA,[["__scopeId","data-v-16a6a1fc"]]),fA={class:"project"},dA={class:"projectOverview"},hA={class:"mainProjectContent"},pA={class:"imageContainer"},mA={class:"imageContainer"},gA={class:"projectDetails"},_A={__name:"event_posters",setup(n){return(e,t)=>(Ye(),lt("div",fA,[he(Cn),C("section",dA,[he(Pn,{title:"Event Posters",text:"Poster & Flyer Designs I made for the 808Club."}),C("div",hA,[C("div",pA,[he(yt,{src:"/project_images/d_808_img2.jpg",alt:"Flyer"}),he(yt,{src:"/project_images/d_808_img3.jpg",alt:"Flyer"})]),t[0]||(t[0]=C("p",{style:{"text-align":"center"},class:"contentNote"}," Flyer - House of Arts #1- Affinity & Procreate ",-1)),t[1]||(t[1]=C("p",{style:{"text-align":"center"},class:"contentNote"}," Flyer - Game of Skate #1- Affinity ",-1)),C("div",mA,[he(yt,{src:"/project_images/d_808_img5.jpg",alt:"Flyer"}),he(yt,{src:"/project_images/d_808_img4.jpg",alt:"Flyer"})]),t[2]||(t[2]=C("p",{style:{"text-align":"center"},class:"contentNote"}," Flyer - House of Arts #2- Photoshop | Event sadly canceled :( ",-1)),t[3]||(t[3]=C("p",{style:{"text-align":"center"},class:"contentNote"}," Flyer - Game of Skate #2- Affinity ",-1))])]),C("section",gA,[he(ht,{title:"Overview"},{default:qe(()=>t[4]||(t[4]=[C("h4",null,"About",-1),C("p",null," The 808Club is an art and culture collective based in Linz. Together with a group of friends, we organize various events and creative projects. ",-1),C("h4",null,"Role",-1),C("p",null," As a board member, I contribute to event organization, create designs, and manage the club’s web presence. ",-1)])),_:1}),he(ht,{title:"Resources"},{default:qe(()=>t[5]||(t[5]=[C("p",null,[C("a",{href:"https://www.instagram.com/808club_linz/",target:"_blank",rel:"noopener noreferrer"},"→ Instagram @808club_linz"),C("br"),C("a",{href:"https://808club.x-net.dev/",target:"_blank",rel:"noopener noreferrer"},"→ Website 808Club")],-1)])),_:1})])]))}},vA=Tt(_A,[["__scopeId","data-v-dbc60bfe"]]),xA={class:"project"},SA={class:"projectOverview"},MA={class:"mainProjectContent"},yA={class:"projectDetails"},EA={__name:"pdf_portfolio",setup(n){return(e,t)=>(Ye(),lt("div",xA,[he(Cn),C("section",SA,[he(Pn,{title:"PDF Portfolio",text:"Find more designs in my PDF Portfolio!"}),C("div",MA,[he(yt,{src:"/project_images/d_portfolio_img1.jpg",alt:"Spotlight"}),t[0]||(t[0]=C("p",{class:"contentNote"},[We(" This portfolio wasn’t meant to be taken too seriously — but have fun flipping through it! "),C("a",{href:"https://drive.google.com/file/d/18GAOEvxXWaD3Pvr4apUIzXjAwTwsZfBV/view?usp=sharing",target:"_blank"},"→ Portfolio (PDF)")],-1))])]),C("section",yA,[he(ht,{title:"Overview"},{default:qe(()=>t[1]||(t[1]=[C("h4",null,"About",-1),C("p",null," I put this PDF portfolio together in my 2D Design class at FH Hagenberg. While it doesn’t include every creative project I’ve ever made, you’ll find a few more of my designs there. ",-1),C("h4",null,"Tech",-1),C("p",null,[We(" - Adobe CC "),C("br"),We(" - Touchdesigner "),C("br"),We(" - Many more... ")],-1)])),_:1}),he(ht,{title:"Resources"},{default:qe(()=>t[2]||(t[2]=[C("p",null,[C("a",{href:"https://drive.google.com/file/d/18GAOEvxXWaD3Pvr4apUIzXjAwTwsZfBV/view?usp=sharing",target:"_blank"},"→ Portfolio (PDF) - Download")],-1)])),_:1})])]))}},AA=Tt(EA,[["__scopeId","data-v-3cd88975"]]),bA={class:"project"},TA={class:"projectOverview"},wA={class:"projectDetails"},RA={__name:"TD_tutorials",setup(n){return $n(()=>{_s(()=>{xc.highlightAll()})}),(e,t)=>(Ye(),lt("div",bA,[he(Cn),C("section",TA,[he(Pn,{title:"TD Tutorials",text:"Various Touchdesigner Tutorials I did on YouTube."}),t[0]||(t[0]=C("div",{class:"mainProjectContent"},[C("iframe",{width:"600",height:"337",src:"https://www.youtube.com/embed/videoseries?si=XO8NCGPKKnPCw6Fk&list=PLFLuAZh6tS3Lu9dsZ10a__zXhkrIHYXhE",title:"YouTube video player",frameborder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",referrerpolicy:"strict-origin-when-cross-origin",allowfullscreen:""}),C("p",{class:"contentNote"},[We(" Tuchdesigner tutorials on "),C("a",{target:"_blank",href:"https://www.youtube.com/@tribeholz23"},"→ YouTube")])],-1))]),C("section",wA,[he(ht,{title:"Overview"},{default:qe(()=>t[1]||(t[1]=[C("h4",null,"About",-1),C("p",null," While I’m not a TouchDesigner pro, they say you learn best when you try to teach — and that’s what these tutorials are all about. I’m also happy if I can help a few people along the way. ",-1),C("h4",null,"Tools",-1),C("p",null,[We(" - Touchdesigner "),C("br"),We(" - Python "),C("br"),We(" - GLSL "),C("br"),We(" - OBS | Recording "),C("br"),We(" - Davinci Resolve | Cutting ")],-1)])),_:1}),he(ht,{title:"Resources"},{default:qe(()=>t[2]||(t[2]=[C("p",null,[C("a",{target:"_blank",href:"https://drive.google.com/drive/folders/1Hxd5kI1gWZXB3dU15D3aQc7badd6mQHl?usp=sharing"},"→ Tutorial Files + Assets")],-1)])),_:1})])]))}},CA=Tt(RA,[["__scopeId","data-v-c9e703a1"]]),PA={class:"project"},LA={class:"projectOverview"},DA={class:"projectDetails"},IA={__name:"coding_techno",setup(n){return(e,t)=>(Ye(),lt("div",PA,[he(Cn),C("section",LA,[he(Pn,{title:"Coding Techno",text:`This was the first series I created on coding with SonicPi. It focused\r
          on experimentation and developing a workflow.`}),t[0]||(t[0]=C("div",{class:"mainProjectContent"},[C("iframe",{width:"600",height:"337",src:"https://www.youtube.com/embed/videoseries?si=cQ-cdKx3yKNn4xmz&list=PLFLuAZh6tS3IfAgWplNl72bJkq3jWkxeA",title:"YouTube video player",frameborder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",referrerpolicy:"strict-origin-when-cross-origin",allowfullscreen:""}),C("p",{class:"contentNote"},"Playlist - Coding Techno with SonicPi")],-1))]),C("section",DA,[he(ht,{title:"Overview"},{default:qe(()=>t[1]||(t[1]=[C("h4",null,"About",-1),C("p",null," I never intended to explore electronic music production, but that changed when I discovered SonicPi. Since then, I've developed a deep passion for creative coding. ",-1),C("h4",null,"Tools",-1),C("p",null,[We(" - SonicPi "),C("br"),We(" - Ruby ")],-1)])),_:1}),he(ht,{title:"Resources"},{default:qe(()=>t[2]||(t[2]=[C("p",null,[C("a",{target:"_blank",href:"https://github.com/sync-tax/TechnoSession-1/blob/main/TechnoSession%231.rb"},"→ Ruby-File | First"),C("br"),C("a",{target:"_blank",href:"https://www.youtube.com/watch?v=s22yDfzhWoU&list=PLFLuAZh6tS3IfAgWplNl72bJkq3jWkxeA"},"→ Playlist | YouTube")],-1)])),_:1})])]))}},UA=Tt(IA,[["__scopeId","data-v-6d84316b"]]),NA={class:"project"},FA={class:"projectOverview"},OA={class:"mainProjectContent"},BA={class:"projectDetails"},kA={__name:"808spotlight",setup(n){return(e,t)=>(Ye(),lt("div",NA,[he(Cn),C("section",FA,[he(Pn,{title:"808Spotlight",text:"A concert we organized at Ars Electronica Deep Space. | Video on YouTube soon →"}),C("div",OA,[he(yt,{src:"/project_images/o_events_img5.jpg",alt:"Spotlight"}),t[0]||(t[0]=C("p",{class:"contentNote"},"Intro Visual | 808",-1)),he(yt,{src:"/project_images/o_events_img1.jpg",alt:"Spotlight"}),t[1]||(t[1]=C("p",{class:"contentNote"},"Visual | Luzius P",-1)),he(yt,{src:"/project_images/o_events_img2.jpg",alt:"Spotlight"}),t[2]||(t[2]=C("p",{class:"contentNote"},"Visual | Blue",-1))])]),C("section",BA,[he(ht,{title:"Overview"},{default:qe(()=>t[3]||(t[3]=[C("h4",null,"About",-1),C("p",null," This project aimed to create an interactive realtime visual experience for the 808Spotlight concert. ",-1),C("h4",null,"Role",-1),C("p",null," I designed and built the visual system and integrated it with a MIDI controller to trigger and manipulate procedural visuals in real-time. I also performed the visualisation during the concert. ",-1),C("h4",null,"Tools",-1),C("p",null,[We(" - Touchdesigner "),C("br"),We(" - Python "),C("br"),We(" - MIDI Controller ")],-1)])),_:1}),he(ht,{title:"Resources"},{default:qe(()=>t[4]||(t[4]=[C("p",null,[C("a",{target:"_blank",href:"https://808club.x-net.dev/808-spotlight/"},"→ Website Entry"),C("br"),C("a",{target:"_blank",href:"https://www.instagram.com/p/DG5g0ggN2Oq/"},"→ Promo Reel")],-1)])),_:1})])]))}},zA=Tt(kA,[["__scopeId","data-v-47bec8bf"]]),HA=[{path:"/",name:"Projects",component:hE},{path:"/About",name:"About",component:AE},{path:"/LinkTree",name:"LinkTree",component:RE},{path:"/arro.at",name:"arro",component:kE},{path:"/MIDI_Boilerplate",name:"SonicPi_Tools",component:jE},{path:"/TD_VJ_Setup",name:"VJ_Setup",component:JE},{path:"/808club.at",name:"eioeiclub",component:rA},{path:"/screenprints",name:"screenprints",component:uA},{path:"/event_posters",name:"event_posters",component:vA},{path:"/pdf_portfolio",name:"pdf_portfolio",component:AA},{path:"/TD_tutorials",name:"TD_tutorials",component:CA},{path:"/coding_techno",name:"coding_techno",component:UA},{path:"/808Spotlight",name:"eioeispotlight",component:zA}],VA=["/AudioProject1","/AudioProject2","/AudioProject3","/VisualProject1","/VisualProject2","/DesignProject1","/DesignProject2","/DesignProject3","/OtherProject1","/OtherProject2","/OtherProject3"],GA=E_({history:Qg(),routes:HA,scrollBehavior(n,e,t){return t||(n.path==="/"&&VA.includes(e.path)?{top:510}:{top:0})}}),WA="/assets/flying_nyan-DxYZehf-.gif",XA="data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='UTF-8'?%3e%3csvg%20id='Layer_1'%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20352.9%20352.9'%3e%3cdefs%3e%3cstyle%3e%20.cls-1%20{%20fill:%20%23fff;%20}%20%3c/style%3e%3c/defs%3e%3cpolygon%20class='cls-1'%20points='258.06%200%20258.06%2094.84%20258.06%20135.24%20258.06%20258.06%2094.84%20258.06%2094.84%2094.84%20226.06%2094.84%20226.06%200%200%200%200%20352.9%20352.9%20352.9%20352.9%200%20258.06%200'/%3e%3c/svg%3e",jA="data:image/png;base64,",Xh="data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='UTF-8'%20standalone='no'?%3e%3c!--%20Created%20with%20Inkscape%20(http://www.inkscape.org/)%20--%3e%3csvg%20width='500'%20height='500'%20viewBox='0%200%20132.29166%20132.29167'%20version='1.1'%20id='svg1'%20xml:space='preserve'%20inkscape:export-filename='darkmode_icon.svg'%20inkscape:export-xdpi='96'%20inkscape:export-ydpi='96'%20xmlns:inkscape='http://www.inkscape.org/namespaces/inkscape'%20xmlns:sodipodi='http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:svg='http://www.w3.org/2000/svg'%3e%3csodipodi:namedview%20id='namedview1'%20pagecolor='%23ffffff'%20bordercolor='%23000000'%20borderopacity='0.25'%20inkscape:showpageshadow='2'%20inkscape:pageopacity='0.0'%20inkscape:pagecheckerboard='0'%20inkscape:deskcolor='%23d1d1d1'%20inkscape:document-units='mm'%20/%3e%3cdefs%20id='defs1'%20/%3e%3cg%20inkscape:label='Ebene%201'%20inkscape:groupmode='layer'%20id='layer1'%3e%3cpath%20style='fill:%23000000;stroke-width:0.911498'%20d='M%2064.339462,123.60805%20C%2055.321313,122.53997%2050.154764,121.07607%2043.080977,117.58463%2037.114626,114.63981%2031.819748,110.82439%2027.107092,106.07407%2017.814718,96.707442%2012.028835,84.655166%2010.252639,70.965453%209.8117294,67.567177%209.8796022,59.590704%2010.379361,56.074553%2012.824034,38.874384%2022.167058,23.882672%2036.475236,14.201391%20c%202.142106,-1.449399%209.832931,-5.3859141%2011.890341,-6.086014%201.799164,-0.6122237%203.206808,-0.5787491%204.149038,0.098665%200.859532,0.6179625%201.736076,2.126591%201.736076,2.987981%200,0.300215%20-0.430133,2.07512%20-0.955848,3.944233%20-1.901518,6.760596%20-2.421504,11.648665%20-1.965895,18.480248%200.325819,4.885474%200.861319,7.925274%202.099072,11.915462%205.603246,18.06338%2019.983309,31.258177%2038.654131,35.468092%203.765151,0.84897%207.955329,1.16868%2012.852609,0.980653%204.80853,-0.184621%207.54509,-0.597755%2011.51474,-1.738364%203.83375,-1.101559%205.84191,-1.275156%206.90823,-0.59719%201.64243,1.04426%202.03089,2.872583%201.16322,5.474808%20-0.72509,2.174566%20-4.13408,8.901329%20-5.82854,11.501102%20-9.24103,14.178333%20-24.245669,23.924933%20-40.643568,26.400923%20-3.106452,0.46906%20-11.59963,0.82593%20-13.70938,0.57606%20z%20m%209.079884,-7.8503%20c%204.27545,-0.29428%207.393923,-0.92113%2011.635609,-2.3389%205.804713,-1.94023%2012.028408,-5.36281%2016.757085,-9.21516%202.35897,-1.92181%206.76235,-6.493403%208.46008,-8.783268%201.39751,-1.884947%203.58155,-5.351006%203.87359,-6.147379%200.18521,-0.505046%200.56277,-0.518878%20-4.04647,0.14824%20-3.12497,0.452294%20-12.241214,0.376339%20-15.493467,-0.129087%20C%2083.916642,87.631022%2073.470433,83.108766%2065.687794,76.773351%2062.656178,74.305481%2057.838943,69.354572%2055.884196,66.697705%2048.435992,56.574191%2044.70711,46.649584%2043.659848,34.161927%20c%20-0.276603,-3.298201%20-0.163391,-8.047593%200.268377,-11.258972%200.125332,-0.932195%200.300779,-2.342125%200.389879,-3.13318%20l%200.16201,-1.43828%20-1.179985,0.689074%20c%20-3.503874,2.046151%20-6.418292,4.308319%20-9.67654,7.510908%20-5.47214,5.378668%20-7.91675,8.7064%20-10.852703,14.773239%20-6.606777,13.652229%20-6.982801,28.882739%20-1.06462,43.121411%202.558984,6.156707%206.209525,11.533398%2011.199593,16.495303%208.244438,8.19791%2017.383961,12.75851%2029.271724,14.60654%203.19713,0.49702%206.406044,0.5626%2011.241763,0.22978%20z'%20id='path1'%20/%3e%3c/g%3e%3c/svg%3e",jh="/assets/lightmode_icon-DKA_9KZd.svg",$A={class:"mainNavigation"},qA={__name:"Navbar",setup(n){const e=Ar(null),t=document.documentElement,i=()=>{t.classList.add("lightmode"),t.classList.remove("darkmode"),localStorage.setItem("theme","light")},r=()=>{t.classList.add("darkmode"),t.classList.remove("lightmode"),localStorage.setItem("theme","dark")};return $n(()=>{const s=document.getElementById("nyan");s&&s.addEventListener("click",()=>{e.value&&(e.value.classList.add("flyAnim"),e.value.addEventListener("animationend",()=>{e.value.classList.remove("flyAnim")},{once:!0}))})}),$n(()=>{localStorage.getItem("theme")==="light"?document.documentElement.classList.add("lightmode"):document.documentElement.classList.add("darkmode")}),(s,o)=>{const a=Io("RouterLink");return Ye(),lt("nav",$A,[C("div",{class:"flyingCat",style:{"z-index":"5000"},ref_key:"nyanCat",ref:e},o[0]||(o[0]=[C("img",{src:WA,alt:"Nyan Cat flying over screen",width:"270px"},null,-1)]),512),he(a,{to:"/",class:"navLink"},{default:qe(()=>o[1]||(o[1]=[C("img",{src:XA,alt:"A monochrome logo resembling the initials AR.",id:"logoImage"},null,-1)])),_:1}),C("ul",null,[o[5]||(o[5]=C("img",{src:jA,alt:"A moon icon - used to switch to darkmode.",id:"nyan"},null,-1)),he(a,{to:"/",class:"navLink"},{default:qe(()=>o[2]||(o[2]=[C("li",null,"PROJΞCTS",-1)])),_:1}),he(a,{to:"/About",class:"navLink"},{default:qe(()=>o[3]||(o[3]=[C("li",null,"ΛBOUT",-1)])),_:1}),he(a,{to:"/LinkTree",class:"navLink"},{default:qe(()=>o[4]||(o[4]=[C("li",{id:"lastNavLink"},"LIΠKS",-1)])),_:1}),C("img",{src:Xh,alt:"A moon icon - used to switch to darkmode.",style:{fill:"white"},class:"modeSwitch dark",onClick:r}),C("img",{title:"Wait. This is illegal.",src:jh,alt:"A sun icon - used to switch to lightmode.",class:"modeSwitch light",onClick:i})])])}}},YA=Tt(qA,[["__scopeId","data-v-8a23cba4"]]),KA={class:"footer"},ZA={__name:"Footer",setup(n){const e=()=>{const s=document.getElementById("nyan");s.style.opacity="60%",s.style.width="35px",s.style.height="35px",s.style.pointerEvents="all"},t=document.documentElement,i=()=>{t.classList.add("lightmode"),t.classList.remove("darkmode"),localStorage.setItem("theme","light")},r=()=>{t.classList.add("darkmode"),t.classList.remove("lightmode"),localStorage.setItem("theme","dark")};return $n(()=>{localStorage.getItem("theme")==="light"?document.documentElement.classList.add("lightmode"):document.documentElement.classList.add("darkmode")}),(s,o)=>(Ye(),lt("div",KA,[C("div",{class:"footerWrapper"},[o[1]||(o[1]=Bd('<div class="footerSocials"><h4>Socials</h4><a href="https://www.youtube.com/@tribeholz23" target="_blank">YouTube</a><a href="https://www.instagram.com/_tribeholz/" target="_blank">Instagram</a><a href="https://github.com/sync-tax" target="_blank">GitHub</a></div><div class="footerContact"><h4>Contact</h4><a href="mailto:robert.ardeleanu.0607@gmail.com" target="_blank">E-Mail</a></div>',2)),C("div",{class:"footerExtra"},[C("div",{class:"modeSwitchContainer"},[C("img",{src:Xh,alt:"A moon icon - used to switch to darkmode.",style:{fill:"white"},class:"modeSwitch dark",onClick:r}),C("img",{title:"Wait. This is illegal.",src:jh,alt:"A sun icon - used to switch to lightmode.",class:"modeSwitch light",onClick:i})]),o[0]||(o[0]=C("p",null,"made with ♡ and a whole lot of coffee^^",-1)),C("p",{class:"nyanUnlock",onClick:e},"UNLOCK NYAN!")])]),o[2]||(o[2]=C("div",{id:"copyrightWrapper"},[C("p",null,"© 2025 Ardeleanu Robert - All Rights Reserved")],-1))]))}},JA={__name:"App",setup(n){return(e,t)=>{const i=Io("router-view");return Ye(),lt("body",null,[he(YA),C("main",null,[he(Xd,{name:"route"},{default:qe(()=>[he(i,null,{default:qe(({Component:r})=>[(Ye(),br(Qp(r)))]),_:1})]),_:1})]),he(ZA)])}}},QA=Tt(JA,[["__scopeId","data-v-5e59c223"]]);(function(n){n.languages.ruby=n.languages.extend("clike",{comment:{pattern:/#.*|^=begin\s[\s\S]*?^=end/m,greedy:!0},"class-name":{pattern:/(\b(?:class|module)\s+|\bcatch\s+\()[\w.\\]+|\b[A-Z_]\w*(?=\s*\.\s*new\b)/,lookbehind:!0,inside:{punctuation:/[.\\]/}},keyword:/\b(?:BEGIN|END|alias|and|begin|break|case|class|def|define_method|defined|do|each|else|elsif|end|ensure|extend|for|if|in|include|module|new|next|nil|not|or|prepend|private|protected|public|raise|redo|require|rescue|retry|return|self|super|then|throw|undef|unless|until|when|while|yield)\b/,operator:/\.{2,3}|&\.|===|<?=>|[!=]?~|(?:&&|\|\||<<|>>|\*\*|[+\-*/%<>!^&|=])=?|[?:]/,punctuation:/[(){}[\].,;]/}),n.languages.insertBefore("ruby","operator",{"double-colon":{pattern:/::/,alias:"punctuation"}});var e={pattern:/((?:^|[^\\])(?:\\{2})*)#\{(?:[^{}]|\{[^{}]*\})*\}/,lookbehind:!0,inside:{content:{pattern:/^(#\{)[\s\S]+(?=\}$)/,lookbehind:!0,inside:n.languages.ruby},delimiter:{pattern:/^#\{|\}$/,alias:"punctuation"}}};delete n.languages.ruby.function;var t="(?:"+["([^a-zA-Z0-9\\s{(\\[<=])(?:(?!\\1)[^\\\\]|\\\\[^])*\\1","\\((?:[^()\\\\]|\\\\[^]|\\((?:[^()\\\\]|\\\\[^])*\\))*\\)","\\{(?:[^{}\\\\]|\\\\[^]|\\{(?:[^{}\\\\]|\\\\[^])*\\})*\\}","\\[(?:[^\\[\\]\\\\]|\\\\[^]|\\[(?:[^\\[\\]\\\\]|\\\\[^])*\\])*\\]","<(?:[^<>\\\\]|\\\\[^]|<(?:[^<>\\\\]|\\\\[^])*>)*>"].join("|")+")",i=`(?:"(?:\\\\.|[^"\\\\\r
