...
`)+`
`+p);const _=M+m+o,y=M+p+a,P=df(r,r.VERTEX_SHADER,_),C=df(r,r.FRAGMENT_SHADER,y);r.attachShader(E,P),r.attachShader(E,C),t.index0AttributeName!==void 0?r.bindAttribLocation(E,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(E,0,"position"),r.linkProgram(E);function R(A){if(n.debug.checkShaderErrors){const U=r.getProgramInfoLog(E).trim(),X=r.getShaderInfoLog(P).trim(),Q=r.getShaderInfoLog(C).trim();let ae=!0,q=!0;if(r.getProgramParameter(E,r.LINK_STATUS)===!1)if(ae=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,E,P,C);else{const J=hf(r,P,"vertex"),H=hf(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(E,r.VALIDATE_STATUS)+`
...
}`;function Cy(n,e,t){let i=new gc;const r=new Je,s=new Je,o=new ct,a=new Ay({depthPacking:i0}),l=new Ty,c={},u=t.maxTextureSize,f={[_i]:Xt,[Xt]:_i,[Gn]:Gn},d=new vi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Je},radius:{value:4}},vertexShader:wy,fragmentShader:Ry}),h=d.clone();h.defines.HORIZONTAL_PASS=1;const S=new yi;S.setAttribute("position",new Rn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const E=new Tn(S,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=fh;let p=this.type;this.render=function(C,R,D){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||C.length===0)return;const k=n.getRenderTarget(),x=n.getActiveCubeFace(),A=n.getActiveMipmapLevel(),U=n.state;U.setBlending(pi),U.buffers.color.setClear(1,1,1,1),U.buffers.depth.setTest(!0),U.setScissorTest(!1);const X=p!==zn&&this.type===zn,Q=p===zn&&this.type!==zn;for(let ae=0,q=C.length;ae<q;ae++){const J=C[ae],H=J.shadow;if(H===void 0){console.warn("THREE.WebGLShadowMap:",J,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;r.copy(H.mapSize);const me=H.getFrameExtents();if(r.multiply(me),s.copy(H.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/me.x),r.x=s.x*me.x,H.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/me.y),r.y=s.y*me.y,H.mapSize.y=s.y)),H.map===null||X===!0||Q===!0){const Me=this.type!==zn?{minFilter:an,magFilter:an}:{};H.map!==null&&H.map.dispose(),H.map=new ji(r.x,r.y,Me),H.map.texture.name=J.name+".shadowMap",H.camera.updateProjectionMatrix()}n.setRenderTarget(H.map),n.clear();const _e=H.getViewportCount();for(let Me=0;Me<_e;Me++){const De=H.getViewport(Me);o.set(s.x*De.x,s.y*De.y,s.x*De.z,s.y*De.w),U.viewport(o),H.updateMatrices(J,Me),i=H.getFrustum(),y(R,D,H.camera,J,this.type)}H.isPointLightShadow!==!0&&this.type===zn&&M(H,D),H.needsUpdate=!1}p=this.type,m.needsUpdate=!1,n.setRenderTarget(k,x,A)};function M(C,R){const D=e.update(E);d.defines.VSM_SAMPLES!==C.blurSamples&&(d.defines.VSM_SAMPLES=C.blurSamples,h.defines.VSM_SAMPLES=C.blurSamples,d.needsUpdate=!0,h.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new ji(r.x,r.y)),d.uniforms.shadow_pass.value=C.map.texture,d.uniforms.resolution.value=C.mapSize,d.uniforms.radius.value=C.radius,n.setRenderTarget(C.mapPass),n.clear(),n.renderBufferDirect(R,null,D,d,E,null),h.uniforms.shadow_pass.value=C.mapPass.texture,h.uniforms.resolution.value=C.mapSize,h.uniforms.radius.value=C.radius,n.setRenderTarget(C.map),n.clear(),n.renderBufferDirect(R,null,D,h,E,null)}function _(C,R,D,k){let x=null;const A=D.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(A!==void 0)x=A;else if(x=D.isPointLight===!0?l:a,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const U=x.uuid,X=R.uuid;let Q=c[U];Q===void 0&&(Q={},c[U]=Q);let ae=Q[X];ae===void 0&&(ae=x.clone(),Q[X]=ae,R.addEventListener("dispose",P)),x=ae}if(x.visible=R.visible,x.wireframe=R.wireframe,k===zn?x.side=R.shadowSide!==null?R.shadowSide:R.side:x.side=R.shadowSide!==null?R.shadowSide:f[R.side],x.alphaMap=R.alphaMap,x.alphaTest=R.alphaTest,x.map=R.map,x.clipShadows=R.clipShadows,x.clippingPlanes=R.clippingPlanes,x.clipIntersection=R.clipIntersection,x.displacementMap=R.displacementMap,x.displacementScale=R.displacementScale,x.displacementBias=R.displacementBias,x.wireframeLinewidth=R.wireframeLinewidth,x.linewidth=R.linewidth,D.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const U=n.properties.get(x);U.light=D}return x}function y(C,R,D,k,x){if(C.visible===!1)return;if(C.layers.test(R.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&x===zn)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(D.matrixWorldInverse,C.matrixWorld);const X=e.update(C),Q=C.material;if(Array.isArray(Q)){const ae=X.groups;for(let q=0,J=ae.length;q<J;q++){const H=ae[q],me=Q[H.materialIndex];if(me&&me.visible){const _e=_(C,me,k,x);C.onBeforeShadow(n,C,R,D,X,_e,H),n.renderBufferDirect(D,null,X,_e,C,H),C.onAfterShadow(n,C,R,D,X,_e,H)}}}else if(Q.visible){const ae=_(C,Q,k,x);C.onBeforeShadow(n,C,R,D,X,ae,null),n.renderBufferDirect(D,null,X,ae,C,null),C.onAfterShadow(n,C,R,D,X,ae,null)}}const U=C.children;for(let X=0,Q=U.length;X<Q;X++)y(U[X],R,D,k,x)}function P(C){C.target.removeEventListener("dispose",P);for(const D in c){const k=c[D],x=C.target.uuid;x in k&&(k[x].dispose(),delete k[x])}}}const Py={[nl]:il,[rl]:al,[sl]:ll,[Cr]:ol,[il]:nl,[al]:rl,[ll]:sl,[ol]:Cr};function Ly(n){function e(){let N=!1;const Ae=new ct;let te=null;const ce=new ct(0,0,0,0);return{setMask:function(Ee){te!==Ee&&!N&&(n.colorMask(Ee,Ee,Ee,Ee),te=Ee)},setLocked:function(Ee){N=Ee},setClear:function(Ee,Te,Ke,Mt,Gt){Gt===!0&&(Ee*=Mt,Te*=Mt,Ke*=Mt),Ae.set(Ee,Te,Ke,Mt),ce.equals(Ae)===!1&&(n.clearColor(Ee,Te,Ke,Mt),ce.copy(Ae))},reset:function(){N=!1,te=null,ce.set(-1,0,0,0)}}}function t(){let N=!1,Ae=!1,te=null,ce=null,Ee=null;return{setReversed:function(Te){Ae=Te},setTest:function(Te){Te?xe(n.DEPTH_TEST):F(n.DEPTH_TEST)},setMask:function(Te){te!==Te&&!N&&(n.depthMask(Te),te=Te)},setFunc:function(Te){if(Ae&&(Te=Py[Te]),ce!==Te){switch(Te){case nl:n.depthFunc(n.NEVER);break;case il:n.depthFunc(n.ALWAYS);break;case rl:n.depthFunc(n.LESS);break;case Cr:n.depthFunc(n.LEQUAL);break;case sl:n.depthFunc(n.EQUAL);break;case ol:n.depthFunc(n.GEQUAL);break;case al:n.depthFunc(n.GREATER);break;case ll:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}ce=Te}},setLocked:function(Te){N=Te},setClear:function(Te){Ee!==Te&&(n.clearDepth(Te),Ee=Te)},reset:function(){N=!1,te=null,ce=null,Ee=null}}}function i(){let N=!1,Ae=null,te=null,ce=null,Ee=null,Te=null,Ke=null,Mt=null,Gt=null;return{setTest:function(Qe){N||(Qe?xe(n.STENCIL_TEST):F(n.STENCIL_TEST))},setMask:function(Qe){Ae!==Qe&&!N&&(n.stencilMask(Qe),Ae=Qe)},setFunc:function(Qe,Wt,Ln){(te!==Qe||ce!==Wt||Ee!==Ln)&&(n.stencilFunc(Qe,Wt,Ln),te=Qe,ce=Wt,Ee=Ln)},setOp:function(Qe,Wt,Ln){(Te!==Qe||Ke!==Wt||Mt!==Ln)&&(n.stencilOp(Qe,Wt,Ln),Te=Qe,Ke=Wt,Mt=Ln)},setLocked:function(Qe){N=Qe},setClear:function(Qe){Gt!==Qe&&(n.clearStencil(Qe),Gt=Qe)},reset:function(){N=!1,Ae=null,te=null,ce=null,Ee=null,Te=null,Ke=null,Mt=null,Gt=null}}}const r=new e,s=new t,o=new i,a=new WeakMap,l=new WeakMap;let c={},u={},f=new WeakMap,d=[],h=null,S=!1,E=null,m=null,p=null,M=null,_=null,y=null,P=null,C=new et(0,0,0),R=0,D=!1,k=null,x=null,A=null,U=null,X=null;const Q=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let ae=!1,q=0;const J=n.getParameter(n.VERSION);J.indexOf("WebGL")!==-1?(q=parseFloat(/^WebGL (\d)/.exec(J)[1]),ae=q>=1):J.indexOf("OpenGL ES")!==-1&&(q=parseFloat(/^OpenGL ES (\d)/.exec(J)[1]),ae=q>=2);let H=null,me={};const _e=n.getParameter(n.SCISSOR_BOX),Me=n.getParameter(n.VIEWPORT),De=new ct().fromArray(_e),je=new ct().fromArray(Me);function ee(N,Ae,te,ce){const Ee=new Uint8Array(4),Te=n.createTexture();n.bindTexture(N,Te),n.texParameteri(N,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(N,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ke=0;Ke<te;Ke++)N===n.TEXTURE_3D||N===n.TEXTURE_2D_ARRAY?n.texImage3D(Ae,0,n.RGBA,1,1,ce,0,n.RGBA,n.UNSIGNED_BYTE,Ee):n.texImage2D(Ae+Ke,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,Ee);return Te}const de={};de[n.TEXTURE_2D]=ee(n.TEXTURE_2D,n.TEXTURE_2D,1),de[n.TEXTURE_CUBE_MAP]=ee(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),de[n.TEXTURE_2D_ARRAY]=ee(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),de[n.TEXTURE_3D]=ee(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),o.setClear(0),xe(n.DEPTH_TEST),s.setFunc(Cr),O(!1),Z(Tu),xe(n.CULL_FACE),g(pi);function xe(N){c[N]!==!0&&(n.enable(N),c[N]=!0)}function F(N){c[N]!==!1&&(n.disable(N),c[N]=!1)}function oe(N,Ae){return u[N]!==Ae?(n.bindFramebuffer(N,Ae),u[N]=Ae,N===n.DRAW_FRAMEBUFFER&&(u[n.FRAMEBUFFER]=Ae),N===n.FRAMEBUFFER&&(u[n.DRAW_FRAMEBUFFER]=Ae),!0):!1}function ne(N,Ae){let te=d,ce=!1;if(N){te=f.get(Ae),te===void 0&&(te=[],f.set(Ae,te));const Ee=N.textures;if(te.length!==Ee.length||te[0]!==n.COLOR_ATTACHMENT0){for(let Te=0,Ke=Ee.length;Te<Ke;Te++)te[Te]=n.COLOR_ATTACHMENT0+Te;te.length=Ee.length,ce=!0}}else te[0]!==n.BACK&&(te[0]=n.BACK,ce=!0);ce&&n.drawBuffers(te)}function he(N){return h!==N?(n.useProgram(N),h=N,!0):!1}const we={[Oi]:n.FUNC_ADD,[C_]:n.FUNC_SUBTRACT,[P_]:n.FUNC_REVERSE_SUBTRACT};we[L_]=n.MIN,we[I_]=n.MAX;const Pe={[D_]:n.ZERO,[U_]:n.ONE,[N_]:n.SRC_COLOR,[el]:n.SRC_ALPHA,[H_]:n.SRC_ALPHA_SATURATE,[k_]:n.DST_COLOR,[O_]:n.DST_ALPHA,[F_]:n.ONE_MINUS_SRC_COLOR,[tl]:n.ONE_MINUS_SRC_ALPHA,[z_]:n.ONE_MINUS_DST_COLOR,[B_]:n.ONE_MINUS_DST_ALPHA,[V_]:n.CONSTANT_COLOR,[G_]:n.ONE_MINUS_CONSTANT_COLOR,[W_]:n.CONSTANT_ALPHA,[X_]:n.ONE_MINUS_CONSTANT_ALPHA};function g(N,Ae,te,ce,Ee,Te,Ke,Mt,Gt,Qe){if(N===pi){S===!0&&(F(n.BLEND),S=!1);return}if(S===!1&&(xe(n.BLEND),S=!0),N!==R_){if(N!==E||Qe!==D){if((m!==Oi||_!==Oi)&&(n.blendEquation(n.FUNC_ADD),m=Oi,_=Oi),Qe)switch(N){case Mr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case wu:n.blendFunc(n.ONE,n.ONE);break;case Ru:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Cu:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}else switch(N){case Mr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case wu:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Ru:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Cu:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",N);break}p=null,M=null,y=null,P=null,C.set(0,0,0),R=0,E=N,D=Qe}return}Ee=Ee||Ae,Te=Te||te,Ke=Ke||ce,(Ae!==m||Ee!==_)&&(n.blendEquationSeparate(we[Ae],we[Ee]),m=Ae,_=Ee),(te!==p||ce!==M||Te!==y||Ke!==P)&&(n.blendFuncSeparate(Pe[te],Pe[ce],Pe[Te],Pe[Ke]),p=te,M=ce,y=Te,P=Ke),(Mt.equals(C)===!1||Gt!==R)&&(n.blendColor(Mt.r,Mt.g,Mt.b,Gt),C.copy(Mt),R=Gt),E=N,D=!1}function L(N,Ae){N.side===Gn?F(n.CULL_FACE):xe(n.CULL_FACE);let te=N.side===Xt;Ae&&(te=!te),O(te),N.blending===Mr&&N.transparent===!1?g(pi):g(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),s.setFunc(N.depthFunc),s.setTest(N.depthTest),s.setMask(N.depthWrite),r.setMask(N.colorWrite);const ce=N.stencilWrite;o.setTest(ce),ce&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),ie(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?xe(n.SAMPLE_ALPHA_TO_COVERAGE):F(n.SAMPLE_ALPHA_TO_COVERAGE)}function O(N){k!==N&&(N?n.frontFace(n.CW):n.frontFace(n.CCW),k=N)}function Z(N){N!==A_?(xe(n.CULL_FACE),N!==x&&(N===Tu?n.cullFace(n.BACK):N===T_?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):F(n.CULL_FACE),x=N}function W(N){N!==A&&(ae&&n.lineWidth(N),A=N)}function ie(N,Ae,te){N?(xe(n.POLYGON_OFFSET_FILL),(U!==Ae||X!==te)&&(n.polygonOffset(Ae,te),U=Ae,X=te)):F(n.POLYGON_OFFSET_FILL)}function re(N){N?xe(n.SCISSOR_TEST):F(n.SCISSOR_TEST)}function b(N){N===void 0&&(N=n.TEXTURE0+Q-1),H!==N&&(n.activeTexture(N),H=N)}function v(N,Ae,te){te===void 0&&(H===null?te=n.TEXTURE0+Q-1:te=H);let ce=me[te];ce===void 0&&(ce={type:void 0,texture:void 0},me[te]=ce),(ce.type!==N||ce.texture!==Ae)&&(H!==te&&(n.activeTexture(te),H=te),n.bindTexture(N,Ae||de[N]),ce.type=N,ce.texture=Ae)}function I(){const N=me[H];N!==void 0&&N.type!==void 0&&(n.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function j(){try{n.compressedTexImage2D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function G(){try{n.compressedTexImage3D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function V(){try{n.texSubImage2D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ue(){try{n.texSubImage3D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function le(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function pe(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Re(){try{n.texStorage2D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function fe(){try{n.texStorage3D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function ve(){try{n.texImage2D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Ue(){try{n.texImage3D.apply(n,arguments)}catch(N){console.error("THREE.WebGLState:",N)}}function Le(N){De.equals(N)===!1&&(n.scissor(N.x,N.y,N.z,N.w),De.copy(N))}function ye(N){je.equals(N)===!1&&(n.viewport(N.x,N.y,N.z,N.w),je.copy(N))}function $e(N,Ae){let te=l.get(Ae);te===void 0&&(te=new WeakMap,l.set(Ae,te));let ce=te.get(N);ce===void 0&&(ce=n.getUniformBlockIndex(Ae,N.name),te.set(N,ce))}function Ne(N,Ae){const ce=l.get(Ae).get(N);a.get(Ae)!==ce&&(n.uniformBlockBinding(Ae,ce,N.__bindingPointIndex),a.set(Ae,ce))}function qe(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),c={},H=null,me={},u={},f=new WeakMap,d=[],h=null,S=!1,E=null,m=null,p=null,M=null,_=null,y=null,P=null,C=new et(0,0,0),R=0,D=!1,k=null,x=null,A=null,U=null,X=null,De.set(0,0,n.canvas.width,n.canvas.height),je.set(0,0,n.canvas.width,n.canvas.height),r.reset(),s.reset(),o.reset()}return{buffers:{color:r,depth:s,stencil:o},enable:xe,disable:F,bindFramebuffer:oe,drawBuffers:ne,useProgram:he,setBlending:g,setMaterial:L,setFlipSided:O,setCullFace:Z,setLineWidth:W,setPolygonOffset:ie,setScissorTest:re,activeTexture:b,bindTexture:v,unbindTexture:I,compressedTexImage2D:j,compressedTexImage3D:G,texImage2D:ve,texImage3D:Ue,updateUBOMapping:$e,uniformBlockBinding:Ne,texStorage2D:Re,texStorage3D:fe,texSubImage2D:V,texSubImage3D:ue,compressedTexSubImage2D:le,compressedTexSubImage3D:pe,scissor:Le,viewport:ye,reset:qe}}function Mf(n,e,t,i){const r=Iy(i);switch(t){case _h:return n*e;case xh:return n*e;case Sh:return n*e*2;case Mh:return n*e/r.components*r.byteLength;case uc:return n*e/r.components*r.byteLength;case yh:return n*e*2/r.components*r.byteLength;case fc:return n*e*2/r.components*r.byteLength;case vh:return n*e*3/r.components*r.byteLength;case _n:return n*e*4/r.components*r.byteLength;case dc:return n*e*4/r.components*r.byteLength;case io:case ro:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*8;case so:case oo:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case pl:case gl:return Math.max(n,16)*Math.max(e,8)/4;case hl:case ml:return Math.max(n,8)*Math.max(e,8)/2;case _l:case vl:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*8;case xl:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case Sl:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case Ml:return Math.floor((n+4)/5)*Math.floor((e+3)/4)*16;case yl:return Math.floor((n+4)/5)*Math.floor((e+4)/5)*16;case El:return Math.floor((n+5)/6)*Math.floor((e+4)/5)*16;case bl:return Math.floor((n+5)/6)*Math.floor((e+5)/6)*16;case Al:return Math.floor((n+7)/8)*Math.floor((e+4)/5)*16;case Tl:return Math.floor((n+7)/8)*Math.floor((e+5)/6)*16;case wl:return Math.floor((n+7)/8)*Math.floor((e+7)/8)*16;case Rl:return Math.floor((n+9)/10)*Math.floor((e+4)/5)*16;case Cl:return Math.floor((n+9)/10)*Math.floor((e+5)/6)*16;case Pl:return Math.floor((n+9)/10)*Math.floor((e+7)/8)*16;case Ll:return Math.floor((n+9)/10)*Math.floor((e+9)/10)*16;case Il:return Math.floor((n+11)/12)*Math.floor((e+9)/10)*16;case Dl:return Math.floor((n+11)/12)*Math.floor((e+11)/12)*16;case ao:case Ul:case Nl:return Math.ceil(n/4)*Math.ceil(e/4)*16;case Eh:case Fl:return Math.ceil(n/4)*Math.ceil(e/4)*8;case Ol:case Bl:return Math.ceil(n/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function Iy(n){switch(n){case qn:case ph:return{byteLength:1,components:1};case hs:case mh:case xs:return{byteLength:2,components:1};case lc:case cc:return{byteLength:2,components:4};case Xi:case ac:case Wn:return{byteLength:4,components:1};case gh:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${n}.`)}function Dy(n,e,t,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Je,u=new WeakMap;let f;const d=new WeakMap;let h=!1;try{h=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(b,v){return h?new OffscreenCanvas(b,v):Mo("canvas")}function E(b,v,I){let j=1;const G=re(b);if((G.width>I||G.height>I)&&(j=I/Math.max(G.width,G.height)),j<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const V=Math.floor(j*G.width),ue=Math.floor(j*G.height);f===void 0&&(f=S(V,ue));const le=v?S(V,ue):f;return le.width=V,le.height=ue,le.getContext("2d").drawImage(b,0,0,V,ue),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+G.width+"x"+G.height+") to ("+V+"x"+ue+")."),le}else return"data"in b&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+G.width+"x"+G.height+")."),b;return b}function m(b){return b.generateMipmaps&&b.minFilter!==an&&b.minFilter!==mn}function p(b){n.generateMipmap(b)}function M(b,v,I,j,G=!1){if(b!==null){if(n[b]!==void 0)return n[b];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let V=v;if(v===n.RED&&(I===n.FLOAT&&(V=n.R32F),I===n.HALF_FLOAT&&(V=n.R16F),I===n.UNSIGNED_BYTE&&(V=n.R8)),v===n.RED_INTEGER&&(I===n.UNSIGNED_BYTE&&(V=n.R8UI),I===n.UNSIGNED_SHORT&&(V=n.R16UI),I===n.UNSIGNED_INT&&(V=n.R32UI),I===n.BYTE&&(V=n.R8I),I===n.SHORT&&(V=n.R16I),I===n.INT&&(V=n.R32I)),v===n.RG&&(I===n.FLOAT&&(V=n.RG32F),I===n.HALF_FLOAT&&(V=n.RG16F),I===n.UNSIGNED_BYTE&&(V=n.RG8)),v===n.RG_INTEGER&&(I===n.UNSIGNED_BYTE&&(V=n.RG8UI),I===n.UNSIGNED_SHORT&&(V=n.RG16UI),I===n.UNSIGNED_INT&&(V=n.RG32UI),I===n.BYTE&&(V=n.RG8I),I===n.SHORT&&(V=n.RG16I),I===n.INT&&(V=n.RG32I)),v===n.RGB_INTEGER&&(I===n.UNSIGNED_BYTE&&(V=n.RGB8UI),I===n.UNSIGNED_SHORT&&(V=n.RGB16UI),I===n.UNSIGNED_INT&&(V=n.RGB32UI),I===n.BYTE&&(V=n.RGB8I),I===n.SHORT&&(V=n.RGB16I),I===n.INT&&(V=n.RGB32I)),v===n.RGBA_INTEGER&&(I===n.UNSIGNED_BYTE&&(V=n.RGBA8UI),I===n.UNSIGNED_SHORT&&(V=n.RGBA16UI),I===n.UNSIGNED_INT&&(V=n.RGBA32UI),I===n.BYTE&&(V=n.RGBA8I),I===n.SHORT&&(V=n.RGBA16I),I===n.INT&&(V=n.RGBA32I)),v===n.RGB&&I===n.UNSIGNED_INT_5_9_9_9_REV&&(V=n.RGB9_E5),v===n.RGBA){const ue=G?_o:st.getTransfer(j);I===n.FLOAT&&(V=n.RGBA32F),I===n.HALF_FLOAT&&(V=n.RGBA16F),I===n.UNSIGNED_BYTE&&(V=ue===pt?n.SRGB8_ALPHA8:n.RGBA8),I===n.UNSIGNED_SHORT_4_4_4_4&&(V=n.RGBA4),I===n.UNSIGNED_SHORT_5_5_5_1&&(V=n.RGB5_A1)}return(V===n.R16F||V===n.R32F||V===n.RG16F||V===n.RG32F||V===n.RGBA16F||V===n.RGBA32F)&&e.get("EXT_color_buffer_float"),V}function _(b,v){let I;return b?v===null||v===Xi||v===Ir?I=n.DEPTH24_STENCIL8:v===Wn?I=n.DEPTH32F_STENCIL8:v===hs&&(I=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Xi||v===Ir?I=n.DEPTH_COMPONENT24:v===Wn?I=n.DEPTH_COMPONENT32F:v===hs&&(I=n.DEPTH_COMPONENT16),I}function y(b,v){return m(b)===!0||b.isFramebufferTexture&&b.minFilter!==an&&b.minFilter!==mn?Math.log2(Math.max(v.width,v.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?v.mipmaps.length:1}function P(b){const v=b.target;v.removeEventListener("dispose",P),R(v),v.isVideoTexture&&u.delete(v)}function C(b){const v=b.target;v.removeEventListener("dispose",C),k(v)}function R(b){const v=i.get(b);if(v.__webglInit===void 0)return;const I=b.source,j=d.get(I);if(j){const G=j[v.__cacheKey];G.usedTimes--,G.usedTimes===0&&D(b),Object.keys(j).length===0&&d.delete(I)}i.remove(b)}function D(b){const v=i.get(b);n.deleteTexture(v.__webglTexture);const I=b.source,j=d.get(I);delete j[v.__cacheKey],o.memory.textures--}function k(b){const v=i.get(b);if(b.depthTexture&&b.depthTexture.dispose(),b.isWebGLCubeRenderTarget)for(let j=0;j<6;j++){if(Array.isArray(v.__webglFramebuffer[j]))for(let G=0;G<v.__webglFramebuffer[j].length;G++)n.deleteFramebuffer(v.__webglFramebuffer[j][G]);else n.deleteFramebuffer(v.__webglFramebuffer[j]);v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer[j])}else{if(Array.isArray(v.__webglFramebuffer))for(let j=0;j<v.__webglFramebuffer.length;j++)n.deleteFramebuffer(v.__webglFramebuffer[j]);else n.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&n.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let j=0;j<v.__webglColorRenderbuffer.length;j++)v.__webglColorRenderbuffer[j]&&n.deleteRenderbuffer(v.__webglColorRenderbuffer[j]);v.__webglDepthRenderbuffer&&n.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const I=b.textures;for(let j=0,G=I.length;j<G;j++){const V=i.get(I[j]);V.__webglTexture&&(n.deleteTexture(V.__webglTexture),o.memory.textures--),i.remove(I[j])}i.remove(b)}let x=0;function A(){x=0}function U(){const b=x;return b>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+r.maxTextures),x+=1,b}function X(b){const v=[];return v.push(b.wrapS),v.push(b.wrapT),v.push(b.wrapR||0),v.push(b.magFilter),v.push(b.minFilter),v.push(b.anisotropy),v.push(b.internalFormat),v.push(b.format),v.push(b.type),v.push(b.generateMipmaps),v.push(b.premultiplyAlpha),v.push(b.flipY),v.push(b.unpackAlignment),v.push(b.colorSpace),v.join()}function Q(b,v){const I=i.get(b);if(b.isVideoTexture&&W(b),b.isRenderTargetTexture===!1&&b.version>0&&I.__version!==b.version){const j=b.image;if(j===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(j.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{je(I,b,v);return}}t.bindTexture(n.TEXTURE_2D,I.__webglTexture,n.TEXTURE0+v)}function ae(b,v){const I=i.get(b);if(b.version>0&&I.__version!==b.version){je(I,b,v);return}t.bindTexture(n.TEXTURE_2D_ARRAY,I.__webglTexture,n.TEXTURE0+v)}function q(b,v){const I=i.get(b);if(b.version>0&&I.__version!==b.version){je(I,b,v);return}t.bindTexture(n.TEXTURE_3D,I.__webglTexture,n.TEXTURE0+v)}function J(b,v){const I=i.get(b);if(b.version>0&&I.__version!==b.version){ee(I,b,v);return}t.bindTexture(n.TEXTURE_CUBE_MAP,I.__webglTexture,n.TEXTURE0+v)}const H={[fl]:n.REPEAT,[ki]:n.CLAMP_TO_EDGE,[dl]:n.MIRRORED_REPEAT},me={[an]:n.NEAREST,[t0]:n.NEAREST_MIPMAP_NEAREST,[Ps]:n.NEAREST_MIPMAP_LINEAR,[mn]:n.LINEAR,[aa]:n.LINEAR_MIPMAP_NEAREST,[zi]:n.LINEAR_MIPMAP_LINEAR},_e={[s0]:n.NEVER,[f0]:n.ALWAYS,[o0]:n.LESS,[Ah]:n.LEQUAL,[a0]:n.EQUAL,[u0]:n.GEQUAL,[l0]:n.GREATER,[c0]:n.NOTEQUAL};function Me(b,v){if(v.type===Wn&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===mn||v.magFilter===aa||v.magFilter===Ps||v.magFilter===zi||v.minFilter===mn||v.minFilter===aa||v.minFilter===Ps||v.minFilter===zi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(b,n.TEXTURE_WRAP_S,H[v.wrapS]),n.texParameteri(b,n.TEXTURE_WRAP_T,H[v.wrapT]),(b===n.TEXTURE_3D||b===n.TEXTURE_2D_ARRAY)&&n.texParameteri(b,n.TEXTURE_WRAP_R,H[v.wrapR]),n.texParameteri(b,n.TEXTURE_MAG_FILTER,me[v.magFilter]),n.texParameteri(b,n.TEXTURE_MIN_FILTER,me[v.minFilter]),v.compareFunction&&(n.texParameteri(b,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(b,n.TEXTURE_COMPARE_FUNC,_e[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===an||v.minFilter!==Ps&&v.minFilter!==zi||v.type===Wn&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||i.get(v).__currentAnisotropy){const I=e.get("EXT_texture_filter_anisotropic");n.texParameterf(b,I.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),i.get(v).__currentAnisotropy=v.anisotropy}}}function De(b,v){let I=!1;b.__webglInit===void 0&&(b.__webglInit=!0,v.addEventListener("dispose",P));const j=v.source;let G=d.get(j);G===void 0&&(G={},d.set(j,G));const V=X(v);if(V!==b.__cacheKey){G[V]===void 0&&(G[V]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,I=!0),G[V].usedTimes++;const ue=G[b.__cacheKey];ue!==void 0&&(G[b.__cacheKey].usedTimes--,ue.usedTimes===0&&D(v)),b.__cacheKey=V,b.__webglTexture=G[V].texture}return I}function je(b,v,I){let j=n.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(j=n.TEXTURE_2D_ARRAY),v.isData3DTexture&&(j=n.TEXTURE_3D);const G=De(b,v),V=v.source;t.bindTexture(j,b.__webglTexture,n.TEXTURE0+I);const ue=i.get(V);if(V.version!==ue.__version||G===!0){t.activeTexture(n.TEXTURE0+I);const le=st.getPrimaries(st.workingColorSpace),pe=v.colorSpace===di?null:st.getPrimaries(v.colorSpace),Re=v.colorSpace===di||le===pe?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Re);let fe=E(v.image,!1,r.maxTextureSize);fe=ie(v,fe);const ve=s.convert(v.format,v.colorSpace),Ue=s.convert(v.type);let Le=M(v.internalFormat,ve,Ue,v.colorSpace,v.isVideoTexture);Me(j,v);let ye;const $e=v.mipmaps,Ne=v.isVideoTexture!==!0,qe=ue.__version===void 0||G===!0,N=V.dataReady,Ae=y(v,fe);if(v.isDepthTexture)Le=_(v.format===Dr,v.type),qe&&(Ne?t.texStorage2D(n.TEXTURE_2D,1,Le,fe.width,fe.height):t.texImage2D(n.TEXTURE_2D,0,Le,fe.width,fe.height,0,ve,Ue,null));else if(v.isDataTexture)if($e.length>0){Ne&&qe&&t.texStorage2D(n.TEXTURE_2D,Ae,Le,$e[0].width,$e[0].height);for(let te=0,ce=$e.length;te<ce;te++)ye=$e[te],Ne?N&&t.texSubImage2D(n.TEXTURE_2D,te,0,0,ye.width,ye.height,ve,Ue,ye.data):t.texImage2D(n.TEXTURE_2D,te,Le,ye.width,ye.height,0,ve,Ue,ye.data);v.generateMipmaps=!1}else Ne?(qe&&t.texStorage2D(n.TEXTURE_2D,Ae,Le,fe.width,fe.height),N&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,fe.width,fe.height,ve,Ue,fe.data)):t.texImage2D(n.TEXTURE_2D,0,Le,fe.width,fe.height,0,ve,Ue,fe.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Ne&&qe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Ae,Le,$e[0].width,$e[0].height,fe.depth);for(let te=0,ce=$e.length;te<ce;te++)if(ye=$e[te],v.format!==_n)if(ve!==null)if(Ne){if(N)if(v.layerUpdates.size>0){const Ee=Mf(ye.width,ye.height,v.format,v.type);for(const Te of v.layerUpdates){const Ke=ye.data.subarray(Te*Ee/ye.data.BYTES_PER_ELEMENT,(Te+1)*Ee/ye.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,te,0,0,Te,ye.width,ye.height,1,ve,Ke,0,0)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,te,0,0,0,ye.width,ye.height,fe.depth,ve,ye.data,0,0)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,te,Le,ye.width,ye.height,fe.depth,0,ye.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ne?N&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,te,0,0,0,ye.width,ye.height,fe.depth,ve,Ue,ye.data):t.texImage3D(n.TEXTURE_2D_ARRAY,te,Le,ye.width,ye.height,fe.depth,0,ve,Ue,ye.data)}else{Ne&&qe&&t.texStorage2D(n.TEXTURE_2D,Ae,Le,$e[0].width,$e[0].height);for(let te=0,ce=$e.length;te<ce;te++)ye=$e[te],v.format!==_n?ve!==null?Ne?N&&t.compressedTexSubImage2D(n.TEXTURE_2D,te,0,0,ye.width,ye.height,ve,ye.data):t.compressedTexImage2D(n.TEXTURE_2D,te,Le,ye.width,ye.height,0,ye.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ne?N&&t.texSubImage2D(n.TEXTURE_2D,te,0,0,ye.width,ye.height,ve,Ue,ye.data):t.texImage2D(n.TEXTURE_2D,te,Le,ye.width,ye.height,0,ve,Ue,ye.data)}else if(v.isDataArrayTexture)if(Ne){if(qe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Ae,Le,fe.width,fe.height,fe.depth),N)if(v.layerUpdates.size>0){const te=Mf(fe.width,fe.height,v.format,v.type);for(const ce of v.layerUpdates){const Ee=fe.data.subarray(ce*te/fe.data.BYTES_PER_ELEMENT,(ce+1)*te/fe.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,ce,fe.width,fe.height,1,ve,Ue,Ee)}v.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,fe.width,fe.height,fe.depth,ve,Ue,fe.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Le,fe.width,fe.height,fe.depth,0,ve,Ue,fe.data);else if(v.isData3DTexture)Ne?(qe&&t.texStorage3D(n.TEXTURE_3D,Ae,Le,fe.width,fe.height,fe.depth),N&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,fe.width,fe.height,fe.depth,ve,Ue,fe.data)):t.texImage3D(n.TEXTURE_3D,0,Le,fe.width,fe.height,fe.depth,0,ve,Ue,fe.data);else if(v.isFramebufferTexture){if(qe)if(Ne)t.texStorage2D(n.TEXTURE_2D,Ae,Le,fe.width,fe.height);else{let te=fe.width,ce=fe.height;for(let Ee=0;Ee<Ae;Ee++)t.texImage2D(n.TEXTURE_2D,Ee,Le,te,ce,0,ve,Ue,null),te>>=1,ce>>=1}}else if($e.length>0){if(Ne&&qe){const te=re($e[0]);t.texStorage2D(n.TEXTURE_2D,Ae,Le,te.width,te.height)}for(let te=0,ce=$e.length;te<ce;te++)ye=$e[te],Ne?N&&t.texSubImage2D(n.TEXTURE_2D,te,0,0,ve,Ue,ye):t.texImage2D(n.TEXTURE_2D,te,Le,ve,Ue,ye);v.generateMipmaps=!1}else if(Ne){if(qe){const te=re(fe);t.texStorage2D(n.TEXTURE_2D,Ae,Le,te.width,te.height)}N&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ve,Ue,fe)}else t.texImage2D(n.TEXTURE_2D,0,Le,ve,Ue,fe);m(v)&&p(j),ue.__version=V.version,v.onUpdate&&v.onUpdate(v)}b.__version=v.version}function ee(b,v,I){if(v.image.length!==6)return;const j=De(b,v),G=v.source;t.bindTexture(n.TEXTURE_CUBE_MAP,b.__webglTexture,n.TEXTURE0+I);const V=i.get(G);if(G.version!==V.__version||j===!0){t.activeTexture(n.TEXTURE0+I);const ue=st.getPrimaries(st.workingColorSpace),le=v.colorSpace===di?null:st.getPrimaries(v.colorSpace),pe=v.colorSpace===di||ue===le?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,pe);const Re=v.isCompressedTexture||v.image[0].isCompressedTexture,fe=v.image[0]&&v.image[0].isDataTexture,ve=[];for(let ce=0;ce<6;ce++)!Re&&!fe?ve[ce]=E(v.image[ce],!0,r.maxCubemapSize):ve[ce]=fe?v.image[ce].image:v.image[ce],ve[ce]=ie(v,ve[ce]);const Ue=ve[0],Le=s.convert(v.format,v.colorSpace),ye=s.convert(v.type),$e=M(v.internalFormat,Le,ye,v.colorSpace),Ne=v.isVideoTexture!==!0,qe=V.__version===void 0||j===!0,N=G.dataReady;let Ae=y(v,Ue);Me(n.TEXTURE_CUBE_MAP,v);let te;if(Re){Ne&&qe&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Ae,$e,Ue.width,Ue.height);for(let ce=0;ce<6;ce++){te=ve[ce].mipmaps;for(let Ee=0;Ee<te.length;Ee++){const Te=te[Ee];v.format!==_n?Le!==null?Ne?N&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Ee,0,0,Te.width,Te.height,Le,Te.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Ee,$e,Te.width,Te.height,0,Te.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ne?N&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Ee,0,0,Te.width,Te.height,Le,ye,Te.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Ee,$e,Te.width,Te.height,0,Le,ye,Te.data)}}}else{if(te=v.mipmaps,Ne&&qe){te.length>0&&Ae++;const ce=re(ve[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,Ae,$e,ce.width,ce.height)}for(let ce=0;ce<6;ce++)if(fe){Ne?N&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,0,0,ve[ce].width,ve[ce].height,Le,ye,ve[ce].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,$e,ve[ce].width,ve[ce].height,0,Le,ye,ve[ce].data);for(let Ee=0;Ee<te.length;Ee++){const Ke=te[Ee].image[ce].image;Ne?N&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Ee+1,0,0,Ke.width,Ke.height,Le,ye,Ke.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Ee+1,$e,Ke.width,Ke.height,0,Le,ye,Ke.data)}}else{Ne?N&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,0,0,Le,ye,ve[ce]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,$e,Le,ye,ve[ce]);for(let Ee=0;Ee<te.length;Ee++){const Te=te[Ee];Ne?N&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Ee+1,0,0,Le,ye,Te.image[ce]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,Ee+1,$e,Le,ye,Te.image[ce])}}}m(v)&&p(n.TEXTURE_CUBE_MAP),V.__version=G.version,v.onUpdate&&v.onUpdate(v)}b.__version=v.version}function de(b,v,I,j,G,V){const ue=s.convert(I.format,I.colorSpace),le=s.convert(I.type),pe=M(I.internalFormat,ue,le,I.colorSpace);if(!i.get(v).__hasExternalTextures){const fe=Math.max(1,v.width>>V),ve=Math.max(1,v.height>>V);G===n.TEXTURE_3D||G===n.TEXTURE_2D_ARRAY?t.texImage3D(G,V,pe,fe,ve,v.depth,0,ue,le,null):t.texImage2D(G,V,pe,fe,ve,0,ue,le,null)}t.bindFramebuffer(n.FRAMEBUFFER,b),Z(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,j,G,i.get(I).__webglTexture,0,O(v)):(G===n.TEXTURE_2D||G>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&G<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,j,G,i.get(I).__webglTexture,V),t.bindFramebuffer(n.FRAMEBUFFER,null)}function xe(b,v,I){if(n.bindRenderbuffer(n.RENDERBUFFER,b),v.depthBuffer){const j=v.depthTexture,G=j&&j.isDepthTexture?j.type:null,V=_(v.stencilBuffer,G),ue=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,le=O(v);Z(v)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,le,V,v.width,v.height):I?n.renderbufferStorageMultisample(n.RENDERBUFFER,le,V,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,V,v.width,v.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,ue,n.RENDERBUFFER,b)}else{const j=v.textures;for(let G=0;G<j.length;G++){const V=j[G],ue=s.convert(V.format,V.colorSpace),le=s.convert(V.type),pe=M(V.internalFormat,ue,le,V.colorSpace),Re=O(v);I&&Z(v)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Re,pe,v.width,v.height):Z(v)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Re,pe,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,pe,v.width,v.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function F(b,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,b),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(v.depthTexture).__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),Q(v.depthTexture,0);const j=i.get(v.depthTexture).__webglTexture,G=O(v);if(v.depthTexture.format===yr)Z(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,j,0,G):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,j,0);else if(v.depthTexture.format===Dr)Z(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,j,0,G):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,j,0);else throw new Error("Unknown depthTexture format")}function oe(b){const v=i.get(b),I=b.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==b.depthTexture){const j=b.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),j){const G=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,j.removeEventListener("dispose",G)};j.addEventListener("dispose",G),v.__depthDisposeCallback=G}v.__boundDepthTexture=j}if(b.depthTexture&&!v.__autoAllocateDepthBuffer){if(I)throw new Error("target.depthTexture not supported in Cube render targets");F(v.__webglFramebuffer,b)}else if(I){v.__webglDepthbuffer=[];for(let j=0;j<6;j++)if(t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[j]),v.__webglDepthbuffer[j]===void 0)v.__webglDepthbuffer[j]=n.createRenderbuffer(),xe(v.__webglDepthbuffer[j],b,!1);else{const G=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,V=v.__webglDepthbuffer[j];n.bindRenderbuffer(n.RENDERBUFFER,V),n.framebufferRenderbuffer(n.FRAMEBUFFER,G,n.RENDERBUFFER,V)}}else if(t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=n.createRenderbuffer(),xe(v.__webglDepthbuffer,b,!1);else{const j=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,G=v.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,G),n.framebufferRenderbuffer(n.FRAMEBUFFER,j,n.RENDERBUFFER,G)}t.bindFramebuffer(n.FRAMEBUFFER,null)}function ne(b,v,I){const j=i.get(b);v!==void 0&&de(j.__webglFramebuffer,b,b.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),I!==void 0&&oe(b)}function he(b){const v=b.texture,I=i.get(b),j=i.get(v);b.addEventListener("dispose",C);const G=b.textures,V=b.isWebGLCubeRenderTarget===!0,ue=G.length>1;if(ue||(j.__webglTexture===void 0&&(j.__webglTexture=n.createTexture()),j.__version=v.version,o.memory.textures++),V){I.__webglFramebuffer=[];for(let le=0;le<6;le++)if(v.mipmaps&&v.mipmaps.length>0){I.__webglFramebuffer[le]=[];for(let pe=0;pe<v.mipmaps.length;pe++)I.__webglFramebuffer[le][pe]=n.createFramebuffer()}else I.__webglFramebuffer[le]=n.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){I.__webglFramebuffer=[];for(let le=0;le<v.mipmaps.length;le++)I.__webglFramebuffer[le]=n.createFramebuffer()}else I.__webglFramebuffer=n.createFramebuffer();if(ue)for(let le=0,pe=G.length;le<pe;le++){const Re=i.get(G[le]);Re.__webglTexture===void 0&&(Re.__webglTexture=n.createTexture(),o.memory.textures++)}if(b.samples>0&&Z(b)===!1){I.__webglMultisampledFramebuffer=n.createFramebuffer(),I.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,I.__webglMultisampledFramebuffer);for(let le=0;le<G.length;le++){const pe=G[le];I.__webglColorRenderbuffer[le]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,I.__webglColorRenderbuffer[le]);const Re=s.convert(pe.format,pe.colorSpace),fe=s.convert(pe.type),ve=M(pe.internalFormat,Re,fe,pe.colorSpace,b.isXRRenderTarget===!0),Ue=O(b);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ue,ve,b.width,b.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+le,n.RENDERBUFFER,I.__webglColorRenderbuffer[le])}n.bindRenderbuffer(n.RENDERBUFFER,null),b.depthBuffer&&(I.__webglDepthRenderbuffer=n.createRenderbuffer(),xe(I.__webglDepthRenderbuffer,b,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(V){t.bindTexture(n.TEXTURE_CUBE_MAP,j.__webglTexture),Me(n.TEXTURE_CUBE_MAP,v);for(let le=0;le<6;le++)if(v.mipmaps&&v.mipmaps.length>0)for(let pe=0;pe<v.mipmaps.length;pe++)de(I.__webglFramebuffer[le][pe],b,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+le,pe);else de(I.__webglFramebuffer[le],b,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0);m(v)&&p(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ue){for(let le=0,pe=G.length;le<pe;le++){const Re=G[le],fe=i.get(Re);t.bindTexture(n.TEXTURE_2D,fe.__webglTexture),Me(n.TEXTURE_2D,Re),de(I.__webglFramebuffer,b,Re,n.COLOR_ATTACHMENT0+le,n.TEXTURE_2D,0),m(Re)&&p(n.TEXTURE_2D)}t.unbindTexture()}else{let le=n.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(le=b.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(le,j.__webglTexture),Me(le,v),v.mipmaps&&v.mipmaps.length>0)for(let pe=0;pe<v.mipmaps.length;pe++)de(I.__webglFramebuffer[pe],b,v,n.COLOR_ATTACHMENT0,le,pe);else de(I.__webglFramebuffer,b,v,n.COLOR_ATTACHMENT0,le,0);m(v)&&p(le),t.unbindTexture()}b.depthBuffer&&oe(b)}function we(b){const v=b.textures;for(let I=0,j=v.length;I<j;I++){const G=v[I];if(m(G)){const V=b.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,ue=i.get(G).__webglTexture;t.bindTexture(V,ue),p(V),t.unbindTexture()}}}const Pe=[],g=[];function L(b){if(b.samples>0){if(Z(b)===!1){const v=b.textures,I=b.width,j=b.height;let G=n.COLOR_BUFFER_BIT;const V=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ue=i.get(b),le=v.length>1;if(le)for(let pe=0;pe<v.length;pe++)t.bindFramebuffer(n.FRAMEBUFFER,ue.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,ue.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,ue.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ue.__webglFramebuffer);for(let pe=0;pe<v.length;pe++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(G|=n.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(G|=n.STENCIL_BUFFER_BIT)),le){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ue.__webglColorRenderbuffer[pe]);const Re=i.get(v[pe]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Re,0)}n.blitFramebuffer(0,0,I,j,0,0,I,j,G,n.NEAREST),l===!0&&(Pe.length=0,g.length=0,Pe.push(n.COLOR_ATTACHMENT0+pe),b.depthBuffer&&b.resolveDepthBuffer===!1&&(Pe.push(V),g.push(V),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,g)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,Pe))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),le)for(let pe=0;pe<v.length;pe++){t.bindFramebuffer(n.FRAMEBUFFER,ue.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.RENDERBUFFER,ue.__webglColorRenderbuffer[pe]);const Re=i.get(v[pe]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,ue.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.TEXTURE_2D,Re,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ue.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&l){const v=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[v])}}}function O(b){return Math.min(r.maxSamples,b.samples)}function Z(b){const v=i.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function W(b){const v=o.render.frame;u.get(b)!==v&&(u.set(b,v),b.update())}function ie(b,v){const I=b.colorSpace,j=b.format,G=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||I!==Mi&&I!==di&&(st.getTransfer(I)===pt?(j!==_n||G!==qn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",I)),v}function re(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(c.width=b.naturalWidth||b.width,c.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(c.width=b.displayWidth,c.height=b.displayHeight):(c.width=b.width,c.height=b.height),c}this.allocateTextureUnit=U,this.resetTextureUnits=A,this.setTexture2D=Q,this.setTexture2DArray=ae,this.setTexture3D=q,this.setTextureCube=J,this.rebindTextures=ne,this.setupRenderTarget=he,this.updateRenderTargetMipmap=we,this.updateMultisampleRenderTarget=L,this.setupDepthRenderbuffer=oe,this.setupFrameBufferTexture=de,this.useMultisampledRTT=Z}function Uy(n,e){function t(i,r=di){let s;const o=st.getTransfer(r);if(i===qn)return n.UNSIGNED_BYTE;if(i===lc)return n.UNSIGNED_SHORT_4_4_4_4;if(i===cc)return n.UNSIGNED_SHORT_5_5_5_1;if(i===gh)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===ph)return n.BYTE;if(i===mh)return n.SHORT;if(i===hs)return n.UNSIGNED_SHORT;if(i===ac)return n.INT;if(i===Xi)return n.UNSIGNED_INT;if(i===Wn)return n.FLOAT;if(i===xs)return n.HALF_FLOAT;if(i===_h)return n.ALPHA;if(i===vh)return n.RGB;if(i===_n)return n.RGBA;if(i===xh)return n.LUMINANCE;if(i===Sh)return n.LUMINANCE_ALPHA;if(i===yr)return n.DEPTH_COMPONENT;if(i===Dr)return n.DEPTH_STENCIL;if(i===Mh)return n.RED;if(i===uc)return n.RED_INTEGER;if(i===yh)return n.RG;if(i===fc)return n.RG_INTEGER;if(i===dc)return n.RGBA_INTEGER;if(i===io||i===ro||i===so||i===oo)if(o===pt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===io)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===ro)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===so)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===oo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===io)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===ro)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===so)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===oo)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===hl||i===pl||i===ml||i===gl)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===hl)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===pl)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===ml)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===gl)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===_l||i===vl||i===xl)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===_l||i===vl)return o===pt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===xl)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Sl||i===Ml||i===yl||i===El||i===bl||i===Al||i===Tl||i===wl||i===Rl||i===Cl||i===Pl||i===Ll||i===Il||i===Dl)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Sl)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Ml)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===yl)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===El)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===bl)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Al)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Tl)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===wl)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Rl)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Cl)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Pl)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Ll)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Il)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Dl)return o===pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===ao||i===Ul||i===Nl)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===ao)return o===pt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Ul)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Nl)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Eh||i===Fl||i===Ol||i===Bl)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===ao)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Fl)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Ol)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Bl)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Ir?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}class Ny extends en{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Zs extends $t{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Fy={type:"move"};class Na{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Zs,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Zs,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new $,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new $),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Zs,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new $,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new $),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const E of e.hand.values()){const m=t.getJointPose(E,i),p=this._getHandJoint(c,E);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],d=u.position.distanceTo(f.position),h=.02,S=.005;c.inputState.pinching&&d>h+S?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&d<=h-S&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=t.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Fy)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new Zs;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}const Oy=`
void main() {
...
}`;class ky{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,i){if(this.texture===null){const r=new jt,s=e.properties.get(r);s.__webglTexture=t.texture,(t.depthNear!=i.depthNear||t.depthFar!=i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new vi({vertexShader:Oy,fragmentShader:By,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Tn(new ko(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class zy extends Nr{constructor(e,t){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,u=null,f=null,d=null,h=null,S=null;const E=new ky,m=t.getContextAttributes();let p=null,M=null;const _=[],y=[],P=new Je;let C=null;const R=new en;R.layers.enable(1),R.viewport=new ct;const D=new en;D.layers.enable(2),D.viewport=new ct;const k=[R,D],x=new Ny;x.layers.enable(1),x.layers.enable(2);let A=null,U=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(ee){let de=_[ee];return de===void 0&&(de=new Na,_[ee]=de),de.getTargetRaySpace()},this.getControllerGrip=function(ee){let de=_[ee];return de===void 0&&(de=new Na,_[ee]=de),de.getGripSpace()},this.getHand=function(ee){let de=_[ee];return de===void 0&&(de=new Na,_[ee]=de),de.getHandSpace()};function X(ee){const de=y.indexOf(ee.inputSource);if(de===-1)return;const xe=_[de];xe!==void 0&&(xe.update(ee.inputSource,ee.frame,c||o),xe.dispatchEvent({type:ee.type,data:ee.inputSource}))}function Q(){r.removeEventListener("select",X),r.removeEventListener("selectstart",X),r.removeEventListener("selectend",X),r.removeEventListener("squeeze",X),r.removeEventListener("squeezestart",X),r.removeEventListener("squeezeend",X),r.removeEventListener("end",Q),r.removeEventListener("inputsourceschange",ae);for(let ee=0;ee<_.length;ee++){const de=y[ee];de!==null&&(y[ee]=null,_[ee].disconnect(de))}A=null,U=null,E.reset(),e.setRenderTarget(p),h=null,d=null,f=null,r=null,M=null,je.stop(),i.isPresenting=!1,e.setPixelRatio(C),e.setSize(P.width,P.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(ee){s=ee,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(ee){a=ee,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(ee){c=ee},this.getBaseLayer=function(){return d!==null?d:h},this.getBinding=function(){return f},this.getFrame=function(){return S},this.getSession=function(){return r},this.setSession=async function(ee){if(r=ee,r!==null){if(p=e.getRenderTarget(),r.addEventListener("select",X),r.addEventListener("selectstart",X),r.addEventListener("selectend",X),r.addEventListener("squeeze",X),r.addEventListener("squeezestart",X),r.addEventListener("squeezeend",X),r.addEventListener("end",Q),r.addEventListener("inputsourceschange",ae),m.xrCompatible!==!0&&await t.makeXRCompatible(),C=e.getPixelRatio(),e.getSize(P),r.renderState.layers===void 0){const de={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};h=new XRWebGLLayer(r,t,de),r.updateRenderState({baseLayer:h}),e.setPixelRatio(1),e.setSize(h.framebufferWidth,h.framebufferHeight,!1),M=new ji(h.framebufferWidth,h.framebufferHeight,{format:_n,type:qn,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil})}else{let de=null,xe=null,F=null;m.depth&&(F=m.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,de=m.stencil?Dr:yr,xe=m.stencil?Ir:Xi);const oe={colorFormat:t.RGBA8,depthFormat:F,scaleFactor:s};f=new XRWebGLBinding(r,t),d=f.createProjectionLayer(oe),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),M=new ji(d.textureWidth,d.textureHeight,{format:_n,type:qn,depthTexture:new Bh(d.textureWidth,d.textureHeight,xe,void 0,void 0,void 0,void 0,void 0,void 0,de),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),je.setContext(r),je.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return E.getDepthTexture()};function ae(ee){for(let de=0;de<ee.removed.length;de++){const xe=ee.removed[de],F=y.indexOf(xe);F>=0&&(y[F]=null,_[F].disconnect(xe))}for(let de=0;de<ee.added.length;de++){const xe=ee.added[de];let F=y.indexOf(xe);if(F===-1){for(let ne=0;ne<_.length;ne++)if(ne>=y.length){y.push(xe),F=ne;break}else if(y[ne]===null){y[ne]=xe,F=ne;break}if(F===-1)break}const oe=_[F];oe&&oe.connect(xe)}}const q=new $,J=new $;function H(ee,de,xe){q.setFromMatrixPosition(de.matrixWorld),J.setFromMatrixPosition(xe.matrixWorld);const F=q.distanceTo(J),oe=de.projectionMatrix.elements,ne=xe.projectionMatrix.elements,he=oe[14]/(oe[10]-1),we=oe[14]/(oe[10]+1),Pe=(oe[9]+1)/oe[5],g=(oe[9]-1)/oe[5],L=(oe[8]-1)/oe[0],O=(ne[8]+1)/ne[0],Z=he*L,W=he*O,ie=F/(-L+O),re=ie*-L;if(de.matrixWorld.decompose(ee.position,ee.quaternion,ee.scale),ee.translateX(re),ee.translateZ(ie),ee.matrixWorld.compose(ee.position,ee.quaternion,ee.scale),ee.matrixWorldInverse.copy(ee.matrixWorld).invert(),oe[10]===-1)ee.projectionMatrix.copy(de.projectionMatrix),ee.projectionMatrixInverse.copy(de.projectionMatrixInverse);else{const b=he+ie,v=we+ie,I=Z-re,j=W+(F-re),G=Pe*we/v*b,V=g*we/v*b;ee.projectionMatrix.makePerspective(I,j,G,V,b,v),ee.projectionMatrixInverse.copy(ee.projectionMatrix).invert()}}function me(ee,de){de===null?ee.matrixWorld.copy(ee.matrix):ee.matrixWorld.multiplyMatrices(de.matrixWorld,ee.matrix),ee.matrixWorldInverse.copy(ee.matrixWorld).invert()}this.updateCamera=function(ee){if(r===null)return;let de=ee.near,xe=ee.far;E.texture!==null&&(E.depthNear>0&&(de=E.depthNear),E.depthFar>0&&(xe=E.depthFar)),x.near=D.near=R.near=de,x.far=D.far=R.far=xe,(A!==x.near||U!==x.far)&&(r.updateRenderState({depthNear:x.near,depthFar:x.far}),A=x.near,U=x.far);const F=ee.parent,oe=x.cameras;me(x,F);for(let ne=0;ne<oe.length;ne++)me(oe[ne],F);oe.length===2?H(x,R,D):x.projectionMatrix.copy(R.projectionMatrix),_e(ee,x,F)};function _e(ee,de,xe){xe===null?ee.matrix.copy(de.matrixWorld):(ee.matrix.copy(xe.matrixWorld),ee.matrix.invert(),ee.matrix.multiply(de.matrixWorld)),ee.matrix.decompose(ee.position,ee.quaternion,ee.scale),ee.updateMatrixWorld(!0),ee.projectionMatrix.copy(de.projectionMatrix),ee.projectionMatrixInverse.copy(de.projectionMatrixInverse),ee.isPerspectiveCamera&&(ee.fov=ps*2*Math.atan(1/ee.projectionMatrix.elements[5]),ee.zoom=1)}this.getCamera=function(){return x},this.getFoveation=function(){if(!(d===null&&h===null))return l},this.setFoveation=function(ee){l=ee,d!==null&&(d.fixedFoveation=ee),h!==null&&h.fixedFoveation!==void 0&&(h.fixedFoveation=ee)},this.hasDepthSensing=function(){return E.texture!==null},this.getDepthSensingMesh=function(){return E.getMesh(x)};let Me=null;function De(ee,de){if(u=de.getViewerPose(c||o),S=de,u!==null){const xe=u.views;h!==null&&(e.setRenderTargetFramebuffer(M,h.framebuffer),e.setRenderTarget(M));let F=!1;xe.length!==x.cameras.length&&(x.cameras.length=0,F=!0);for(let ne=0;ne<xe.length;ne++){const he=xe[ne];let we=null;if(h!==null)we=h.getViewport(he);else{const g=f.getViewSubImage(d,he);we=g.viewport,ne===0&&(e.setRenderTargetTextures(M,g.colorTexture,d.ignoreDepthValues?void 0:g.depthStencilTexture),e.setRenderTarget(M))}let Pe=k[ne];Pe===void 0&&(Pe=new en,Pe.layers.enable(ne),Pe.viewport=new ct,k[ne]=Pe),Pe.matrix.fromArray(he.transform.matrix),Pe.matrix.decompose(Pe.position,Pe.quaternion,Pe.scale),Pe.projectionMatrix.fromArray(he.projectionMatrix),Pe.projectionMatrixInverse.copy(Pe.projectionMatrix).invert(),Pe.viewport.set(we.x,we.y,we.width,we.height),ne===0&&(x.matrix.copy(Pe.matrix),x.matrix.decompose(x.position,x.quaternion,x.scale)),F===!0&&x.cameras.push(Pe)}const oe=r.enabledFeatures;if(oe&&oe.includes("depth-sensing")){const ne=f.getDepthInformation(xe[0]);ne&&ne.isValid&&ne.texture&&E.init(e,ne,r.renderState)}}for(let xe=0;xe<_.length;xe++){const F=y[xe],oe=_[xe];F!==null&&oe!==void 0&&oe.update(F,de,c||o)}Me&&Me(ee,de),de.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:de}),S=null}const je=new Oh;je.setAnimationLoop(De),this.setAnimationLoop=function(ee){Me=ee},this.dispose=function(){}}}const Ii=new Pn,Hy=new gt;function Vy(n,e){function t(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function i(m,p){p.color.getRGB(m.fogColor.value,Uh(n)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function r(m,p,M,_,y){p.isMeshBasicMaterial||p.isMeshLambertMaterial?s(m,p):p.isMeshToonMaterial?(s(m,p),f(m,p)):p.isMeshPhongMaterial?(s(m,p),u(m,p)):p.isMeshStandardMaterial?(s(m,p),d(m,p),p.isMeshPhysicalMaterial&&h(m,p,y)):p.isMeshMatcapMaterial?(s(m,p),S(m,p)):p.isMeshDepthMaterial?s(m,p):p.isMeshDistanceMaterial?(s(m,p),E(m,p)):p.isMeshNormalMaterial?s(m,p):p.isLineBasicMaterial?(o(m,p),p.isLineDashedMaterial&&a(m,p)):p.isPointsMaterial?l(m,p,M,_):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function s(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,t(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===Xt&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,t(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===Xt&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,t(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,t(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,t(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const M=e.get(p),_=M.envMap,y=M.envMapRotation;_&&(m.envMap.value=_,Ii.copy(y),Ii.x*=-1,Ii.y*=-1,Ii.z*=-1,_.isCubeTexture&&_.isRenderTargetTexture===!1&&(Ii.y*=-1,Ii.z*=-1),m.envMapRotation.value.setFromMatrix4(Hy.makeRotationFromEuler(Ii)),m.flipEnvMap.value=_.isCubeTexture&&_.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,t(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,t(p.aoMap,m.aoMapTransform))}function o(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform))}function a(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,M,_){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*M,m.scale.value=_*.5,p.map&&(m.map.value=p.map,t(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function u(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function f(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function d(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,t(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,t(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function h(m,p,M){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,t(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,t(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,t(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,t(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,t(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===Xt&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,t(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,t(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=M.texture,m.transmissionSamplerSize.value.set(M.width,M.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,t(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,t(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,t(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,t(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,t(p.specularIntensityMap,m.specularIntensityMapTransform))}function S(m,p){p.matcap&&(m.matcap.value=p.matcap)}function E(m,p){const M=e.get(p).light;m.referencePosition.value.setFromMatrixPosition(M.matrixWorld),m.nearDistance.value=M.shadow.camera.near,m.farDistance.value=M.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function Gy(n,e,t,i){let r={},s={},o=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(M,_){const y=_.program;i.uniformBlockBinding(M,y)}function c(M,_){let y=r[M.id];y===void 0&&(S(M),y=u(M),r[M.id]=y,M.addEventListener("dispose",m));const P=_.program;i.updateUBOMapping(M,P);const C=e.render.frame;s[M.id]!==C&&(d(M),s[M.id]=C)}function u(M){const _=f();M.__bindingPointIndex=_;const y=n.createBuffer(),P=M.__size,C=M.usage;return n.bindBuffer(n.UNIFORM_BUFFER,y),n.bufferData(n.UNIFORM_BUFFER,P,C),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,_,y),y}function f(){for(let M=0;M<a;M++)if(o.indexOf(M)===-1)return o.push(M),M;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(M){const _=r[M.id],y=M.uniforms,P=M.__cache;n.bindBuffer(n.UNIFORM_BUFFER,_);for(let C=0,R=y.length;C<R;C++){const D=Array.isArray(y[C])?y[C]:[y[C]];for(let k=0,x=D.length;k<x;k++){const A=D[k];if(h(A,C,k,P)===!0){const U=A.__offset,X=Array.isArray(A.value)?A.value:[A.value];let Q=0;for(let ae=0;ae<X.length;ae++){const q=X[ae],J=E(q);typeof q=="number"||typeof q=="boolean"?(A.__data[0]=q,n.bufferSubData(n.UNIFORM_BUFFER,U+Q,A.__data)):q.isMatrix3?(A.__data[0]=q.elements[0],A.__data[1]=q.elements[1],A.__data[2]=q.elements[2],A.__data[3]=0,A.__data[4]=q.elements[3],A.__data[5]=q.elements[4],A.__data[6]=q.elements[5],A.__data[7]=0,A.__data[8]=q.elements[6],A.__data[9]=q.elements[7],A.__data[10]=q.elements[8],A.__data[11]=0):(q.toArray(A.__data,Q),Q+=J.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,U,A.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function h(M,_,y,P){const C=M.value,R=_+"_"+y;if(P[R]===void 0)return typeof C=="number"||typeof C=="boolean"?P[R]=C:P[R]=C.clone(),!0;{const D=P[R];if(typeof C=="number"||typeof C=="boolean"){if(D!==C)return P[R]=C,!0}else if(D.equals(C)===!1)return D.copy(C),!0}return!1}function S(M){const _=M.uniforms;let y=0;const P=16;for(let R=0,D=_.length;R<D;R++){const k=Array.isArray(_[R])?_[R]:[_[R]];for(let x=0,A=k.length;x<A;x++){const U=k[x],X=Array.isArray(U.value)?U.value:[U.value];for(let Q=0,ae=X.length;Q<ae;Q++){const q=X[Q],J=E(q),H=y%P,me=H%J.boundary,_e=H+me;y+=me,_e!==0&&P-_e<J.storage&&(y+=P-_e),U.__data=new Float32Array(J.storage/Float32Array.BYTES_PER_ELEMENT),U.__offset=y,y+=J.storage}}}const C=y%P;return C>0&&(y+=P-C),M.__size=y,M.__cache={},this}function E(M){const _={boundary:0,storage:0};return typeof M=="number"||typeof M=="boolean"?(_.boundary=4,_.storage=4):M.isVector2?(_.boundary=8,_.storage=8):M.isVector3||M.isColor?(_.boundary=16,_.storage=12):M.isVector4?(_.boundary=16,_.storage=16):M.isMatrix3?(_.boundary=48,_.storage=48):M.isMatrix4?(_.boundary=64,_.storage=64):M.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",M),_}function m(M){const _=M.target;_.removeEventListener("dispose",m);const y=o.indexOf(_.__bindingPointIndex);o.splice(y,1),n.deleteBuffer(r[_.id]),delete r[_.id],delete s[_.id]}function p(){for(const M in r)n.deleteBuffer(r[M]);o=[],r={},s={}}return{bind:l,update:c,dispose:p}}class Wy{constructor(e={}){const{canvas:t=C0(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1}=e;this.isWebGLRenderer=!0;let d;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");d=i.getContextAttributes().alpha}else d=o;const h=new Uint32Array(4),S=new Int32Array(4);let E=null,m=null;const p=[],M=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=En,this.toneMapping=mi,this.toneMappingExposure=1;const _=this;let y=!1,P=0,C=0,R=null,D=-1,k=null;const x=new ct,A=new ct;let U=null;const X=new et(0);let Q=0,ae=t.width,q=t.height,J=1,H=null,me=null;const _e=new ct(0,0,ae,q),Me=new ct(0,0,ae,q);let De=!1;const je=new gc;let ee=!1,de=!1;const xe=new gt,F=new gt,oe=new $,ne=new ct,he={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let we=!1;function Pe(){return R===null?J:1}let g=i;function L(T,B){return t.getContext(T,B)}try{const T={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${oc}`),t.addEventListener("webglcontextlost",ce,!1),t.addEventListener("webglcontextrestored",Ee,!1),t.addEventListener("webglcontextcreationerror",Te,!1),g===null){const B="webgl2";if(g=L(B,T),g===null)throw L(B)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(T){throw console.error("THREE.WebGLRenderer: "+T.message),T}let O,Z,W,ie,re,b,v,I,j,G,V,ue,le,pe,Re,fe,ve,Ue,Le,ye,$e,Ne,qe,N;function Ae(){O=new YS(g),O.init(),Ne=new Uy(g,O),Z=new VS(g,O,e,Ne),W=new Ly(g),Z.reverseDepthBuffer&&W.buffers.depth.setReversed(!0),ie=new JS(g),re=new gy,b=new Dy(g,O,W,re,Z,Ne,ie),v=new WS(_),I=new qS(_),j=new rv(g),qe=new zS(g,j),G=new KS(g,j,ie,qe),V=new eM(g,G,j,ie),Le=new QS(g,Z,b),fe=new GS(re),ue=new my(_,v,I,O,Z,qe,fe),le=new Vy(_,re),pe=new vy,Re=new by(O),Ue=new kS(_,v,I,W,V,d,l),ve=new Cy(_,V,Z),N=new Gy(g,ie,Z,W),ye=new HS(g,O,ie),$e=new ZS(g,O,ie),ie.programs=ue.programs,_.capabilities=Z,_.extensions=O,_.properties=re,_.renderLists=pe,_.shadowMap=ve,_.state=W,_.info=ie}Ae();const te=new zy(_,g);this.xr=te,this.getContext=function(){return g},this.getContextAttributes=function(){return g.getContextAttributes()},this.forceContextLoss=function(){const T=O.get("WEBGL_lose_context");T&&T.loseContext()},this.forceContextRestore=function(){const T=O.get("WEBGL_lose_context");T&&T.restoreContext()},this.getPixelRatio=function(){return J},this.setPixelRatio=function(T){T!==void 0&&(J=T,this.setSize(ae,q,!1))},this.getSize=function(T){return T.set(ae,q)},this.setSize=function(T,B,Y=!0){if(te.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}ae=T,q=B,t.width=Math.floor(T*J),t.height=Math.floor(B*J),Y===!0&&(t.style.width=T+"px",t.style.height=B+"px"),this.setViewport(0,0,T,B)},this.getDrawingBufferSize=function(T){return T.set(ae*J,q*J).floor()},this.setDrawingBufferSize=function(T,B,Y){ae=T,q=B,J=Y,t.width=Math.floor(T*Y),t.height=Math.floor(B*Y),this.setViewport(0,0,T,B)},this.getCurrentViewport=function(T){return T.copy(x)},this.getViewport=function(T){return T.copy(_e)},this.setViewport=function(T,B,Y,K){T.isVector4?_e.set(T.x,T.y,T.z,T.w):_e.set(T,B,Y,K),W.viewport(x.copy(_e).multiplyScalar(J).round())},this.getScissor=function(T){return T.copy(Me)},this.setScissor=function(T,B,Y,K){T.isVector4?Me.set(T.x,T.y,T.z,T.w):Me.set(T,B,Y,K),W.scissor(A.copy(Me).multiplyScalar(J).round())},this.getScissorTest=function(){return De},this.setScissorTest=function(T){W.setScissorTest(De=T)},this.setOpaqueSort=function(T){H=T},this.setTransparentSort=function(T){me=T},this.getClearColor=function(T){return T.copy(Ue.getClearColor())},this.setClearColor=function(){Ue.setClearColor.apply(Ue,arguments)},this.getClearAlpha=function(){return Ue.getClearAlpha()},this.setClearAlpha=function(){Ue.setClearAlpha.apply(Ue,arguments)},this.clear=function(T=!0,B=!0,Y=!0){let K=0;if(T){let z=!1;if(R!==null){const ge=R.texture.format;z=ge===dc||ge===fc||ge===uc}if(z){const ge=R.texture.type,be=ge===qn||ge===Xi||ge===hs||ge===Ir||ge===lc||ge===cc,Ce=Ue.getClearColor(),Ie=Ue.getClearAlpha(),Be=Ce.r,ze=Ce.g,Fe=Ce.b;be?(h[0]=Be,h[1]=ze,h[2]=Fe,h[3]=Ie,g.clearBufferuiv(g.COLOR,0,h)):(S[0]=Be,S[1]=ze,S[2]=Fe,S[3]=Ie,g.clearBufferiv(g.COLOR,0,S))}else K|=g.COLOR_BUFFER_BIT}B&&(K|=g.DEPTH_BUFFER_BIT,g.clearDepth(this.capabilities.reverseDepthBuffer?0:1)),Y&&(K|=g.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),g.clear(K)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",ce,!1),t.removeEventListener("webglcontextrestored",Ee,!1),t.removeEventListener("webglcontextcreationerror",Te,!1),pe.dispose(),Re.dispose(),re.dispose(),v.dispose(),I.dispose(),V.dispose(),qe.dispose(),N.dispose(),ue.dispose(),te.dispose(),te.removeEventListener("sessionstart",Sc),te.removeEventListener("sessionend",Mc),Ei.stop()};function ce(T){T.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),y=!0}function Ee(){console.log("THREE.WebGLRenderer: Context Restored."),y=!1;const T=ie.autoReset,B=ve.enabled,Y=ve.autoUpdate,K=ve.needsUpdate,z=ve.type;Ae(),ie.autoReset=T,ve.enabled=B,ve.autoUpdate=Y,ve.needsUpdate=K,ve.type=z}function Te(T){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",T.statusMessage)}function Ke(T){const B=T.target;B.removeEventListener("dispose",Ke),Mt(B)}function Mt(T){Gt(T),re.remove(T)}function Gt(T){const B=re.get(T).programs;B!==void 0&&(B.forEach(function(Y){ue.releaseProgram(Y)}),T.isShaderMaterial&&ue.releaseShaderCache(T))}this.renderBufferDirect=function(T,B,Y,K,z,ge){B===null&&(B=he);const be=z.isMesh&&z.matrixWorld.determinant()<0,Ce=$h(T,B,Y,K,z);W.setMaterial(K,be);let Ie=Y.index,Be=1;if(K.wireframe===!0){if(Ie=G.getWireframeAttribute(Y),Ie===void 0)return;Be=2}const ze=Y.drawRange,Fe=Y.attributes.position;let at=ze.start*Be,ht=(ze.start+ze.count)*Be;ge!==null&&(at=Math.max(at,ge.start*Be),ht=Math.min(ht,(ge.start+ge.count)*Be)),Ie!==null?(at=Math.max(at,0),ht=Math.min(ht,Ie.count)):Fe!=null&&(at=Math.max(at,0),ht=Math.min(ht,Fe.count));const _t=ht-at;if(_t<0||_t===1/0)return;qe.setup(z,K,Ce,Y,Ie);let qt,nt=ye;if(Ie!==null&&(qt=j.get(Ie),nt=$e,nt.setIndex(qt)),z.isMesh)K.wireframe===!0?(W.setLineWidth(K.wireframeLinewidth*Pe()),nt.setMode(g.LINES)):nt.setMode(g.TRIANGLES);else if(z.isLine){let Oe=K.linewidth;Oe===void 0&&(Oe=1),W.setLineWidth(Oe*Pe()),z.isLineSegments?nt.setMode(g.LINES):z.isLineLoop?nt.setMode(g.LINE_LOOP):nt.setMode(g.LINE_STRIP)}else z.isPoints?nt.setMode(g.POINTS):z.isSprite&&nt.setMode(g.TRIANGLES);if(z.isBatchedMesh)if(z._multiDrawInstances!==null)nt.renderMultiDrawInstances(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount,z._multiDrawInstances);else if(O.get("WEBGL_multi_draw"))nt.renderMultiDraw(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount);else{const Oe=z._multiDrawStarts,wt=z._multiDrawCounts,it=z._multiDrawCount,fn=Ie?j.get(Ie).bytesPerElement:1,qi=re.get(K).currentProgram.getUniforms();for(let Yt=0;Yt<it;Yt++)qi.setValue(g,"_gl_DrawID",Yt),nt.render(Oe[Yt]/fn,wt[Yt])}else if(z.isInstancedMesh)nt.renderInstances(at,_t,z.count);else if(Y.isInstancedBufferGeometry){const Oe=Y._maxInstanceCount!==void 0?Y._maxInstanceCount:1/0,wt=Math.min(Y.instanceCount,Oe);nt.renderInstances(at,_t,wt)}else nt.render(at,_t)};function Qe(T,B,Y){T.transparent===!0&&T.side===Gn&&T.forceSinglePass===!1?(T.side=Xt,T.needsUpdate=!0,As(T,B,Y),T.side=_i,T.needsUpdate=!0,As(T,B,Y),T.side=Gn):As(T,B,Y)}this.compile=function(T,B,Y=null){Y===null&&(Y=T),m=Re.get(Y),m.init(B),M.push(m),Y.traverseVisible(function(z){z.isLight&&z.layers.test(B.layers)&&(m.pushLight(z),z.castShadow&&m.pushShadow(z))}),T!==Y&&T.traverseVisible(function(z){z.isLight&&z.layers.test(B.layers)&&(m.pushLight(z),z.castShadow&&m.pushShadow(z))}),m.setupLights();const K=new Set;return T.traverse(function(z){if(!(z.isMesh||z.isPoints||z.isLine||z.isSprite))return;const ge=z.material;if(ge)if(Array.isArray(ge))for(let be=0;be<ge.length;be++){const Ce=ge[be];Qe(Ce,Y,z),K.add(Ce)}else Qe(ge,Y,z),K.add(ge)}),M.pop(),m=null,K},this.compileAsync=function(T,B,Y=null){const K=this.compile(T,B,Y);return new Promise(z=>{function ge(){if(K.forEach(function(be){re.get(be).currentProgram.isReady()&&K.delete(be)}),K.size===0){z(T);return}setTimeout(ge,10)}O.get("KHR_parallel_shader_compile")!==null?ge():setTimeout(ge,10)})};let Wt=null;function Ln(T){Wt&&Wt(T)}function Sc(){Ei.stop()}function Mc(){Ei.start()}const Ei=new Oh;Ei.setAnimationLoop(Ln),typeof self<"u"&&Ei.setContext(self),this.setAnimationLoop=function(T){Wt=T,te.setAnimationLoop(T),T===null?Ei.stop():Ei.start()},te.addEventListener("sessionstart",Sc),te.addEventListener("sessionend",Mc),this.render=function(T,B){if(B!==void 0&&B.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(y===!0)return;if(T.matrixWorldAutoUpdate===!0&&T.updateMatrixWorld(),B.parent===null&&B.matrixWorldAutoUpdate===!0&&B.updateMatrixWorld(),te.enabled===!0&&te.isPresenting===!0&&(te.cameraAutoUpdate===!0&&te.updateCamera(B),B=te.getCamera()),T.isScene===!0&&T.onBeforeRender(_,T,B,R),m=Re.get(T,M.length),m.init(B),M.push(m),F.multiplyMatrices(B.projectionMatrix,B.matrixWorldInverse),je.setFromProjectionMatrix(F),de=this.localClippingEnabled,ee=fe.init(this.clippingPlanes,de),E=pe.get(T,p.length),E.init(),p.push(E),te.enabled===!0&&te.isPresenting===!0){const ge=_.xr.getDepthSensingMesh();ge!==null&&Ho(ge,B,-1/0,_.sortObjects)}Ho(T,B,0,_.sortObjects),E.finish(),_.sortObjects===!0&&E.sort(H,me),we=te.enabled===!1||te.isPresenting===!1||te.hasDepthSensing()===!1,we&&Ue.addToRenderList(E,T),this.info.render.frame++,ee===!0&&fe.beginShadows();const Y=m.state.shadowsArray;ve.render(Y,T,B),ee===!0&&fe.endShadows(),this.info.autoReset===!0&&this.info.reset();const K=E.opaque,z=E.transmissive;if(m.setupLights(),B.isArrayCamera){const ge=B.cameras;if(z.length>0)for(let be=0,Ce=ge.length;be<Ce;be++){const Ie=ge[be];Ec(K,z,T,Ie)}we&&Ue.render(T);for(let be=0,Ce=ge.length;be<Ce;be++){const Ie=ge[be];yc(E,T,Ie,Ie.viewport)}}else z.length>0&&Ec(K,z,T,B),we&&Ue.render(T),yc(E,T,B);R!==null&&(b.updateMultisampleRenderTarget(R),b.updateRenderTargetMipmap(R)),T.isScene===!0&&T.onAfterRender(_,T,B),qe.resetDefaultState(),D=-1,k=null,M.pop(),M.length>0?(m=M[M.length-1],ee===!0&&fe.setGlobalState(_.clippingPlanes,m.state.camera)):m=null,p.pop(),p.length>0?E=p[p.length-1]:E=null};function Ho(T,B,Y,K){if(T.visible===!1)return;if(T.layers.test(B.layers)){if(T.isGroup)Y=T.renderOrder;else if(T.isLOD)T.autoUpdate===!0&&T.update(B);else if(T.isLight)m.pushLight(T),T.castShadow&&m.pushShadow(T);else if(T.isSprite){if(!T.frustumCulled||je.intersectsSprite(T)){K&&ne.setFromMatrixPosition(T.matrixWorld).applyMatrix4(F);const be=V.update(T),Ce=T.material;Ce.visible&&E.push(T,be,Ce,Y,ne.z,null)}}else if((T.isMesh||T.isLine||T.isPoints)&&(!T.frustumCulled||je.intersectsObject(T))){const be=V.update(T),Ce=T.material;if(K&&(T.boundingSphere!==void 0?(T.boundingSphere===null&&T.computeBoundingSphere(),ne.copy(T.boundingSphere.center)):(be.boundingSphere===null&&be.computeBoundingSphere(),ne.copy(be.boundingSphere.center)),ne.applyMatrix4(T.matrixWorld).applyMatrix4(F)),Array.isArray(Ce)){const Ie=be.groups;for(let Be=0,ze=Ie.length;Be<ze;Be++){const Fe=Ie[Be],at=Ce[Fe.materialIndex];at&&at.visible&&E.push(T,be,at,Y,ne.z,Fe)}}else Ce.visible&&E.push(T,be,Ce,Y,ne.z,null)}}const ge=T.children;for(let be=0,Ce=ge.length;be<Ce;be++)Ho(ge[be],B,Y,K)}function yc(T,B,Y,K){const z=T.opaque,ge=T.transmissive,be=T.transparent;m.setupLightsView(Y),ee===!0&&fe.setGlobalState(_.clippingPlanes,Y),K&&W.viewport(x.copy(K)),z.length>0&&bs(z,B,Y),ge.length>0&&bs(ge,B,Y),be.length>0&&bs(be,B,Y),W.buffers.depth.setTest(!0),W.buffers.depth.setMask(!0),W.buffers.color.setMask(!0),W.setPolygonOffset(!1)}function Ec(T,B,Y,K){if((Y.isScene===!0?Y.overrideMaterial:null)!==null)return;m.state.transmissionRenderTarget[K.id]===void 0&&(m.state.transmissionRenderTarget[K.id]=new ji(1,1,{generateMipmaps:!0,type:O.has("EXT_color_buffer_half_float")||O.has("EXT_color_buffer_float")?xs:qn,minFilter:zi,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:st.workingColorSpace}));const ge=m.state.transmissionRenderTarget[K.id],be=K.viewport||x;ge.setSize(be.z,be.w);const Ce=_.getRenderTarget();_.setRenderTarget(ge),_.getClearColor(X),Q=_.getClearAlpha(),Q<1&&_.setClearColor(16777215,.5),_.clear(),we&&Ue.render(Y);const Ie=_.toneMapping;_.toneMapping=mi;const Be=K.viewport;if(K.viewport!==void 0&&(K.viewport=void 0),m.setupLightsView(K),ee===!0&&fe.setGlobalState(_.clippingPlanes,K),bs(T,Y,K),b.updateMultisampleRenderTarget(ge),b.updateRenderTargetMipmap(ge),O.has("WEBGL_multisampled_render_to_texture")===!1){let ze=!1;for(let Fe=0,at=B.length;Fe<at;Fe++){const ht=B[Fe],_t=ht.object,qt=ht.geometry,nt=ht.material,Oe=ht.group;if(nt.side===Gn&&_t.layers.test(K.layers)){const wt=nt.side;nt.side=Xt,nt.needsUpdate=!0,bc(_t,Y,K,qt,nt,Oe),nt.side=wt,nt.needsUpdate=!0,ze=!0}}ze===!0&&(b.updateMultisampleRenderTarget(ge),b.updateRenderTargetMipmap(ge))}_.setRenderTarget(Ce),_.setClearColor(X,Q),Be!==void 0&&(K.viewport=Be),_.toneMapping=Ie}function bs(T,B,Y){const K=B.isScene===!0?B.overrideMaterial:null;for(let z=0,ge=T.length;z<ge;z++){const be=T[z],Ce=be.object,Ie=be.geometry,Be=K===null?be.material:K,ze=be.group;Ce.layers.test(Y.layers)&&bc(Ce,B,Y,Ie,Be,ze)}}function bc(T,B,Y,K,z,ge){T.onBeforeRender(_,B,Y,K,z,ge),T.modelViewMatrix.multiplyMatrices(Y.matrixWorldInverse,T.matrixWorld),T.normalMatrix.getNormalMatrix(T.modelViewMatrix),z.onBeforeRender(_,B,Y,K,T,ge),z.transparent===!0&&z.side===Gn&&z.forceSinglePass===!1?(z.side=Xt,z.needsUpdate=!0,_.renderBufferDirect(Y,B,K,z,T,ge),z.side=_i,z.needsUpdate=!0,_.renderBufferDirect(Y,B,K,z,T,ge),z.side=Gn):_.renderBufferDirect(Y,B,K,z,T,ge),T.onAfterRender(_,B,Y,K,z,ge)}function As(T,B,Y){B.isScene!==!0&&(B=he);const K=re.get(T),z=m.state.lights,ge=m.state.shadowsArray,be=z.state.version,Ce=ue.getParameters(T,z.state,ge,B,Y),Ie=ue.getProgramCacheKey(Ce);let Be=K.programs;K.environment=T.isMeshStandardMaterial?B.environment:null,K.fog=B.fog,K.envMap=(T.isMeshStandardMaterial?I:v).get(T.envMap||K.environment),K.envMapRotation=K.environment!==null&&T.envMap===null?B.environmentRotation:T.envMapRotation,Be===void 0&&(T.addEventListener("dispose",Ke),Be=new Map,K.programs=Be);let ze=Be.get(Ie);if(ze!==void 0){if(K.currentProgram===ze&&K.lightsStateVersion===be)return Tc(T,Ce),ze}else Ce.uniforms=ue.getUniforms(T),T.onBeforeCompile(Ce,_),ze=ue.acquireProgram(Ce,Ie),Be.set(Ie,ze),K.uniforms=Ce.uniforms;const Fe=K.uniforms;return(!T.isShaderMaterial&&!T.isRawShaderMaterial||T.clipping===!0)&&(Fe.clippingPlanes=fe.uniform),Tc(T,Ce),K.needsLights=Yh(T),K.lightsStateVersion=be,K.needsLights&&(Fe.ambientLightColor.value=z.state.ambient,Fe.lightProbe.value=z.state.probe,Fe.directionalLights.value=z.state.directional,Fe.directionalLightShadows.value=z.state.directionalShadow,Fe.spotLights.value=z.state.spot,Fe.spotLightShadows.value=z.state.spotShadow,Fe.rectAreaLights.value=z.state.rectArea,Fe.ltc_1.value=z.state.rectAreaLTC1,Fe.ltc_2.value=z.state.rectAreaLTC2,Fe.pointLights.value=z.state.point,Fe.pointLightShadows.value=z.state.pointShadow,Fe.hemisphereLights.value=z.state.hemi,Fe.directionalShadowMap.value=z.state.directionalShadowMap,Fe.directionalShadowMatrix.value=z.state.directionalShadowMatrix,Fe.spotShadowMap.value=z.state.spotShadowMap,Fe.spotLightMatrix.value=z.state.spotLightMatrix,Fe.spotLightMap.value=z.state.spotLightMap,Fe.pointShadowMap.value=z.state.pointShadowMap,Fe.pointShadowMatrix.value=z.state.pointShadowMatrix),K.currentProgram=ze,K.uniformsList=null,ze}function Ac(T){if(T.uniformsList===null){const B=T.currentProgram.getUniforms();T.uniformsList=co.seqWithValue(B.seq,T.uniforms)}return T.uniformsList}function Tc(T,B){const Y=re.get(T);Y.outputColorSpace=B.outputColorSpace,Y.batching=B.batching,Y.batchingColor=B.batchingColor,Y.instancing=B.instancing,Y.instancingColor=B.instancingColor,Y.instancingMorph=B.instancingMorph,Y.skinning=B.skinning,Y.morphTargets=B.morphTargets,Y.morphNormals=B.morphNormals,Y.morphColors=B.morphColors,Y.morphTargetsCount=B.morphTargetsCount,Y.numClippingPlanes=B.numClippingPlanes,Y.numIntersection=B.numClipIntersection,Y.vertexAlphas=B.vertexAlphas,Y.vertexTangents=B.vertexTangents,Y.toneMapping=B.toneMapping}function $h(T,B,Y,K,z){B.isScene!==!0&&(B=he),b.resetTextureUnits();const ge=B.fog,be=K.isMeshStandardMaterial?B.environment:null,Ce=R===null?_.outputColorSpace:R.isXRRenderTarget===!0?R.texture.colorSpace:Mi,Ie=(K.isMeshStandardMaterial?I:v).get(K.envMap||be),Be=K.vertexColors===!0&&!!Y.attributes.color&&Y.attributes.color.itemSize===4,ze=!!Y.attributes.tangent&&(!!K.normalMap||K.anisotropy>0),Fe=!!Y.morphAttributes.position,at=!!Y.morphAttributes.normal,ht=!!Y.morphAttributes.color;let _t=mi;K.toneMapped&&(R===null||R.isXRRenderTarget===!0)&&(_t=_.toneMapping);const qt=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,nt=qt!==void 0?qt.length:0,Oe=re.get(K),wt=m.state.lights;if(ee===!0&&(de===!0||T!==k)){const nn=T===k&&K.id===D;fe.setState(K,T,nn)}let it=!1;K.version===Oe.__version?(Oe.needsLights&&Oe.lightsStateVersion!==wt.state.version||Oe.outputColorSpace!==Ce||z.isBatchedMesh&&Oe.batching===!1||!z.isBatchedMesh&&Oe.batching===!0||z.isBatchedMesh&&Oe.batchingColor===!0&&z.colorTexture===null||z.isBatchedMesh&&Oe.batchingColor===!1&&z.colorTexture!==null||z.isInstancedMesh&&Oe.instancing===!1||!z.isInstancedMesh&&Oe.instancing===!0||z.isSkinnedMesh&&Oe.skinning===!1||!z.isSkinnedMesh&&Oe.skinning===!0||z.isInstancedMesh&&Oe.instancingColor===!0&&z.instanceColor===null||z.isInstancedMesh&&Oe.instancingColor===!1&&z.instanceColor!==null||z.isInstancedMesh&&Oe.instancingMorph===!0&&z.morphTexture===null||z.isInstancedMesh&&Oe.instancingMorph===!1&&z.morphTexture!==null||Oe.envMap!==Ie||K.fog===!0&&Oe.fog!==ge||Oe.numClippingPlanes!==void 0&&(Oe.numClippingPlanes!==fe.numPlanes||Oe.numIntersection!==fe.numIntersection)||Oe.vertexAlphas!==Be||Oe.vertexTangents!==ze||Oe.morphTargets!==Fe||Oe.morphNormals!==at||Oe.morphColors!==ht||Oe.toneMapping!==_t||Oe.morphTargetsCount!==nt)&&(it=!0):(it=!0,Oe.__version=K.version);let fn=Oe.currentProgram;it===!0&&(fn=As(K,B,z));let qi=!1,Yt=!1,Vo=!1;const xt=fn.getUniforms(),Zn=Oe.uniforms;if(W.useProgram(fn.program)&&(qi=!0,Yt=!0,Vo=!0),K.id!==D&&(D=K.id,Yt=!0),qi||k!==T){Z.reverseDepthBuffer?(xe.copy(T.projectionMatrix),L0(xe),I0(xe),xt.setValue(g,"projectionMatrix",xe)):xt.setValue(g,"projectionMatrix",T.projectionMatrix),xt.setValue(g,"viewMatrix",T.matrixWorldInverse);const nn=xt.map.cameraPosition;nn!==void 0&&nn.setValue(g,oe.setFromMatrixPosition(T.matrixWorld)),Z.logarithmicDepthBuffer&&xt.setValue(g,"logDepthBufFC",2/(Math.log(T.far+1)/Math.LN2)),(K.isMeshPhongMaterial||K.isMeshToonMaterial||K.isMeshLambertMaterial||K.isMeshBasicMaterial||K.isMeshStandardMaterial||K.isShaderMaterial)&&xt.setValue(g,"isOrthographic",T.isOrthographicCamera===!0),k!==T&&(k=T,Yt=!0,Vo=!0)}if(z.isSkinnedMesh){xt.setOptional(g,z,"bindMatrix"),xt.setOptional(g,z,"bindMatrixInverse");const nn=z.skeleton;nn&&(nn.boneTexture===null&&nn.computeBoneTexture(),xt.setValue(g,"boneTexture",nn.boneTexture,b))}z.isBatchedMesh&&(xt.setOptional(g,z,"batchingTexture"),xt.setValue(g,"batchingTexture",z._matricesTexture,b),xt.setOptional(g,z,"batchingIdTexture"),xt.setValue(g,"batchingIdTexture",z._indirectTexture,b),xt.setOptional(g,z,"batchingColorTexture"),z._colorsTexture!==null&&xt.setValue(g,"batchingColorTexture",z._colorsTexture,b));const Go=Y.morphAttributes;if((Go.position!==void 0||Go.normal!==void 0||Go.color!==void 0)&&Le.update(z,Y,fn),(Yt||Oe.receiveShadow!==z.receiveShadow)&&(Oe.receiveShadow=z.receiveShadow,xt.setValue(g,"receiveShadow",z.receiveShadow)),K.isMeshGouraudMaterial&&K.envMap!==null&&(Zn.envMap.value=Ie,Zn.flipEnvMap.value=Ie.isCubeTexture&&Ie.isRenderTargetTexture===!1?-1:1),K.isMeshStandardMaterial&&K.envMap===null&&B.environment!==null&&(Zn.envMapIntensity.value=B.environmentIntensity),Yt&&(xt.setValue(g,"toneMappingExposure",_.toneMappingExposure),Oe.needsLights&&qh(Zn,Vo),ge&&K.fog===!0&&le.refreshFogUniforms(Zn,ge),le.refreshMaterialUniforms(Zn,K,J,q,m.state.transmissionRenderTarget[T.id]),co.upload(g,Ac(Oe),Zn,b)),K.isShaderMaterial&&K.uniformsNeedUpdate===!0&&(co.upload(g,Ac(Oe),Zn,b),K.uniformsNeedUpdate=!1),K.isSpriteMaterial&&xt.setValue(g,"center",z.center),xt.setValue(g,"modelViewMatrix",z.modelViewMatrix),xt.setValue(g,"normalMatrix",z.normalMatrix),xt.setValue(g,"modelMatrix",z.matrixWorld),K.isShaderMaterial||K.isRawShaderMaterial){const nn=K.uniformsGroups;for(let Wo=0,Kh=nn.length;Wo<Kh;Wo++){const wc=nn[Wo];N.update(wc,fn),N.bind(wc,fn)}}return fn}function qh(T,B){T.ambientLightColor.needsUpdate=B,T.lightProbe.needsUpdate=B,T.directionalLights.needsUpdate=B,T.directionalLightShadows.needsUpdate=B,T.pointLights.needsUpdate=B,T.pointLightShadows.needsUpdate=B,T.spotLights.needsUpdate=B,T.spotLightShadows.needsUpdate=B,T.rectAreaLights.needsUpdate=B,T.hemisphereLights.needsUpdate=B}function Yh(T){return T.isMeshLambertMaterial||T.isMeshToonMaterial||T.isMeshPhongMaterial||T.isMeshStandardMaterial||T.isShadowMaterial||T.isShaderMaterial&&T.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return C},this.getRenderTarget=function(){return R},this.setRenderTargetTextures=function(T,B,Y){re.get(T.texture).__webglTexture=B,re.get(T.depthTexture).__webglTexture=Y;const K=re.get(T);K.__hasExternalTextures=!0,K.__autoAllocateDepthBuffer=Y===void 0,K.__autoAllocateDepthBuffer||O.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),K.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(T,B){const Y=re.get(T);Y.__webglFramebuffer=B,Y.__useDefaultFramebuffer=B===void 0},this.setRenderTarget=function(T,B=0,Y=0){R=T,P=B,C=Y;let K=!0,z=null,ge=!1,be=!1;if(T){const Ie=re.get(T);if(Ie.__useDefaultFramebuffer!==void 0)W.bindFramebuffer(g.FRAMEBUFFER,null),K=!1;else if(Ie.__webglFramebuffer===void 0)b.setupRenderTarget(T);else if(Ie.__hasExternalTextures)b.rebindTextures(T,re.get(T.texture).__webglTexture,re.get(T.depthTexture).__webglTexture);else if(T.depthBuffer){const Fe=T.depthTexture;if(Ie.__boundDepthTexture!==Fe){if(Fe!==null&&re.has(Fe)&&(T.width!==Fe.image.width||T.height!==Fe.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");b.setupDepthRenderbuffer(T)}}const Be=T.texture;(Be.isData3DTexture||Be.isDataArrayTexture||Be.isCompressedArrayTexture)&&(be=!0);const ze=re.get(T).__webglFramebuffer;T.isWebGLCubeRenderTarget?(Array.isArray(ze[B])?z=ze[B][Y]:z=ze[B],ge=!0):T.samples>0&&b.useMultisampledRTT(T)===!1?z=re.get(T).__webglMultisampledFramebuffer:Array.isArray(ze)?z=ze[Y]:z=ze,x.copy(T.viewport),A.copy(T.scissor),U=T.scissorTest}else x.copy(_e).multiplyScalar(J).floor(),A.copy(Me).multiplyScalar(J).floor(),U=De;if(W.bindFramebuffer(g.FRAMEBUFFER,z)&&K&&W.drawBuffers(T,z),W.viewport(x),W.scissor(A),W.setScissorTest(U),ge){const Ie=re.get(T.texture);g.framebufferTexture2D(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,g.TEXTURE_CUBE_MAP_POSITIVE_X+B,Ie.__webglTexture,Y)}else if(be){const Ie=re.get(T.texture),Be=B||0;g.framebufferTextureLayer(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,Ie.__webglTexture,Y||0,Be)}D=-1},this.readRenderTargetPixels=function(T,B,Y,K,z,ge,be){if(!(T&&T.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ce=re.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&be!==void 0&&(Ce=Ce[be]),Ce){W.bindFramebuffer(g.FRAMEBUFFER,Ce);try{const Ie=T.texture,Be=Ie.format,ze=Ie.type;if(!Z.textureFormatReadable(Be)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Z.textureTypeReadable(ze)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}B>=0&&B<=T.width-K&&Y>=0&&Y<=T.height-z&&g.readPixels(B,Y,K,z,Ne.convert(Be),Ne.convert(ze),ge)}finally{const Ie=R!==null?re.get(R).__webglFramebuffer:null;W.bindFramebuffer(g.FRAMEBUFFER,Ie)}}},this.readRenderTargetPixelsAsync=async function(T,B,Y,K,z,ge,be){if(!(T&&T.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ce=re.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&be!==void 0&&(Ce=Ce[be]),Ce){const Ie=T.texture,Be=Ie.format,ze=Ie.type;if(!Z.textureFormatReadable(Be))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Z.textureTypeReadable(ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(B>=0&&B<=T.width-K&&Y>=0&&Y<=T.height-z){W.bindFramebuffer(g.FRAMEBUFFER,Ce);const Fe=g.createBuffer();g.bindBuffer(g.PIXEL_PACK_BUFFER,Fe),g.bufferData(g.PIXEL_PACK_BUFFER,ge.byteLength,g.STREAM_READ),g.readPixels(B,Y,K,z,Ne.convert(Be),Ne.convert(ze),0);const at=R!==null?re.get(R).__webglFramebuffer:null;W.bindFramebuffer(g.FRAMEBUFFER,at);const ht=g.fenceSync(g.SYNC_GPU_COMMANDS_COMPLETE,0);return g.flush(),await P0(g,ht,4),g.bindBuffer(g.PIXEL_PACK_BUFFER,Fe),g.getBufferSubData(g.PIXEL_PACK_BUFFER,0,ge),g.deleteBuffer(Fe),g.deleteSync(ht),ge}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(T,B=null,Y=0){T.isTexture!==!0&&(lo("WebGLRenderer: copyFramebufferToTexture function signature has changed."),B=arguments[0]||null,T=arguments[1]);const K=Math.pow(2,-Y),z=Math.floor(T.image.width*K),ge=Math.floor(T.image.height*K),be=B!==null?B.x:0,Ce=B!==null?B.y:0;b.setTexture2D(T,0),g.copyTexSubImage2D(g.TEXTURE_2D,Y,0,0,be,Ce,z,ge),W.unbindTexture()},this.copyTextureToTexture=function(T,B,Y=null,K=null,z=0){T.isTexture!==!0&&(lo("WebGLRenderer: copyTextureToTexture function signature has changed."),K=arguments[0]||null,T=arguments[1],B=arguments[2],z=arguments[3]||0,Y=null);let ge,be,Ce,Ie,Be,ze;Y!==null?(ge=Y.max.x-Y.min.x,be=Y.max.y-Y.min.y,Ce=Y.min.x,Ie=Y.min.y):(ge=T.image.width,be=T.image.height,Ce=0,Ie=0),K!==null?(Be=K.x,ze=K.y):(Be=0,ze=0);const Fe=Ne.convert(B.format),at=Ne.convert(B.type);b.setTexture2D(B,0),g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL,B.flipY),g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,B.premultiplyAlpha),g.pixelStorei(g.UNPACK_ALIGNMENT,B.unpackAlignment);const ht=g.getParameter(g.UNPACK_ROW_LENGTH),_t=g.getParameter(g.UNPACK_IMAGE_HEIGHT),qt=g.getParameter(g.UNPACK_SKIP_PIXELS),nt=g.getParameter(g.UNPACK_SKIP_ROWS),Oe=g.getParameter(g.UNPACK_SKIP_IMAGES),wt=T.isCompressedTexture?T.mipmaps[z]:T.image;g.pixelStorei(g.UNPACK_ROW_LENGTH,wt.width),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,wt.height),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Ce),g.pixelStorei(g.UNPACK_SKIP_ROWS,Ie),T.isDataTexture?g.texSubImage2D(g.TEXTURE_2D,z,Be,ze,ge,be,Fe,at,wt.data):T.isCompressedTexture?g.compressedTexSubImage2D(g.TEXTURE_2D,z,Be,ze,wt.width,wt.height,Fe,wt.data):g.texSubImage2D(g.TEXTURE_2D,z,Be,ze,ge,be,Fe,at,wt),g.pixelStorei(g.UNPACK_ROW_LENGTH,ht),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,_t),g.pixelStorei(g.UNPACK_SKIP_PIXELS,qt),g.pixelStorei(g.UNPACK_SKIP_ROWS,nt),g.pixelStorei(g.UNPACK_SKIP_IMAGES,Oe),z===0&&B.generateMipmaps&&g.generateMipmap(g.TEXTURE_2D),W.unbindTexture()},this.copyTextureToTexture3D=function(T,B,Y=null,K=null,z=0){T.isTexture!==!0&&(lo("WebGLRenderer: copyTextureToTexture3D function signature has changed."),Y=arguments[0]||null,K=arguments[1]||null,T=arguments[2],B=arguments[3],z=arguments[4]||0);let ge,be,Ce,Ie,Be,ze,Fe,at,ht;const _t=T.isCompressedTexture?T.mipmaps[z]:T.image;Y!==null?(ge=Y.max.x-Y.min.x,be=Y.max.y-Y.min.y,Ce=Y.max.z-Y.min.z,Ie=Y.min.x,Be=Y.min.y,ze=Y.min.z):(ge=_t.width,be=_t.height,Ce=_t.depth,Ie=0,Be=0,ze=0),K!==null?(Fe=K.x,at=K.y,ht=K.z):(Fe=0,at=0,ht=0);const qt=Ne.convert(B.format),nt=Ne.convert(B.type);let Oe;if(B.isData3DTexture)b.setTexture3D(B,0),Oe=g.TEXTURE_3D;else if(B.isDataArrayTexture||B.isCompressedArrayTexture)b.setTexture2DArray(B,0),Oe=g.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL,B.flipY),g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,B.premultiplyAlpha),g.pixelStorei(g.UNPACK_ALIGNMENT,B.unpackAlignment);const wt=g.getParameter(g.UNPACK_ROW_LENGTH),it=g.getParameter(g.UNPACK_IMAGE_HEIGHT),fn=g.getParameter(g.UNPACK_SKIP_PIXELS),qi=g.getParameter(g.UNPACK_SKIP_ROWS),Yt=g.getParameter(g.UNPACK_SKIP_IMAGES);g.pixelStorei(g.UNPACK_ROW_LENGTH,_t.width),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,_t.height),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Ie),g.pixelStorei(g.UNPACK_SKIP_ROWS,Be),g.pixelStorei(g.UNPACK_SKIP_IMAGES,ze),T.isDataTexture||T.isData3DTexture?g.texSubImage3D(Oe,z,Fe,at,ht,ge,be,Ce,qt,nt,_t.data):B.isCompressedArrayTexture?g.compressedTexSubImage3D(Oe,z,Fe,at,ht,ge,be,Ce,qt,_t.data):g.texSubImage3D(Oe,z,Fe,at,ht,ge,be,Ce,qt,nt,_t),g.pixelStorei(g.UNPACK_ROW_LENGTH,wt),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,it),g.pixelStorei(g.UNPACK_SKIP_PIXELS,fn),g.pixelStorei(g.UNPACK_SKIP_ROWS,qi),g.pixelStorei(g.UNPACK_SKIP_IMAGES,Yt),z===0&&B.generateMipmaps&&g.generateMipmap(Oe),W.unbindTexture()},this.initRenderTarget=function(T){re.get(T).__webglFramebuffer===void 0&&b.setupRenderTarget(T)},this.initTexture=function(T){T.isCubeTexture?b.setTextureCube(T,0):T.isData3DTexture?b.setTexture3D(T,0):T.isDataArrayTexture||T.isCompressedArrayTexture?b.setTexture2DArray(T,0):b.setTexture2D(T,0),W.unbindTexture()},this.resetState=function(){P=0,C=0,R=null,W.reset(),qe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Xn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===hc?"display-p3":"srgb",t.unpackColorSpace=st.workingColorSpace===Bo?"display-p3":"srgb"}}class Xy extends $t{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Pn,this.environmentIntensity=1,this.environmentRotation=new Pn,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(t.object.environmentIntensity=this.environmentIntensity),t.object.environmentRotation=this.environmentRotation.toArray(),t}}class vc extends yi{constructor(e=1,t=32,i=16,r=0,s=Math.PI*2,o=0,a=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:t,heightSegments:i,phiStart:r,phiLength:s,thetaStart:o,thetaLength:a},t=Math.max(3,Math.floor(t)),i=Math.max(2,Math.floor(i));const l=Math.min(o+a,Math.PI);let c=0;const u=[],f=new $,d=new $,h=[],S=[],E=[],m=[];for(let p=0;p<=i;p++){const M=[],_=p/i;let y=0;p===0&&o===0?y=.5/t:p===i&&l===Math.PI&&(y=-.5/t);for(let P=0;P<=t;P++){const C=P/t;f.x=-e*Math.cos(r+C*s)*Math.sin(o+_*a),f.y=e*Math.cos(o+_*a),f.z=e*Math.sin(r+C*s)*Math.sin(o+_*a),S.push(f.x,f.y,f.z),d.copy(f).normalize(),E.push(d.x,d.y,d.z),m.push(C+y,1-_),M.push(c++)}u.push(M)}for(let p=0;p<i;p++)for(let M=0;M<t;M++){const _=u[p][M+1],y=u[p][M],P=u[p+1][M],C=u[p+1][M+1];(p!==0||o>0)&&h.push(_,y,C),(p!==i-1||l<Math.PI)&&h.push(y,P,C)}this.setIndex(h),this.setAttribute("position",new Cn(S,3)),this.setAttribute("normal",new Cn(E,3)),this.setAttribute("uv",new Cn(m,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new vc(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class jy extends ys{constructor(e){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new et(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new et(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=bh,this.normalScale=new Je(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new Pn,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={STANDARD:""},this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapRotation.copy(e.envMapRotation),this.envMapIntensity=e.envMapIntensity,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class Gh extends $t{constructor(e,t=1){super(),this.isLight=!0,this.type="Light",this.color=new et(e),this.intensity=t}dispose(){}copy(e,t){return super.copy(e,t),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const t=super.toJSON(e);return t.object.color=this.color.getHex(),t.object.intensity=this.intensity,this.groundColor!==void 0&&(t.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(t.object.distance=this.distance),this.angle!==void 0&&(t.object.angle=this.angle),this.decay!==void 0&&(t.object.decay=this.decay),this.penumbra!==void 0&&(t.object.penumbra=this.penumbra),this.shadow!==void 0&&(t.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(t.object.target=this.target.uuid),t}}const Fa=new gt,yf=new $,Ef=new $;class $y{constructor(e){this.camera=e,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Je(512,512),this.map=null,this.mapPass=null,this.matrix=new gt,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new gc,this._frameExtents=new Je(1,1),this._viewportCount=1,this._viewports=[new ct(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const t=this.camera,i=this.matrix;yf.setFromMatrixPosition(e.matrixWorld),t.position.copy(yf),Ef.setFromMatrixPosition(e.target.matrixWorld),t.lookAt(Ef),t.updateMatrixWorld(),Fa.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Fa),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(Fa)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.intensity=e.intensity,this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.intensity!==1&&(e.intensity=this.intensity),this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}const bf=new gt,jr=new $,Oa=new $;class qy extends $y{constructor(){super(new en(90,1,.5,500)),this.isPointLightShadow=!0,this._frameExtents=new Je(4,2),this._viewportCount=6,this._viewports=[new ct(2,1,1,1),new ct(0,1,1,1),new ct(3,1,1,1),new ct(1,1,1,1),new ct(3,0,1,1),new ct(1,0,1,1)],this._cubeDirections=[new $(1,0,0),new $(-1,0,0),new $(0,0,1),new $(0,0,-1),new $(0,1,0),new $(0,-1,0)],this._cubeUps=[new $(0,1,0),new $(0,1,0),new $(0,1,0),new $(0,1,0),new $(0,0,1),new $(0,0,-1)]}updateMatrices(e,t=0){const i=this.camera,r=this.matrix,s=e.distance||i.far;s!==i.far&&(i.far=s,i.updateProjectionMatrix()),jr.setFromMatrixPosition(e.matrixWorld),i.position.copy(jr),Oa.copy(i.position),Oa.add(this._cubeDirections[t]),i.up.copy(this._cubeUps[t]),i.lookAt(Oa),i.updateMatrixWorld(),r.makeTranslation(-jr.x,-jr.y,-jr.z),bf.multiplyMatrices(i.projectionMatrix,i.matrixWorldInverse),this._frustum.setFromProjectionMatrix(bf)}}class Yy extends Gh{constructor(e,t,i=0,r=2){super(e,t),this.isPointLight=!0,this.type="PointLight",this.distance=i,this.decay=r,this.shadow=new qy}get power(){return this.intensity*4*Math.PI}set power(e){this.intensity=e/(4*Math.PI)}dispose(){this.shadow.dispose()}copy(e,t){return super.copy(e,t),this.distance=e.distance,this.decay=e.decay,this.shadow=e.shadow.clone(),this}}class Ky extends Gh{constructor(e,t){super(e,t),this.isAmbientLight=!0,this.type="AmbientLight"}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:oc}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=oc);function Zy(){const n=new Xy,e=new en(18,window.innerWidth/window.innerHeight,10,1e3),t=new Yy(16777215,150),i=new Ky(16777215,10),r=new Wy({canvas:document.querySelector("#starHeader")});return r.setPixelRatio(window.devicePixelRatio),r.setSize(window.innerWidth,window.innerHeight),r.setClearColor(986895),r.render(n,e),t.position.set(0,4,6),{scene:n,renderer:r,camera:e,pointLight:t,ambientLight:i}}function Jy(){return{star:new Tn(new vc(.035),new jy({color:16777215}))}}const Qy={class:"canvaswrapper"},eE={__name:"StarBG",setup(n){return $n(()=>{const{scene:e,renderer:t,camera:i,ambientLight:r}=Zy(),s=new $(0,0,0),o=80;function a(){const{star:f}=Jy(),[d,h,S]=Array(3).fill().map(()=>R0.randFloatSpread(100));f.position.set(d,h,S),f.rotation.z=S*-.1,e.add(f)}Array(500).fill().forEach(a),e.add(r);const l=new Je;function c(f){l.x=f.clientX/window.innerWidth*2-1}window.addEventListener("mousemove",c);function u(){requestAnimationFrame(u);const f=Date.now()*5e-5;i.position.x=s.x-Math.sin(f)*o*l.x,i.position.z=s.z+Math.cos(f)*o,i.lookAt(s),t.render(e,i)}u()}),(e,t)=>(Ye(),ot("div",Qy,t[0]||(t[0]=[w("canvas",{id:"starHeader"},null,-1)])))}},tE={class:"headerContainer",id:"canvasCon"},nE={__name:"Header",setup(n){return(e,t)=>(Ye(),ot("div",tE,[se(eE),t[0]||(t[0]=w("div",{class:"herowrapper"},[w("h2",{class:"hero glitch layers","data-text":"程式和設計"},[w("span",null,"ARRO.AV")]),w("h5",{class:"hero glitch layers","data-text":"程式和設計"},[w("span",null,"creative_coding")]),w("h6",{class:"hero glitch layers","data-text":"程式和設計"},[w("span",null,"開發設計")])],-1))]))}},Et=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},iE={class:"projectLeftSection"},rE={class:"projectTags"},sE={__name:"ProjectCard",props:{projectTitle:String,projectTags:Array,currentProjectView:String,imagePath:String},setup(n){return(e,t)=>{const i=Do("RouterLink");return Ye(),Ar(Zd,{name:"project",tag:"div",class:"project-list"},{default:Ge(()=>[w("div",{class:"projectContainer",style:wo({backgroundImage:`url(${n.imagePath})`})},[se(i,{to:n.currentProjectView,class:"project-list"},{default:Ge(()=>[w("div",iE,[w("h2",null,Vi(n.projectTitle),1),w("div",rE,[(Ye(!0),ot(Rt,null,Wa(n.projectTags,r=>(Ye(),ot("p",{key:r},Vi(r),1))),128))])])]),_:1},8,["to"])],4)]),_:1})}}},oE=Et(sE,[["__scopeId","data-v-2a9a0186"]]),aE={class:"projectsWrapper"},lE={class:"projectNav"},cE=["id","onClick"],uE={class:"projectListContainer"},fE={__name:"ProjectFilter",setup(n){const e=br(localStorage.getItem("activeFilter")||"OTHER"),t=br([{categories:["AUDIO"],title:"Coding Techno",currentProjectView:"/AudioProject1",imagePath:"/bg_images/a_1.png",tag:["#LiveSession","#SonicPi"]},{categories:["AUDIO"],title:"Chaotic Algorithms",currentProjectView:"/AudioProject2",imagePath:"/bg_images/a_2.png",tag:["#MusicVideo","#SP","#TD"]},{categories:["AUDIO"],title:"MIDI Boilerplate",currentProjectView:"/AudioProject3",imagePath:"/bg_images/a_3.png",tag:["#Code","#Ruby"]},{categories:["VISUAL"],title:"VJ-Setup v1.0",currentProjectView:"/VisualProject1",imagePath:"/bg_images/v_1.png",tag:["#TD","#VJ","#MIDI"]},{categories:["VISUAL"],title:"PokéMorph",currentProjectView:"/VisualProject2",imagePath:"/bg_images/v_2.png",tag:["#Tutorial","#GLSL","#TD"]},{categories:["VISUAL"],title:"Bananana",currentProjectView:"/VisualProject3",imagePath:"/bg_images/v_3.png",tag:["#Tutorial","#TD"]},{categories:["DESIGN"],title:"Websites",currentProjectView:"/DesignProject1",imagePath:"/bg_images/d_1.png",tag:["#Webdesign","#Frontend","#CMS"]},{categories:["DESIGN"],title:"Screenprints",currentProjectView:"/DesignProject2",imagePath:"/bg_images/d_2.png",tag:["#Screenprint","#Art"]},{categories:["DESIGN"],title:"Branding",currentProjectView:"/DesignProject3",imagePath:"/bg_images/d_3.png",tag:["#Different","#Stuff"]},{categories:["OTHER"],title:"Events",currentProjectView:"/OtherProject1",imagePath:"/bg_images/o_1.png",tag:["#HoA","#GoS","#SL"]},{categories:["OTHER"],title:"RetroPi Build",currentProjectView:"/OtherProject2",imagePath:"/bg_images/o_2.png",tag:["#RasPi","#Emulation","#Linux"]},{categories:["OTHER"],title:"Dead Internet",currentProjectView:"/OtherProject3",imagePath:"/bg_images/o_3.png",tag:["#DataVisualisation","#MediaStudies"]}]),i=on(()=>e.value?t.value.filter(s=>s.categories.includes(e.value)):t.value);function r(s){e.value===s?e.value=null:(e.value=s,localStorage.setItem("activeFilter",s))}return(s,o)=>(Ye(),ot("div",aE,[w("div",lE,[(Ye(),ot(Rt,null,Wa(["AUDIO","VISUAL","DESIGN","OTHER"],a=>w("li",{key:a,id:e.value===a?"activeFilter":"",onClick:l=>r(a)},Vi(a),9,cE)),64))]),w("div",uE,[se(Zd,{name:"project",tag:"div",class:"project-list"},{default:Ge(()=>[(Ye(!0),ot(Rt,null,Wa(i.value,a=>(Ye(),Ar(oE,{key:a.title,subTitle:a.subTitle,projectTitle:a.title,currentProjectView:a.currentProjectView,imagePath:a.imagePath,projectTags:a.tag,projectInfo:a.info},null,8,["subTitle","projectTitle","currentProjectView","imagePath","projectTags","projectInfo"]))),128))]),_:1})])]))}},dE={class:"projectsWrapper"},hE={__name:"Projects",setup(n){return(e,t)=>(Ye(),ot("div",dE,[se(nE),se(fE)]))}},pE="data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='UTF-8'%20standalone='no'?%3e%3c!--%20Created%20with%20Inkscape%20(http://www.inkscape.org/)%20--%3e%3csvg%20width='500'%20height='500'%20viewBox='0%200%20132.29166%20132.29167'%20version='1.1'%20id='svg1'%20xml:space='preserve'%20xmlns:inkscape='http://www.inkscape.org/namespaces/inkscape'%20xmlns:sodipodi='http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:svg='http://www.w3.org/2000/svg'%3e%3csodipodi:namedview%20id='namedview1'%20pagecolor='%23ffffff'%20bordercolor='%23000000'%20borderopacity='0.25'%20inkscape:showpageshadow='2'%20inkscape:pageopacity='0.0'%20inkscape:pagecheckerboard='0'%20inkscape:deskcolor='%23d1d1d1'%20inkscape:document-units='mm'%20showgrid='false'%20/%3e%3cdefs%20id='defs1'%20/%3e%3cg%20inkscape:label='Ebene%201'%20inkscape:groupmode='layer'%20id='layer1'%3e%3cpath%20style='fill:%23000000'%20d='m%2062.927177,115.33645%20-1.32532,-1.42951%20V%2092.040717%2070.174495%20h%20-20.27252%20-20.27252%20l%20-1.32532,-1.429511%20c%20-1.6891,-1.821886%20-1.6891,-4.054993%200,-5.876878%20l%201.32532,-1.429511%20h%2020.27252%2020.27252%20V%2039.572373%2017.70615%20l%201.32532,-1.42951%20c%201.6891,-1.821886%203.75945,-1.821886%205.44855,0%20l%201.32532,1.42951%20v%2021.866223%2021.866222%20h%2020.27253%2020.272523%20l%201.32532,1.429511%20c%201.6891,1.821885%201.6891,4.054992%200,5.876878%20l%20-1.32532,1.429511%20H%2089.973577%2069.701047%20v%2021.866222%2021.866223%20l%20-1.32532,1.42951%20c%20-0.72893,0.78623%20-1.95485,1.42951%20-2.72427,1.42951%20-0.76943,0%20-1.99535,-0.64328%20-2.72428,-1.42951%20z'%20id='path1'%20/%3e%3c/g%3e%3c/svg%3e",mE={class:"collapsibleWrapper"},gE={key:0,class:"collapsibleContent"},_E={__name:"Collapsibles",props:{title:String,text:String},setup(n){const e=br(!1);return(t,i)=>(Ye(),ot("div",mE,[w("div",{class:"collapspreview",onClick:i[0]||(i[0]=r=>e.value=!e.value)},[w("h4",null,Vi(n.title),1),w("img",{src:pE,alt:"Icon to Open a collapse section",class:ms({rotated:e.value})},null,2)]),se(Xd,{name:"ease-in"},{default:Ge(()=>[e.value?(Ye(),ot("div",gE,[em(t.$slots,"default",{},void 0,!0)])):Im("",!0)]),_:3})]))}},tt=Et(_E,[["__scopeId","data-v-d0e110b4"]]),vE=["src","alt"],xE={__name:"Image",props:{src:String,alt:String},setup(n){const e=br(!1);return(t,i)=>(Ye(),ot("img",{src:n.src,alt:n.alt,class:ms([{loaded:e.value},"smooth-img"]),onLoad:i[0]||(i[0]=r=>e.value=!0),loading:"lazy"},null,42,vE))}},dt=Et(xE,[["__scopeId","data-v-9a23060d"]]),SE={class:"aboutSite"},ME={class:"aboutGeneral"},yE={class:"aboutDetails"},EE={__name:"About",setup(n){return(e,t)=>(Ye(),ot("div",SE,[w("section",ME,[se(dt,{src:"/project_images/me_about.png",alt:"Me"}),t[0]||(t[0]=w("div",{class:"aboutTextWrapper"},[w("h5",null,"hi, my name is..."),w("h2",null,"ROBERT ARDELEANU"),w("p",null,[He(" I am a creative coding enthusiast and currently study MtD (BA) at the unviersity of applied sciences @ Campus Hagenberg. "),w("br"),w("span",null,"Linz, Upper Austria")])],-1))]),w("section",yE,[se(tt,{title:"Things I love"},{default:Ge(()=>t[1]||(t[1]=[w("h4",null,"Creative Coding",-1),w("p",null,"generative visuals with TD & algorithmic sound with SP",-1),w("h4",null,"Prints",-1),w("p",null,"screenprinted shirts, stickers and all that good stuff",-1),w("h4",null,"Pokémon",-1),w("p",null,"pure nostalgia - the ROM-hacks are the best tho",-1),w("h4",null,"Cats",-1),w("p",null,"I have two cats - basically my children",-1),w("h4",null,"Techno",-1),w("p",null,"best spirit - even better sound",-1)])),_:1}),se(tt,{title:"Technologies"},{default:Ge(()=>t[2]||(t[2]=[w("h4",null,"Programming",-1),w("p",null,"Javascript(Vue), Java, Python, Ruby, GLSL",-1),w("h4",null,"Realtime-Graphics",-1),w("p",null,"Touchdesigner",-1),w("h4",null,"2D-Graphics",-1),w("p",null,"Photoshop, Illustrator, Procreate",-1),w("h4",null,"3D-Graphics",-1),w("p",null,"Blender",-1),w("h4",null,"Video",-1),w("p",null,"DaVinci Resolve, OBS, Premiere",-1),w("h4",null,"Audio",-1),w("p",null,"SonicPi, Ableton",-1),w("h4",null,"UX/UI-Design",-1),w("p",null,"Xd, Figma",-1)])),_:1}),se(tt,{title:"Portfolio"},{default:Ge(()=>t[3]||(t[3]=[w("h4",null,"Web Portfolio",-1),w("p",null,[He(" This Portfolio was built using HTML, SCSS and JS | Vue. I used Vite for developement and build process. "),w("br"),w("a",{target:"_blank",href:"https://github.com/sync-tax/tribeholz_portfolio"},"→ Codebase on GitHub")],-1),w("br",null,null,-1),w("h4",null,"Print Portfolio",-1),w("p",null,[w("a",{href:"https://drive.google.com/file/d/18GAOEvxXWaD3Pvr4apUIzXjAwTwsZfBV/view?usp=sharing",target:"_blank"},"→ Portfolio (PDF) - Download")],-1)])),_:1})])]))}},bE=Et(EE,[["__scopeId","data-v-bc1aa8a4"]]),AE={},TE={class:"linkContainer"};function wE(n,e){return Ye(),ot("div",TE,e[0]||(e[0]=[Bd('<a href="https://www.youtube.com/@tribeholz23" target="_blank">YouTube</a><a href="https://www.instagram.com/_tribeholz" target="_blank">Instagram</a><a href="https://github.com/sync-tax/" target="_blank">Github</a><a href="https://soundcloud.com/tribeholz808" target="_blank">Soundcloud</a><a href="https://drive.google.com/drive/folders/1Hxd5kI1gWZXB3dU15D3aQc7badd6mQHl?usp=sharing" target="_blank">TD Files</a><a href="https://www.instagram.com/durch.durch.durch/" target="_blank">DURCH</a>',6)]))}const RE=Et(AE,[["render",wE]]),CE="data:image/svg+xml,%3csvg%20clip-rule='evenodd'%20fill-rule='evenodd'%20stroke-linejoin='round'%20stroke-miterlimit='2'%20viewBox='0%200%2024%2024'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='m9.474%205.209s-4.501%204.505-6.254%206.259c-.147.146-.22.338-.22.53s.073.384.22.53c1.752%201.754%206.252%206.257%206.252%206.257.145.145.336.217.527.217.191-.001.383-.074.53-.221.293-.293.294-.766.004-1.057l-4.976-4.976h14.692c.414%200%20.75-.336.75-.75s-.336-.75-.75-.75h-14.692l4.978-4.979c.289-.289.287-.761-.006-1.054-.147-.147-.339-.221-.53-.221-.191-.001-.38.071-.525.215z'%20fill-rule='nonzero'/%3e%3c/svg%3e",PE={},LE={class:"backOverview"};function IE(n,e){const t=Do("RouterLink");return Ye(),ot("section",LE,[se(t,{to:"/",class:"backLink"},{default:Ge(()=>e[0]||(e[0]=[w("img",{src:CE,alt:"back_arrow",width:"20px"},null,-1),w("p",null,"Back",-1)])),_:1})])}const un=Et(PE,[["render",IE]]),DE={class:"textProjectContent"},Vt={__name:"ProjectOverview",props:{title:String,text:String},setup(n){return(e,t)=>(Ye(),ot("div",DE,[w("h2",null,Vi(n.title),1),w("p",null,Vi(n.text),1)]))}},UE={class:"project"},NE={class:"projectOverview"},FE={class:"projectDetails"},OE={__name:"AudioProject1",setup(n){return(e,t)=>(Ye(),ot("div",UE,[se(un),w("section",NE,[se(Vt,{title:"Coding Techno",text:`This was the first series I created on coding with SonicPi. It focused\r
          on experimentation and developing a workflow.`}),t[0]||(t[0]=w("div",{class:"mainProjectContent"},[w("iframe",{width:"600",height:"337",src:"https://www.youtube.com/embed/videoseries?si=cQ-cdKx3yKNn4xmz&list=PLFLuAZh6tS3IfAgWplNl72bJkq3jWkxeA",title:"YouTube video player",frameborder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",referrerpolicy:"strict-origin-when-cross-origin",allowfullscreen:""}),w("p",{class:"contentNote"},"Playlist - Coding Techno with SonicPi")],-1))]),w("section",FE,[se(tt,{title:"About"},{default:Ge(()=>t[1]||(t[1]=[w("h4",null,"Overview",-1),w("p",null," I never intended to explore electronic music production, but that changed when I discovered SonicPi. Since then, I've developed a deep passion for creative coding. ",-1),w("h4",null,"Tools",-1),w("p",null,[He(" - SonicPi "),w("br"),He(" - Ruby ")],-1)])),_:1}),se(tt,{title:"Resources"},{default:Ge(()=>t[2]||(t[2]=[w("p",null,[w("a",{target:"_blank",href:"https://github.com/sync-tax/TechnoSession-1/blob/main/TechnoSession%231.rb"},"→ Ruby-File | First"),w("br"),w("a",{target:"_blank",href:"https://www.youtube.com/watch?v=s22yDfzhWoU&list=PLFLuAZh6tS3IfAgWplNl72bJkq3jWkxeA"},"→ Playlist | YouTube")],-1)])),_:1})])]))}},BE=Et(OE,[["__scopeId","data-v-0d5a5c40"]]),kE={class:"project"},zE={class:"projectOverview"},HE={class:"projectDetails"},VE={__name:"AudioProject2",setup(n){return(e,t)=>(Ye(),ot("div",kE,[se(un),w("section",zE,[se(Vt,{title:"Chaotic Algorithms",text:`This is my second - ongoing - series on coded sound. The goal is to\r
          integrate the SonicPi workflow with Ableton and Touchdesigner.`}),t[0]||(t[0]=w("div",{class:"mainProjectContent"},[w("iframe",{width:"600",height:"337",src:"https://www.youtube.com/embed/videoseries?si=TgvwDJsjbmOgdroc&list=PLFLuAZh6tS3LOBqjGSkGZ7ALP3DXZvhIU",frameborder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",referrerpolicy:"strict-origin-when-cross-origin",allowfullscreen:""}),w("p",{class:"contentNote"},"Playlist - Chaotic Algorhithms")],-1))]),w("section",HE,[se(tt,{title:"About"},{default:Ge(()=>t[1]||(t[1]=[w("h4",null,"Overview",-1),w("p",null,[He(' The "Chaotic Algorithms" is an ongoing project. However I stopped uploading after the second video because I felt stuck in the mindset of forcing myself to post on YouTube. So, I decided to step back and focus on simply creating. '),w("br"),He(" → After almost 1 year of refining I'm ready to get back to it. ")],-1),w("h4",null,"Tools",-1),w("p",null,[He(" - SonicPi "),w("br"),He(" - Ruby "),w("br"),He(" - Touchdesigner ")],-1)])),_:1}),se(tt,{title:"Resources"},{default:Ge(()=>t[2]||(t[2]=[w("p",null,[w("a",{target:"_blank",href:"https://github.com/sync-tax/next_stop/blob/main/next_stop/next_stop.rb"},"→ Next Stop - Ruby File"),w("br"),w("a",{target:"_blank",href:"https://www.youtube.com/watch?v=RvjkTeZztT4&list=PLFLuAZh6tS3LOBqjGSkGZ7ALP3DXZvhIU"},"→ Playlist | YouTube")],-1)])),_:1})])]))}},GE=Et(VE,[["__scopeId","data-v-c1705d08"]]);var Af=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function WE(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}var Wh={exports:{}};(function(n){var e=typeof window<"u"?window:typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope?self:{};/**
...
`)])],-1))]),w("section",qE,[se(tt,{title:"About"},{default:Ge(()=>t[1]||(t[1]=[w("h4",null,"Overview",-1),w("p",null," While SonicPi enables scripting generative soundscapes, I personally prefer using the live loop feature. Controlling different parameters with a MIDI controller makes playing around even more fun. ",-1),w("h4",null,"Tools",-1),w("p",null,[He(" - SonicPi "),w("br"),He(" - Ruby ")],-1)])),_:1}),se(tt,{title:"Features"},{default:Ge(()=>t[2]||(t[2]=[w("h4",null,"Metronome",-1),w("p",null," Syncing to it enables playing around with sleep values without getting out of sync. - MIDI Scale Function: Remap the default MIDI control range to your desired range. ",-1),w("h4",null,"Pattern Function",-1),w("p",null," Easily define rhythmic patterns of instruments with simple Strings. ",-1),w("h4",null,"MIDI Scale Function",-1),w("p",null,"Remap the default MIDI control range to your desired range.",-1),w("h4",null,"MIDI Mapper",-1),w("p",null," Place the controls you want to map within the Switch-Case and call scale_midi(val, min, max) on them. ",-1)])),_:1}),se(tt,{title:"Resources"},{default:Ge(()=>t[3]||(t[3]=[w("p",null,[w("a",{target:"_blank",href:"https://github.com/sync-tax/sonicpi_livejam_boilerplate/blob/main/live_jam_boilerplate.rb"},"→ GitHub - Code")],-1)])),_:1})])]))}},KE=Et(YE,[["__scopeId","data-v-8b114b39"]]),ZE={class:"project"},JE={class:"projectOverview"},QE={class:"mainProjectContent"},eb={class:"projectDetails"},tb={__name:"VisualProject1",setup(n){return $n(()=>{_s(()=>{xc.highlightAll()})}),(e,t)=>(Ye(),ot("div",ZE,[se(un),w("section",JE,[se(Vt,{title:"VJ-Setup v1.0",text:"A Touchdesigner setup that uses a MIDI controller, to navigate and control a range of dynamic visuals during a concert we hosted at AEC Deep Space. "}),w("div",QE,[se(dt,{src:"/project_images/v_spotlight_img2.png",alt:"VJ_System"}),t[0]||(t[0]=w("p",{class:"contentNote"}," Here’s the basic setup – each visual is housed in its own Base component. ",-1)),t[1]||(t[1]=w("pre",null,[w("code",{class:"language-python"},`
...
def onValueChange(channel, sampleIndex, val, prev):
    ...
    return
`)],-1)),t[2]||(t[2]=w("p",{class:"contentNote"}," To keep things running smoothly, I added a small Python script that triggers with MIDI changes. When a visual's opacity drops to 0 (making it invisible), it turns off cooking to save on performance. ",-1))])]),w("section",eb,[se(tt,{title:"About"},{default:Ge(()=>t[3]||(t[3]=[w("h4",null,"Overview",-1),w("p",null," This project aimed to create an interactive realtime visual experience for the 808Spotlight concert. ",-1),w("h4",null,"Role",-1),w("p",null," I designed and built the visual system and integrated it with a MIDI controller to trigger and manipulate procedural visuals in real-time. I also performed the visualisation during the concert. ",-1),w("h4",null,"Tools",-1),w("p",null,[He(" - Touchdesigner "),w("br"),He(" - Python "),w("br"),He(" - MIDI Controller ")],-1)])),_:1}),se(tt,{title:"Resources"},{default:Ge(()=>t[4]||(t[4]=[w("h4",null,"Downloads",-1),w("p",null,[w("a",{target:"_blank",href:"https://drive.google.com/drive/u/1/folders/1q3PbSq1VdNGDDjJ9tW2eAR2bjTQ2lTS3"},"→ .TOE-File + Assets")],-1),w("br",null,null,-1),w("h4",null,"Event",-1),w("p",null,[w("a",{target:"_blank",href:"https://808club.x-net.dev/808-spotlight/"},"→ Website Entry"),w("br"),w("a",{target:"_blank",href:"https://www.instagram.com/p/DG5g0ggN2Oq/"},"→ Promo Reel")],-1)])),_:1})])]))}},nb=Et(tb,[["__scopeId","data-v-0907a79b"]]),ib="/assets/pokemorph-Xap1lcpL.webm",rb={class:"project"},sb={class:"projectOverview"},ob={class:"projectDetails"},ab={__name:"VisualProject2",setup(n){return $n(()=>{_s(()=>{xc.highlightAll()})}),(e,t)=>(Ye(),ot("div",rb,[se(un),w("section",sb,[se(Vt,{title:"PokéMorph",text:"Alternative evolution animation for Pokémon sprites."}),t[0]||(t[0]=w("div",{class:"mainProjectContent"},[w("video",{autoplay:"",loop:"",muted:"",playsinline:"",style:{"border-radius":"15px"}},[w("source",{src:ib,type:"video/mp4"})]),w("p",{class:"contentNote",style:{"text-align":"center"}},"Eevee - Evolution"),w("iframe",{width:"600",height:"337",src:"https://www.youtube.com/embed/l1wTkWRXGMg?start=36",title:"YouTube video player",frameborder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",referrerpolicy:"strict-origin-when-cross-origin",allowfullscreen:""}),w("p",{class:"contentNote"},"Tutorial on YouTube")],-1))]),w("section",ob,[se(tt,{title:"About"},{default:Ge(()=>t[1]||(t[1]=[w("h4",null,"Overview",-1),He(" As a huge Pokémon fan I thought that morphing through the entire Gen1 Pokédex would be a fun freetime activity. "),w("br",null,null,-1),w("p",null," It was not only a great experience but also my first attempt with GLSL shaders. It took me a while to get the hang of it - not gonna lie. ",-1),w("h4",null,"Tools",-1),w("p",null,[He(" - Touchdesigner "),w("br"),He(" - Python "),w("br"),He(" - GLSL ")],-1)])),_:1}),se(tt,{title:"Resources"},{default:Ge(()=>t[2]||(t[2]=[w("p",null,[w("a",{target:"_blank",href:"https://drive.google.com/drive/folders/1AwBtOMceYr7AxiBmPK-23IB7UJHPs7WG?usp=sharing"},"→ .TOX File + Assets"),w("br"),w("a",{target:"_blank",href:"https://github.com/sync-tax/poke_morph_TD/blob/main/poke_morph.glsl"},"→ GLSL Code | Github")],-1)])),_:1})])]))}},lb=Et(ab,[["__scopeId","data-v-b531fd4b"]]),cb={class:"project"},ub={class:"projectOverview"},fb={class:"mainProjectContent"},db={class:"projectDetails"},hb={__name:"VisualProject3",setup(n){return(e,t)=>(Ye(),ot("div",cb,[se(un),w("section",ub,[se(Vt,{title:"Bananana",text:"Just about applying a spiral-like appeal to all sorts of stuff."}),w("div",fb,[t[0]||(t[0]=w("iframe",{width:"600",height:"337",src:"https://www.youtube.com/embed/093l7at3phA?si=ZN2Z0kvI5Tzvf4Xa",title:"YouTube video player",frameborder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",referrerpolicy:"strict-origin-when-cross-origin",allowfullscreen:""},null,-1)),t[1]||(t[1]=w("p",{class:"contentNote"},"Easy Feedback technique tutorial",-1)),se(dt,{src:"/project_images/chicken.png",alt:"Chicken"}),t[2]||(t[2]=w("p",{class:"contentNote"},"Don't look at this chicken",-1))])]),w("section",db,[se(tt,{title:"About"},{default:Ge(()=>t[3]||(t[3]=[w("h4",null,"Overview",-1),w("p",null,"I like spirals...",-1),w("h4",null,"Tools",-1),w("p",null,"- Touchdesigner",-1)])),_:1}),se(tt,{title:"Resources"},{default:Ge(()=>t[4]||(t[4]=[w("p",null,[w("a",{href:"https://drive.google.com/drive/folders/1Mo06E5bS4IUPuELJgVocbKGODV_-2vMJ?usp=drive_link",target:"_blank"},"→ .TOX-File")],-1)])),_:1})])]))}},pb=Et(hb,[["__scopeId","data-v-8cfa9efd"]]),mb={class:"project"},gb={class:"projectOverview"},_b={class:"mainProjectContent"},vb={class:"projectDetails"},xb={__name:"DesignProject1",setup(n){return(e,t)=>(Ye(),ot("div",mb,[se(un),w("section",gb,[se(Vt,{title:"Websites",text:"Websites I built and designed in my free time."}),w("div",_b,[se(dt,{src:"/project_images/d_websites_img1.png",alt:"Website"}),t[0]||(t[0]=w("p",{class:"contentNote"},[w("a",{target:"_blank",href:"https://808club.x-net.dev/"},"→ www.808club.at")],-1)),se(dt,{src:"/project_images/d_websites_img2.png",alt:"Website"}),t[1]||(t[1]=w("p",{class:"contentNote"},[w("a",{target:"_blank",href:"https://github.com/sync-tax/tribeholz_portfolio"},"→ Codebase on GitHub")],-1))])]),w("section",vb,[se(tt,{title:"808club.at"},{default:Ge(()=>t[2]||(t[2]=[w("h4",null,"Overview",-1),w("p",null,[He(" I made this website for our club to post upcoming events on and a bunch of other stuff."),w("br")],-1),w("h4",null,"Tools",-1),w("p",null,[He(" - Wordpress "),w("br"),He(" - Elementor "),w("br"),He(" - Other Plugins ")],-1)])),_:1}),se(tt,{title:"arro.at"},{default:Ge(()=>t[3]||(t[3]=[w("h4",null,"Overview",-1),w("p",null,' Short form for "Ardeleanu Robert". My portfolio website which will grow in size and quality over time. ',-1),w("h4",null,"Tools",-1),w("p",null,[He(" - Vue "),w("br"),He(" - SASS "),w("br"),He(" - THREE "),w("br"),He(" - Vite ")],-1)])),_:1}),se(tt,{title:"Resources"},{default:Ge(()=>t[4]||(t[4]=[w("p",null,[w("a",{href:"https://808club.x-net.dev/",target:"_blank",rel:"noopener noreferrer"},"→ Website 808Club"),w("br"),w("a",{href:"https://arro.at/",target:"_blank",rel:"noopener noreferrer"},"→ Website ARRO")],-1)])),_:1})])]))}},Sb=Et(xb,[["__scopeId","data-v-26263d21"]]),Mb={class:"project"},yb={class:"projectOverview"},Eb={class:"mainProjectContent"},bb={class:"projectDetails"},Ab={__name:"DesignProject2",setup(n){return(e,t)=>(Ye(),ot("div",Mb,[se(un),w("section",yb,[se(Vt,{title:"Screenprints",text:"Printdesigns I made for our screenprinting collective. → DURCH"}),w("div",Eb,[se(dt,{src:"/project_images/d_durch_img3.png",alt:"Printdesign"}),t[0]||(t[0]=w("p",{class:"contentNote"},"Printdesign - Big Brother - Procreate & TD",-1)),se(dt,{src:"/project_images/d_durch_img2.png",alt:"Printdesign"}),t[1]||(t[1]=w("p",{class:"contentNote"},"Printdesign - Random Doodle - Procreate",-1)),se(dt,{src:"/project_images/d_durch_img4.png",alt:"Printdesign"}),t[2]||(t[2]=w("p",{class:"contentNote"},"Printdesign - Bananana - TD",-1)),se(dt,{src:"/project_images/d_durch_img1.png",alt:"Printdesign"}),t[3]||(t[3]=w("p",{class:"contentNote"}," Printdesign - Beeware - Ink Marker & Illustrator ",-1)),se(dt,{src:"/project_images/d_durch_img5.png",alt:"Printdesign"}),t[4]||(t[4]=w("p",{class:"contentNote"},"Printdesign - VOID - Touchdesigner",-1)),se(dt,{src:"/project_images/d_durch_img6.png",alt:"Printdesign"}),t[5]||(t[5]=w("p",{class:"contentNote"}," Printdesign - Shroompa Mario - Inkpens & Procreate ",-1)),se(dt,{src:"/project_images/d_durch_img7.png",alt:"Printdesign"}),t[6]||(t[6]=w("p",{class:"contentNote"},"Printdesign - Wond - Procreate",-1))])]),w("section",bb,[se(tt,{title:"About"},{default:Ge(()=>t[7]||(t[7]=[w("h4",null,"Overview",-1),w("p",null," A couple of friends and I started a small artist collective where we create print designs and screen print them in my home workshop. ",-1),w("h4",null,"Tools",-1),w("p",null,[He(" - Screenprinting stuff "),w("br"),He(" - Pens & Paper "),w("br"),He(" - Designsoftware ")],-1)])),_:1}),se(tt,{title:"Resources"},{default:Ge(()=>t[8]||(t[8]=[w("p",null,[w("a",{href:"https://www.instagram.com/durch.durch.durch/",target:"_blank",rel:"noopener noreferrer"},"→ Instagram @durch.durch.durch")],-1)])),_:1})])]))}},Tb=Et(Ab,[["__scopeId","data-v-917cdea5"]]),wb="/project_images/d_808_img1.png",Rb={class:"project"},Cb={class:"projectOverview"},Pb={class:"mainProjectContent"},Lb={class:"imageContainer"},Ib={class:"imageContainer"},Db={class:"mainProjectContent"},Ub={class:"projectDetails"},Nb={__name:"DesignProject3",setup(n){return(e,t)=>(Ye(),ot("div",Rb,[se(un),w("section",Cb,[se(Vt,{title:"808CLUB",text:"Designs I made for the 808Club."}),w("div",Pb,[t[0]||(t[0]=w("img",{src:wb,alt:"Stuff",width:"80%"},null,-1)),t[1]||(t[1]=w("p",{style:{"text-align":"center"},class:"contentNote"},' Beachflags & Sticker | The Logo was created in collaboration with a friend who provided the "808" lettering. I refined it using Illustrator and designed stickers and such. ',-1)),w("div",Lb,[se(dt,{src:"/project_images/d_808_img2.png",alt:"Flyer"}),se(dt,{src:"/project_images/d_808_img3.png",alt:"Flyer"})]),t[2]||(t[2]=w("p",{style:{"text-align":"center"},class:"contentNote"}," Flyer - House of Arts #1- Affinity & Procreate ",-1)),t[3]||(t[3]=w("p",{style:{"text-align":"center"},class:"contentNote"}," Flyer - Game of Skate #1- Affinity ",-1)),w("div",Ib,[se(dt,{src:"/project_images/d_808_img5.png",alt:"Flyer"}),se(dt,{src:"/project_images/d_808_img4.png",alt:"Flyer"})]),t[4]||(t[4]=w("p",{style:{"text-align":"center"},class:"contentNote"}," Flyer - House of Arts #2- Photoshop | Event sadly canceled :( ",-1)),t[5]||(t[5]=w("p",{style:{"text-align":"center"},class:"contentNote"}," Flyer - Game of Skate #2- Affinity ",-1))]),se(Vt,{style:{"margin-top":"60px"},title:"TRIBΞHOLZ",text:"Designs I made for my algorithmic sound project."}),w("div",Db,[se(dt,{src:"/project_images/d_tribeholz_img1.png",alt:"Banner"}),t[6]||(t[6]=w("p",{style:{"text-align":"center"},class:"contentNote"}," Banner - Soundcloud- Procreate & Illustrator ",-1)),se(dt,{src:"/project_images/d_tribeholz_img2.png",alt:"Lettering"}),t[7]||(t[7]=w("p",{style:{"text-align":"center"},class:"contentNote"}," Lettring Logo - YouTube - Ballpoint & Illustrator ",-1)),se(dt,{src:"/project_images/d_tribeholz_img3.png",alt:"Thumbnails"}),t[8]||(t[8]=w("p",{style:{"text-align":"center"},class:"contentNote"},[He(" Thumbnails - YouTube - Affinity "),w("br")],-1))])]),w("section",Ub,[se(tt,{title:"808Club"},{default:Ge(()=>t[9]||(t[9]=[w("h4",null,"Overview",-1),w("p",null," The 808Club is an art & culture organisation based in Linz. Together with some friend, we organize different events and such. ",-1),w("h4",null,"Role",-1),w("p",null," As part of the board I help with event organisation. Also I frequently make designs & handle the webstuff. ",-1)])),_:1}),se(tt,{title:"TRIBΞHOLZ"},{default:Ge(()=>t[10]||(t[10]=[w("h4",null,"Overview",-1),w("p",null," A personal project where it is all about creative coding. I sometimes post stuff on YouTube. ",-1),w("h4",null,"Tools",-1),w("p",null,[He(" - Touchdesigner "),w("br"),He(" - SonicPi "),w("br"),He(" - DaVinci "),w("br"),He(" - Adobe CC ")],-1)])),_:1}),se(tt,{title:"Resources"},{default:Ge(()=>t[11]||(t[11]=[w("p",null,[w("a",{href:"https://www.instagram.com/808club_linz/",target:"_blank",rel:"noopener noreferrer"},"→ Instagram @808club_linz"),w("br"),w("a",{href:"https://808club.x-net.dev/",target:"_blank",rel:"noopener noreferrer"},"→ Website 808Club"),w("br"),w("a",{href:"https://www.youtube.com/@tribeholz23",target:"_blank",rel:"noopener noreferrer"},"→ YouTube TRIBΞHOLZ")],-1)])),_:1})])]))}},Fb=Et(Nb,[["__scopeId","data-v-41c345ce"]]),Ob={class:"project"},Bb={class:"projectOverview"},kb={class:"mainProjectContent"},zb={class:"mainProjectContent"},Hb={class:"mainProjectContent"},Vb={class:"projectDetails"},Gb={__name:"OtherProject1",setup(n){return(e,t)=>(Ye(),ot("div",Ob,[se(un),w("section",Bb,[se(Vt,{title:"Spotlight",text:"Tiny-desk like concert at the AEC Deep Space."}),w("div",kb,[se(dt,{src:"/project_images/o_events_img5.png",alt:"Spotlight"}),t[0]||(t[0]=w("p",{class:"contentNote"},"Testing - SL",-1))]),se(Vt,{style:{"margin-top":"60px"},title:"House of Arts",text:"Art gallery event for all kinds of local artists."}),w("div",zb,[se(dt,{src:"/project_images/o_events_img1.png",alt:"HoA"}),t[1]||(t[1]=w("p",{class:"contentNote"},"Concert - HoA",-1)),se(dt,{src:"/project_images/o_events_img3.png",alt:"HoA"}),t[2]||(t[2]=w("p",{class:"contentNote"},"Exhibition - HoA",-1))]),se(Vt,{style:{"margin-top":"60px"},title:"Game of Skate",text:"Skate contest for the skating community."}),w("div",Hb,[se(dt,{src:"/project_images/o_events_img4.png",alt:"GoS"}),t[3]||(t[3]=w("p",{class:"contentNote"},"Skate Challenge - GoS",-1))])]),w("section",Vb,[se(tt,{title:"Spotlight"},{default:Ge(()=>t[4]||(t[4]=[w("p",null,[He(" For this event, I took care of the visual setup and live visuals during the concert. I also helped out by cutting reels and other media. "),w("br"),w("br"),He(" The YouTube video of the concert will be online soon! ")],-1)])),_:1}),se(tt,{title:"House of Arts"},{default:Ge(()=>t[5]||(t[5]=[w("p",null,[He(" I was in charge of various design tasks like creating flyers and also organizing equipment. "),w("br"),w("br"),He(" Alongside a friend, I also handled all the tech-related gear—both in the concert room and in the darkroom, which was equipped with three projectors. ")],-1)])),_:1}),se(tt,{title:"Game of Skate"},{default:Ge(()=>t[6]||(t[6]=[w("p",null," Even though I’m not a skater, I designed most of the flyers for the event. I also helped out at the bar and cruised around taking photos throughout the day. ",-1)])),_:1}),se(tt,{title:"Resources"},{default:Ge(()=>t[7]||(t[7]=[w("p",null,[w("a",{href:"https://www.instagram.com/p/DG5g0ggN2Oq/",target:"_blank",rel:"noopener noreferrer"},"→ Reel Spotlight"),w("br"),w("a",{href:"https://808club.x-net.dev/bildergalerie/",target:"_blank",rel:"noopener noreferrer"},"→ Bildergalerie 808Club")],-1)])),_:1})])]))}},Wb=Et(Gb,[["__scopeId","data-v-dadf2b03"]]),Xb={class:"project"},jb={class:"projectOverview"},$b={class:"mainProjectContent"},qb={class:"projectDetails"},Yb={__name:"OtherProject2",setup(n){return(e,t)=>(Ye(),ot("div",Xb,[se(un),w("section",jb,[se(Vt,{title:"RetroPi Build",text:"My personal RetroPi build using a Raspberry Pi"}),w("div",$b,[se(dt,{src:"/project_images/o_retro_img2.png",alt:"RetroPi"}),t[0]||(t[0]=w("p",{style:{"text-align":"center"},class:"contentNote"},"Case - Pokecenter",-1)),se(dt,{src:"/project_images/o_retro_img1.png",alt:"SHINYY"}),t[1]||(t[1]=w("p",{style:{"text-align":"center"},class:"contentNote"},"Shiny Onyx - :3",-1))])]),w("section",qb,[se(tt,{title:"About"},{default:Ge(()=>t[2]||(t[2]=[w("h4",null,"Overview",-1),w("p",null,[He(" This was a fun little side project. I basically prepared a little suitcase with a screen and the Raspberry plus a Powerbank. "),w("br"),He("Not exeptionally beautiful, but it was fun. I play a lot Pokémon ROM hacks on that thing. ")],-1),w("h4",null,"Tools",-1),w("p",null,[He(" - Raspberry Pi "),w("br"),He(" - RetroPi OS "),w("br"),He(" - Filezilla "),w("br"),He(" - Popsicle sticks & paint ")],-1)])),_:1})])]))}},Kb=Et(Yb,[["__scopeId","data-v-d51fd583"]]),Zb={class:"project"},Jb={class:"projectOverview"},Qb={class:"mainProjectContent"},eA={class:"projectDetails"},tA={__name:"OtherProject3",setup(n){return(e,t)=>(Ye(),ot("div",Zb,[se(un),w("section",Jb,[se(Vt,{title:"Dead Internet",text:"Tiny report on the Dead Internet Theory"}),w("div",Qb,[se(dt,{src:"/project_images/o_dead_img1.png",alt:"Data Visualisation"}),t[0]||(t[0]=w("p",{style:{"text-align":"center"},class:"contentNote"}," Data Visualisation - Dead Internet - Illustrator ",-1))])]),w("section",eA,[se(tt,{title:"About"},{default:Ge(()=>t[1]||(t[1]=[w("h4",null,"Overview",-1),w("p",null," This was an assignment for the Media Studies class at FH Hagenberg. The question was wheter the internet is mostly populated by bots or not. ",-1),w("h4",null,"Tools",-1),w("p",null,"- Illustrator",-1)])),_:1}),se(tt,{title:"Resources"},{default:Ge(()=>t[2]||(t[2]=[w("p",null,[w("a",{href:"https://drive.google.com/file/d/1zB3icas943Xb4lMJPKRSDnDA2B7Hmuwp/view?usp=sharing",target:"_blank",rel:"noopener noreferrer"},"→ Report")],-1)])),_:1})])]))}},nA=Et(tA,[["__scopeId","data-v-f5526eb7"]]),iA=[{path:"/",name:"Projects",component:hE},{path:"/About",name:"About",component:bE},{path:"/LinkTree",name:"LinkTree",component:RE},{path:"/AudioProject1",name:"AudioProject1",component:BE},{path:"/AudioProject2",name:"AudioProject2",component:GE},{path:"/AudioProject3",name:"AudioProject3",component:KE},{path:"/VisualProject1",name:"VisualProject1",component:nb},{path:"/VisualProject2",name:"VisualProject2",component:lb},{path:"/VisualProject3",name:"VisualProject3",component:pb},{path:"/DesignProject1",name:"DesignProject1",component:Sb},{path:"/DesignProject2",name:"DesignProject2",component:Tb},{path:"/DesignProject3",name:"DesignProject3",component:Fb},{path:"/OtherProject1",name:"OtherProject1",component:Wb},{path:"/OtherProject2",name:"OtherProject2",component:Kb},{path:"/OtherProject3",name:"OtherProject3",component:nA}],rA=["/AudioProject1","/AudioProject2","/AudioProject3","/VisualProject1","/VisualProject2","/VisualProject3","/DesignProject1","/DesignProject2","/DesignProject3","/OtherProject1","/OtherProject2","/OtherProject3"],sA=E_({history:Qg(),routes:iA,scrollBehavior(n,e,t){return t||(n.path==="/"&&rA.includes(e.path)?{top:510}:{top:0})}}),oA="/assets/flying_nyan-DxYZehf-.gif",aA="data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='UTF-8'?%3e%3csvg%20id='Layer_1'%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20352.9%20352.9'%3e%3cdefs%3e%3cstyle%3e%20.cls-1%20{%20fill:%20%23fff;%20}%20%3c/style%3e%3c/defs%3e%3cpolygon%20class='cls-1'%20points='258.06%200%20258.06%2094.84%20258.06%20135.24%20258.06%20258.06%2094.84%20258.06%2094.84%2094.84%20226.06%2094.84%20226.06%200%200%200%200%20352.9%20352.9%20352.9%20352.9%200%20258.06%200'/%3e%3c/svg%3e",lA="data:image/png;base64,",Xh="data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='UTF-8'%20standalone='no'?%3e%3c!--%20Created%20with%20Inkscape%20(http://www.inkscape.org/)%20--%3e%3csvg%20width='500'%20height='500'%20viewBox='0%200%20132.29166%20132.29167'%20version='1.1'%20id='svg1'%20xml:space='preserve'%20inkscape:export-filename='darkmode_icon.svg'%20inkscape:export-xdpi='96'%20inkscape:export-ydpi='96'%20xmlns:inkscape='http://www.inkscape.org/namespaces/inkscape'%20xmlns:sodipodi='http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:svg='http://www.w3.org/2000/svg'%3e%3csodipodi:namedview%20id='namedview1'%20pagecolor='%23ffffff'%20bordercolor='%23000000'%20borderopacity='0.25'%20inkscape:showpageshadow='2'%20inkscape:pageopacity='0.0'%20inkscape:pagecheckerboard='0'%20inkscape:deskcolor='%23d1d1d1'%20inkscape:document-units='mm'%20/%3e%3cdefs%20id='defs1'%20/%3e%3cg%20inkscape:label='Ebene%201'%20inkscape:groupmode='layer'%20id='layer1'%3e%3cpath%20style='fill:%23000000;stroke-width:0.911498'%20d='M%2064.339462,123.60805%20C%2055.321313,122.53997%2050.154764,121.07607%2043.080977,117.58463%2037.114626,114.63981%2031.819748,110.82439%2027.107092,106.07407%2017.814718,96.707442%2012.028835,84.655166%2010.252639,70.965453%209.8117294,67.567177%209.8796022,59.590704%2010.379361,56.074553%2012.824034,38.874384%2022.167058,23.882672%2036.475236,14.201391%20c%202.142106,-1.449399%209.832931,-5.3859141%2011.890341,-6.086014%201.799164,-0.6122237%203.206808,-0.5787491%204.149038,0.098665%200.859532,0.6179625%201.736076,2.126591%201.736076,2.987981%200,0.300215%20-0.430133,2.07512%20-0.955848,3.944233%20-1.901518,6.760596%20-2.421504,11.648665%20-1.965895,18.480248%200.325819,4.885474%200.861319,7.925274%202.099072,11.915462%205.603246,18.06338%2019.983309,31.258177%2038.654131,35.468092%203.765151,0.84897%207.955329,1.16868%2012.852609,0.980653%204.80853,-0.184621%207.54509,-0.597755%2011.51474,-1.738364%203.83375,-1.101559%205.84191,-1.275156%206.90823,-0.59719%201.64243,1.04426%202.03089,2.872583%201.16322,5.474808%20-0.72509,2.174566%20-4.13408,8.901329%20-5.82854,11.501102%20-9.24103,14.178333%20-24.245669,23.924933%20-40.643568,26.400923%20-3.106452,0.46906%20-11.59963,0.82593%20-13.70938,0.57606%20z%20m%209.079884,-7.8503%20c%204.27545,-0.29428%207.393923,-0.92113%2011.635609,-2.3389%205.804713,-1.94023%2012.028408,-5.36281%2016.757085,-9.21516%202.35897,-1.92181%206.76235,-6.493403%208.46008,-8.783268%201.39751,-1.884947%203.58155,-5.351006%203.87359,-6.147379%200.18521,-0.505046%200.56277,-0.518878%20-4.04647,0.14824%20-3.12497,0.452294%20-12.241214,0.376339%20-15.493467,-0.129087%20C%2083.916642,87.631022%2073.470433,83.108766%2065.687794,76.773351%2062.656178,74.305481%2057.838943,69.354572%2055.884196,66.697705%2048.435992,56.574191%2044.70711,46.649584%2043.659848,34.161927%20c%20-0.276603,-3.298201%20-0.163391,-8.047593%200.268377,-11.258972%200.125332,-0.932195%200.300779,-2.342125%200.389879,-3.13318%20l%200.16201,-1.43828%20-1.179985,0.689074%20c%20-3.503874,2.046151%20-6.418292,4.308319%20-9.67654,7.510908%20-5.47214,5.378668%20-7.91675,8.7064%20-10.852703,14.773239%20-6.606777,13.652229%20-6.982801,28.882739%20-1.06462,43.121411%202.558984,6.156707%206.209525,11.533398%2011.199593,16.495303%208.244438,8.19791%2017.383961,12.75851%2029.271724,14.60654%203.19713,0.49702%206.406044,0.5626%2011.241763,0.22978%20z'%20id='path1'%20/%3e%3c/g%3e%3c/svg%3e",jh="/assets/lightmode_icon-DKA_9KZd.svg",cA={class:"mainNavigation"},uA={__name:"Navbar",setup(n){const e=br(null),t=document.documentElement,i=()=>{t.classList.add("lightmode"),t.classList.remove("darkmode"),localStorage.setItem("theme","light")},r=()=>{t.classList.add("darkmode"),t.classList.remove("lightmode"),localStorage.setItem("theme","dark")};return $n(()=>{const s=document.getElementById("nyan");s&&s.addEventListener("click",()=>{e.value&&(e.value.classList.add("flyAnim"),e.value.addEventListener("animationend",()=>{e.value.classList.remove("flyAnim")},{once:!0}))})}),$n(()=>{localStorage.getItem("theme")==="light"?document.documentElement.classList.add("lightmode"):document.documentElement.classList.add("darkmode")}),(s,o)=>{const a=Do("RouterLink");return Ye(),ot("nav",cA,[w("div",{class:"flyingCat",style:{"z-index":"5000"},ref_key:"nyanCat",ref:e},o[0]||(o[0]=[w("img",{src:oA,alt:"Nyan Cat flying over screen",width:"270px"},null,-1)]),512),se(a,{to:"/",class:"navLink"},{default:Ge(()=>o[1]||(o[1]=[w("img",{src:aA,alt:"A monochrome logo resembling the initials AR.",id:"logoImage"},null,-1)])),_:1}),w("ul",null,[o[5]||(o[5]=w("img",{src:lA,alt:"A moon icon - used to switch to darkmode.",id:"nyan"},null,-1)),se(a,{to:"/",class:"navLink"},{default:Ge(()=>o[2]||(o[2]=[w("li",null,"PROJΞCTS",-1)])),_:1}),se(a,{to:"/About",class:"navLink"},{default:Ge(()=>o[3]||(o[3]=[w("li",null,"ΛBOUT",-1)])),_:1}),se(a,{to:"/LinkTree",class:"navLink"},{default:Ge(()=>o[4]||(o[4]=[w("li",{id:"lastNavLink"},"LIΠKS",-1)])),_:1}),w("img",{src:Xh,alt:"A moon icon - used to switch to darkmode.",style:{fill:"white"},class:"modeSwitch dark",onClick:r}),w("img",{title:"Wait. This is illegal.",src:jh,alt:"A sun icon - used to switch to lightmode.",class:"modeSwitch light",onClick:i})])])}}},fA=Et(uA,[["__scopeId","data-v-8a23cba4"]]),dA={class:"footer"},hA={__name:"Footer",setup(n){const e=()=>{const s=document.getElementById("nyan");s.style.opacity="60%",s.style.width="35px",s.style.height="35px",s.style.pointerEvents="all"},t=document.documentElement,i=()=>{t.classList.add("lightmode"),t.classList.remove("darkmode"),localStorage.setItem("theme","light")},r=()=>{t.classList.add("darkmode"),t.classList.remove("lightmode"),localStorage.setItem("theme","dark")};return $n(()=>{localStorage.getItem("theme")==="light"?document.documentElement.classList.add("lightmode"):document.documentElement.classList.add("darkmode")}),(s,o)=>(Ye(),ot("div",dA,[w("div",{class:"footerWrapper"},[o[1]||(o[1]=Bd('<div class="footerSocials"><h4>Socials</h4><a href="https://www.youtube.com/@tribeholz23" target="_blank">YouTube</a><a href="https://www.instagram.com/_tribeholz/" target="_blank">Instagram</a><a href="https://github.com/sync-tax" target="_blank">GitHub</a></div><div class="footerContact"><h4>Contact</h4><a href="https://www.linkedin.com/in/robert-arbeitsloser-7271a71b2/" target="_blank">LinkedIn</a><a href="mailto:robert.ardeleanu.0607@gmail.com" target="_blank">E-Mail</a></div>',2)),w("div",{class:"footerExtra"},[w("div",{class:"modeSwitchContainer"},[w("img",{src:Xh,alt:"A moon icon - used to switch to darkmode.",style:{fill:"white"},class:"modeSwitch dark",onClick:r}),w("img",{title:"Wait. This is illegal.",src:jh,alt:"A sun icon - used to switch to lightmode.",class:"modeSwitch light",onClick:i})]),o[0]||(o[0]=w("p",null,"made with ♡ and a whole lot of coffee^^",-1)),w("p",{class:"nyanUnlock",onClick:e},"UNLOCK NYAN!")])]),o[2]||(o[2]=w("div",{id:"copyrightWrapper"},[w("p",null,"© 2025 Ardeleanu Robert - All Rights Reserved")],-1))]))}},pA={__name:"App",setup(n){return(e,t)=>{const i=Do("router-view");return Ye(),ot("body",null,[se(fA),w("main",null,[se(Xd,{name:"route"},{default:Ge(()=>[se(i,null,{default:Ge(({Component:r})=>[(Ye(),Ar(Qp(r)))]),_:1})]),_:1})]),se(hA)])}}},mA=Et(pA,[["__scopeId","data-v-5e59c223"]]);(function(n){n.languages.ruby=n.languages.extend("clike",{comment:{pattern:/#.*|^=begin\s[\s\S]*?^=end/m,greedy:!0},"class-name":{pattern:/(\b(?:class|module)\s+|\bcatch\s+\()[\w.\\]+|\b[A-Z_]\w*(?=\s*\.\s*new\b)/,lookbehind:!0,inside:{punctuation:/[.\\]/}},keyword:/\b(?:BEGIN|END|alias|and|begin|break|case|class|def|define_method|defined|do|each|else|elsif|end|ensure|extend|for|if|in|include|module|new|next|nil|not|or|prepend|private|protected|public|raise|redo|require|rescue|retry|return|self|super|then|throw|undef|unless|until|when|while|yield)\b/,operator:/\.{2,3}|&\.|===|<?=>|[!=]?~|(?:&&|\|\||<<|>>|\*\*|[+\-*/%<>!^&|=])=?|[?:]/,punctuation:/[(){}[\].,;]/}),n.languages.insertBefore("ruby","operator",{"double-colon":{pattern:/::/,alias:"punctuation"}});var e={pattern:/((?:^|[^\\])(?:\\{2})*)#\{(?:[^{}]|\{[^{}]*\})*\}/,lookbehind:!0,inside:{content:{pattern:/^(#\{)[\s\S]+(?=\}$)/,lookbehind:!0,inside:n.languages.ruby},delimiter:{pattern:/^#\{|\}$/,alias:"punctuation"}}};delete n.languages.ruby.function;var t="(?:"+["([^a-zA-Z0-9\\s{(\\[<=])(?:(?!\\1)[^\\\\]|\\\\[^])*\\1","\\((?:[^()\\\\]|\\\\[^]|\\((?:[^()\\\\]|\\\\[^])*\\))*\\)","\\{(?:[^{}\\\\]|\\\\[^]|\\{(?:[^{}\\\\]|\\\\[^])*\\})*\\}","\\[(?:[^\\[\\]\\\\]|\\\\[^]|\\[(?:[^\\[\\]\\\\]|\\\\[^])*\\])*\\]","<(?:[^<>\\\\]|\\\\[^]|<(?:[^<>\\\\]|\\\\[^])*>)*>"].join("|")+")",i=`(?:"(?:\\\\.|[^"\\\\\r
